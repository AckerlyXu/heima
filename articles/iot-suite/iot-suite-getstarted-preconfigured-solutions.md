<properties
	pageTitle="Get started with preconfigured solutions | Azure"
...
> [AZURE.NOTE]  If you don’t have an account, you can create a trial account in just a couple of minutes. For details, see [Trial][1rmb-trial].
