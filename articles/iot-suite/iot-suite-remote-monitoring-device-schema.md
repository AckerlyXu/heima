---
title: Device schema in remote monitoring solution
...
To learn more about the JavaScript file that updates the device state object, see [Understand the device model behavior](iot-suite-remote-monitoring-device-behavior.md).
...
To learn more about the JavaScript file that implements the behavior of the device, see [Understand the device model behavior](iot-suite-remote-monitoring-device-behavior.md).
