---
title: Provision Raspberry Pi to Remote Monitoring using C - Azure
...
[Microsoft IoT Starter Kit for Raspberry Pi 3](https://docs.azure.cn/zh-cn/develop/iot/iot-starter-kits) or equivalent components. This tutorial uses the following items from the kit:
