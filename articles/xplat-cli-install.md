<properties
    pageTitle="Install the Azure Command-Line Interface | Azure"
...
Quickly install the Azure Command-Line Interface (Azure CLI) to use a set of open-source shell-based commands for creating and managing resources in Azure. You have several options to install these cross-platform tools on your computer:
...
Once the Azure CLI is installed, [connect it with your Azure subscription](/documentation/articles/xplat-cli-connect/) and run the **azure** commands from your command-line interface (Bash, Terminal, Command prompt, and so on) to work with your Azure resources.
