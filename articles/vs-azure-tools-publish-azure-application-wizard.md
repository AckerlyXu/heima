<properties
    pageTitle="Publish Azure Application Wizard | Azure"
...
1. Get a Microsoft account and an Azure subscription. You can try a free one month Azure subscription [here](/pricing/1rmb-trial/)
