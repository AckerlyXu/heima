<properties
    pageTitle="Using the Visual Studio Publish Azure Application Wizard | Azure"
...
**Enable IntelliTrace** - Specify if you want to enable IntelliTrace. With IntelliTrace, you can log extensive debugging information for a role instance when it runs in Azure. If you need to find the cause of a problem, you can use the IntelliTrace logs to step through your code from Visual Studio as if it were running in Azure. For more information about using IntelliTrace, see [Debugging a published Azure Cloud Service with Visual Studio and IntelliTrace](/documentation/articles/vs-azure-tools-intellitrace-debug-published-cloud-services/). 

**Enable profiling** - Specify if you want to enable performance profiling. The Visual Studio profiler enables you to get an in-depth analysis of the computational aspects of how your cloud service runs. For more information on using the Visual Studio profiler, see [Test the performance of an Azure Cloud Service](/documentation/articles/vs-azure-tools-performance-profiling-cloud-services/).

**Enable Remote Debugger for all roles** - Specify if you want to enable remote debugging. For more information on debugging cloud services using Visual Studio, see [Debugging an Azure cloud service or virtual machine in Visual Studio](/documentation/articles/vs-azure-tools-debug-cloud-services-virtual-machines/).
...
Diagnostics enables you to troubleshoot an Azure cloud service (or Azure virtual machine). For information about diagnostics, see [Configuring Diagnostics for Azure Cloud Services and Virtual Machines](/documentation/articles/vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines/).
...
## Next steps
- [Migrate and publish a Web Application to an Azure Cloud Service from Visual Studio](/documentation/articles/vs-azure-tools-migrate-publish-web-app-to-cloud-service/)
- [Learn how to use Visual Studio to publish an Azure Cloud Service](/documentation/articles/vs-azure-tools-publishing-a-cloud-service/)
- [Debugging a published Azure Cloud Service with Visual Studio and IntelliTrace](/documentation/articles/vs-azure-tools-intellitrace-debug-published-cloud-services/)
- [Test the performance of an Azure Cloud Service](/documentation/articles/vs-azure-tools-performance-profiling-cloud-services/)
- [Configuring Diagnostics for Azure Cloud Services and Virtual Machines](/documentation/articles/vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines/). 
