...
1. From a browser, sign in to the [Azure Portal](http://portal.azure.cn). If you don't already have an account, you can sign up for a [free one-month trial](https://www.azure.cn/pricing/1rmb-trial/). 
