...
>
> [1rmb-trial subscriptions](https://www.azure.cn/pricing/1rmb-trial) are not eligible for limit or quota increases. If you have a [1rmb-trial subscription](https://www.azure.cn/pricing/1rmb-trial), you can upgrade to a Pay-As-You-Go subscription. For more information, see [Upgrade Azure 1rmb-trial to Pay-As-You-Go](billing/billing-upgrade-azure-subscription.md) and  [1rmb-trial subscription FAQ](https://www.azure.cn/pricing/1rmb-trial/).
>
...
See [Virtual machine sizes](virtual-machines/linux/sizes.md) for additional details.
...
[Virtual Machine and Cloud Service Sizes for Azure](virtual-machines/linux/sizes.md)
