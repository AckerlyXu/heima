...
> [!NOTE]
> If you don't have an Azure account, you can [create a Azure account](https://www.azure.cn/pricing/1rmb-trial/?WT.mc_id=redis_cache_hero) in just a couple of minutes.
> 
> 
...
2. Edit the `value` attribute and replace `YourCacheName.redis.cache.chinacloudapi.cn` with the [host name](cache-configure.md#properties) of your cache, and replace `YourAccessKey` with either the [primary or secondary key](cache-configure.md#access-keys) of your cache as the password.
