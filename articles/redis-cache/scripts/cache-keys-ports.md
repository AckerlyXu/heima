...
| Command | Notes |
|---|---|
| [az redis show](/cli/redis#az_redis_show) | Retrieve details of an Azure Redis Cache instance. |
| [az redis list-keys](/cli/redis#az_redis_list_keys) | Retrieve access keys for an Azure Redis Cache instance. |
