...
---
title: Automatic scaling and virtual machine scale sets | Azure
...
Set up automatic scaling on a scale set by using an Azure Resource Manager template, Azure PowerShell, Azure CLI, or the Azure portal preview.
...
## Set up scaling using the Azure portal preview
To see an example of using the Azure portal preview to set up autoscaling, look at [Create a Virtual Machine Scale Set using the Azure portal preview](./virtual-machine-scale-sets-portal-create.md).

## Investigate scaling actions
* Azure portal preview - You can currently get a limited amount of information using the portal.
