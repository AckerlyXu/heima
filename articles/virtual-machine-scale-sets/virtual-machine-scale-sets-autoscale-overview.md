...
To see an example of using the Azure portal preview to set up autoscaling, look at [Create a Virtual Machine Scale Set using the Azure portal preview](/documentation/articles/virtual-machine-scale-sets-portal-create/).
