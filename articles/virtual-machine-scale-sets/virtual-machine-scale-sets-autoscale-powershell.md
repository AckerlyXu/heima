...
## Prerequisites
To create autoscale rules, you need an existing virtual machine scale set. You can create a scale set with the [Azure portal](virtual-machine-scale-sets-create-portal.md), [Azure PowerShell](quick-create-powershell.md), or [Azure CLI 2.0](virtual-machine-scale-sets-create-cli.md).
