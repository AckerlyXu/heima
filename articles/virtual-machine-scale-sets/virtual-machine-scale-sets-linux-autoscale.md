...
---
title: Autoscale Linux Virtual Machine Scale Sets | Azure
...
Before you get started with the steps in this tutorial, [install the Azure CLI](/documentation/articles/cli-install-nodejs/).
