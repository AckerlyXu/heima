...
---
title: Vertically scale Azure virtual machine scale sets | Azure
...
This article describes how to vertically scale Azure [Virtual Machine Scale Sets](https://www.azure.cn/home/features/virtual-machine-scale-sets/) with or without reprovisioning. For vertical scaling of VMs which are not in scale sets, refer to [Vertically scale Azure virtual machine with Azure Automation](../virtual-machines/virtual-machines-windows-vertical-scaling-automation.md).
