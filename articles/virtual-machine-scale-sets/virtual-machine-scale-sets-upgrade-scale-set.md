...
- REST API: 
  ...
  `GET https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}?api-version={apiVersion}` 
...
- Azure CLI: 
  ...
  For more information, see the [Azure CLI documentation](/cli/vmss?view=azure-cli-latest#az_vmss_show).

You can also use [Azure Resource Explorer (Preview)](https://resources.azure.com) or the [Azure SDKs](/downloads/) to query the model for a scale set.
...
- REST API: 
  ...
  `GET https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/instanceView?api-version={apiVersion}` 
...
- Azure CLI: 
  ...
  For more information, see the [Azure CLI documentation](/cli/vmss?view=azure-cli-latest#az_vmss_get_instance_view).

You can also use [Azure Resource Explorer (Preview)](https://resources.azure.com) or the [Azure SDKs](/downloads/) to query the instance view for a scale set.
...
- REST API: 
  ...
  `GET https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}?api-version={apiVersion}` 
...
You can also use [Azure Resource Explorer (Preview)](https://resources.azure.com) or the [Azure SDKs](/downloads/) to query the model for a VM in a scale set.
...
- REST API: 
  ...
  `GET https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/virtualmachines/{instanceId}/instanceView?api-version={apiVersion}` 
...
You can also use [Azure Resource Explorer (Preview)](https://resources.azure.com) or the [Azure SDKs](/downloads/) to query the instance view for a VM in a scale set.
...
- REST API: 
  ...
  `PUT https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}?api-version={apiVersion}` 
...
- Azure CLI:
  ...
  For more information, see the [Azure CLI documentation](/cli/vmss?view=azure-cli-latest#az_vmss_update). 
...
You can also use [Azure Resource Explorer (Preview)](https://resources.azure.com) or the [Azure SDKs](/downloads/) to update the scale set model.
...
- **Manual**: In this mode, when you update the scale set model, nothing happens to existing VMs. To update existing VMs, you must manually upgrade each one. You can do this manual upgrade via:
  ...
  - REST API: 
    ...
    `POST https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/manualupgrade?api-version={apiVersion}` 
  ...
  - Azure CLI: 
    ...
    For more information, see the [Azure CLI documentation](/cli/vmss?view=azure-cli-latest#az_vmss_update_instances).

  You can also use the [Azure SDKs](/downloads/) to manually upgrade a VM in a scale set.

>[!NOTE]
> Azure Service Fabric clusters can use only Automatic mode, but the update is handled differently. For more information on Service Fabric updates, see the [Service Fabric documentation](/service-fabric/service-fabric-application-upgrade).
...
- REST API: 
  ...
  `POST https://management.chinacloudapi.cn/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/reimage?api-version={apiVersion}` 
...
- Azure CLI: 
  ...
  For more information, see the [Azure CLI documentation](/cli/vmss?view=azure-cli-latest#az_vmss_reimage).
