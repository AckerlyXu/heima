...
CLI: `az vmss list-instances -g {resourceGroupName} -n {vmScaleSetName}` (for more information, see the [CLI documentation](/cli/vmss?view=azure-cli-latest#az_vmss_list_instances)).

You can also use [resources.azure.com](https://resources.azure.com) or the [Azure SDKs](/downloads/) to list the VMs in a scale set.
