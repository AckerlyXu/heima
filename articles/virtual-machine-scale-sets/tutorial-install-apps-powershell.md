...
Now, apply the Custom Script Extension with [Add-AzureRmVmssExtension](https://docs.microsoft.com/powershell/module/AzureRM.Compute/Add-AzureRmVmssExtension). The configuration object previously defined is passed to the extension. Update and run the extension on the VM instances with [Update-AzureRmVmss](https://docs.microsoft.com/powershell/module/azurerm.compute/update-azurermvmss).
...
Apply the Custom Script Extension configuration to the VM instances in your scale set again with [Add-AzureRmVmssExtension](https://docs.microsoft.com/powershell/module/AzureRM.Compute/Add-AzureRmVmssExtension). The *customConfigv2* definition is used to apply the updated version of the application:
