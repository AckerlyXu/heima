---
title: 'Create a connection between VNets: classic: Azure portal preview | Azure'
...
1. Locate TestVNet1 in the Azure portal preview. In the **VPN connections** section of the blade, click **Gateway**.
...
1. Locate your virtual network in the Azure portal preview.
...
When all the previous steps have been completed, you can set the IPsec/IKE pre-shared keys and create the connection. This set of steps uses PowerShell. VNet-to-VNet connections for the classic deployment model cannot be configured in the Azure portal preview.
