...
1. Open the [Azure portal](https://portal.azure.cn) and navigate to the Resource Manager virtual network gateway that you want to reset.
...
To reset the gateway, use the [az network vnet-gateway reset](/cli/network/vnet-gateway#reset) command. The following example resets a virtual network gateway named VNet5GW in the TestRG5 resource group:
