...
1. From the [Azure portal](https://portal.azure.cn), select your HDInsight cluster. From the top of the HDInsight blade, select the **Remote Desktop** icon. This link displays the remote desktop blade
