<properties
    pageTitle="Run Apache Sqoop jobs with Azure HDInsight (Hadoop) | Azure"
...
* **SQL Server**: If your HDInsight cluster is on the same virtual network in Azure as SQL Server, you can use the steps in this article to import and export data to a SQL Server database.
    ...
    * To create and configure a virtual network, see [Create a virtual network using the Azure portal preview](/documentation/articles/virtual-networks-create-vnet-arm-pportal/).
...
6. Export a data file to the Azure SQL database.
    ...
    ><p> 
    ><p> * **Azure virtual network point-to-site configuration**: A virtual network connected the HDInsight cluster to a SQL Server in a private datacenter. See [Configure a Point-to-Site VPN in the Management Portal](/documentation/articles/vpn-gateway-point-to-site-create/) for more information.
    ><p> * **Azure HDInsight 3.1**: See [Create Hadoop clusters in HDInsight using custom options](/documentation/articles/hdinsight-provision-clusters/) for information about creating a cluster on a virtual network.
