---
title: Azure Toolkit for IntelliJ - Create Scala applications for HDInsight Spark | Azure
...
3. [!INCLUDE [azure-intellij-login-guide](../../includes/azure-intellij-login-guide.md)]
