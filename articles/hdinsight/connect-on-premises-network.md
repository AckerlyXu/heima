...
> [!NOTE]
> The following steps use the [Azure portal](https://portal.azure.cn) to create an Azure Virtual Machine. For other ways to create a virtual machine, see the following documents:
>
...
1. From the [Azure portal](https://portal.azure.cn), select __+__, __Compute__, and __Ubuntu Server 16.04 LTS__.
