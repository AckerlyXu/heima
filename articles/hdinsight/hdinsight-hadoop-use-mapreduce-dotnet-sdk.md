...
* For submitting a Hive job, see [Run Hive queries using HDInsight .NET SDK](/documentation/articles/hdinsight-hadoop-use-hive-dotnet-sdk/).
* For creating HDInsight clusters, see [Create Linux-based Hadoop clusters in HDInsight](/documentation/articles/hdinsight-hadoop-provision-linux-clusters/).
* For managing HDInsight clusters, see [Manage Hadoop clusters in HDInsight](/documentation/articles/hdinsight-administer-use-portal-linux/).
