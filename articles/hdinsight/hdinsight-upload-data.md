...
* **Windows-based HDInsight**: [Connect using Remote Desktop](/documentation/articles/hdinsight-administer-use-management-portal/#connect-to-clusters-using-rdp)
* **Linux-based HDInsight**: Connect using SSH ([the SSH command](/documentation/articles/hdinsight-hadoop-linux-use-ssh-unix/) or [PuTTY](/documentation/articles/hdinsight-hadoop-linux-use-ssh-windows/))
