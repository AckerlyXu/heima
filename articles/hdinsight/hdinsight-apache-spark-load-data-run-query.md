---
title: Run interactive queries on an Azure HDInsight Spark cluster | Azure
...
1. Open the [Azure portal](https://portal.azure.cn/). If you opted to pin the cluster to the dashboard, click the cluster tile from the dashboard to launch the cluster blade.
