---
title: Python UDF with Apache Hive and Pig - Azure HDInsight | Azure
...
> [!IMPORTANT] 
> The steps in this section use Azure PowerShell. For more information on using Azure PowerShell, see [How to install and configure Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview).
