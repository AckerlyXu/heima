...
The raw JSON file is located at **wasb://processjson@hditutorialdata.blob.core.chinacloudapi.cn/**. The **StudentsRaw** Hive table points to the raw JSON document that is not flattened.
