---
title: Extract, transform, and load (ETL) at Scale
...
[Azure Storage](https://docs.azure.cn/zh-cn/storage/blobs/storage-blobs-introduction) has [specific scalability targets](../../storage/common/storage-scalability-targets.md).  For most analytic nodes, Azure Storage scales best when dealing with many smaller files.  Azure Storage guarantees the same performance, no matter how many files or how large the files (as long as you are within your limits).  This means that you can store terabytes of data and still get consistent performance, whether you are using a subset of the data or all of the data.
...
* "Offline" upload of data. You can use [Azure Import/Export service](../../storage/common/storage-import-export-service.md) to ship hard disk drives with your data to an Azure data center. Your data is first uploaded to Azure Storage Blobs. 
...
Analysis cubes can scale by changing tiers for each individual cube.  For more information, see [Azure Analysis Services Pricing](https://www.azure.cn/pricing/details/analysis-services/).
