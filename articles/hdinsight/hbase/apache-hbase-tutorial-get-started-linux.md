...
A sample data file can be found in a public blob container, *wasb://hbasecontacts@hditutorialdata.blob.core.chinacloudapi.cn/contacts.txt*.  The content of the data file is:
...
1. Sign into the the Ambari Web UI at https://&lt;Clustername>.azurehdinsight.cn.
