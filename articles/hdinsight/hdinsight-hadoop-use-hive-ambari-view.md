...
You can also navigate directly to Ambari by going to https://CLUSTERNAME.azurehdinsight.cn in a web browser. Replace **CLUSTERNAME** with the name of your HDInsight cluster. To list available views, select the set of squares from the menu. To open the view, select the **Hive view** entry.
