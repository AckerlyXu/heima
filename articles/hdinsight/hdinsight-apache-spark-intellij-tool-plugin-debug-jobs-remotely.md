---
title: Azure Toolkit for IntelliJ - Debug applications remotely on HDInsight Spark | Azure
...
We recommend the way of debugging spark applicaltion remotely through ssh. For instructions, see [Remotely debug Spark applications on an HDInsight cluster with Azure Toolkit for IntelliJ through SSH](/hdinsight/hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh).
