...
<properties
    pageTitle="Use Azure Toolkit for IntelliJ to remote-debug applications on Spark clusters| Azure"
...
* [Create a VNet with a site-to-site VPN connection using Azure Portal Preview](/documentation/articles/vpn-gateway-howto-site-to-site-resource-manager-portal/)
