...
For an example of processing data from Event Hubs, see [Process events from Azure Event Hub with Storm on HDInsight](/documentation/articles/hdinsight-storm-develop-csharp-event-hub-topology/).
