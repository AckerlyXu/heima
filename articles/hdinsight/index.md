...
description: Learn Hadoop on HDInsight. Documentation shows you how to use Hadoop, Spark, HBase, and more to process, analyze, and gain insights from big data.
services: hdinsight
author: czeumault
manager: carolz
layout: LandingPage
...
Learn how to use Azure HDInsight to analyze streaming or historical data. Tutorials and other documentation show you how to create clusters, process and analyze big data, and develop solutions using the most popular open-source frameworks, like Hadoop, Spark, Hive, LLAP, Kafka, Storm and more. 
