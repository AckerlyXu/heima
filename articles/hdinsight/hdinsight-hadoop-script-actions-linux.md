...
* Use the [HDInsight .NET SDK reference](https://docs.microsoft.com/dotnet/api/overview/azure/hd-insight) to learn more about creating .NET applications that manage HDInsight
