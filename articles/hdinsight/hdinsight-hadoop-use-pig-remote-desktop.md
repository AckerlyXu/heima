...
><p>
> For HDInsight 3.4 or greater, see [Use Pig with HDInsight and SSH](/documentation/articles/hdinsight-hadoop-use-pig-ssh/) for information on interactively running Pig jobs directly on the cluster from a command-line.
