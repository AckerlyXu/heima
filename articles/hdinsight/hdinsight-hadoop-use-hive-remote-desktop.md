...
><p>
> For HDInsight 3.4 or greater, see [Use Hive with HDInsight and Beeline](/documentation/articles/hdinsight-hadoop-use-hive-beeline/) for information on running Hive queries directly on the cluster from a command-line.
