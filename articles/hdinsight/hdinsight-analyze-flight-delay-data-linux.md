---
title: Analyze flight delay data with Hive on HDInsight - Azure | Azure
...
If you already have a SQL database, you must get the server name. To find the server name in the [Azure portal](https://portal.azure.cn), select **SQL Databases**, and then filter on the name of the database that you choose to use. The server name is listed in the **SERVER** column.
