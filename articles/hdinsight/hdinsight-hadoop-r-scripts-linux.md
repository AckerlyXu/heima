---
title: Install R on Linux-based HDInsight | Azure
...
This section provides instructions about how to use the script when creating a new cluster using the Azure portal preview. 
