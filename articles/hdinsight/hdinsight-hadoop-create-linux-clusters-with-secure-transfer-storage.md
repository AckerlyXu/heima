---
title: Create Hadoop cluster with secure transfer storage accounts in Azure HDInsight | Azure
...
- Create a cluster using the [Azure portal](https://portal.azure.cn) and specify linked storage account.
