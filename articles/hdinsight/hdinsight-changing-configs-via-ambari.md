---
title: Optimize cluster configurations with Ambari 
...
Log in to  Ambari at `https://CLUSTERNAME.azurehdidnsight.cn` with your cluster credentials. The initial screen  displays an overview dashboard.
