<properties
    pageTitle="Use custom Maven packages with Jupyter notebooks in Spark on Azure | Azure"
...
* [Use external python packages with Jupyter notebooks in Apache Spark clusters on HDInsight Linux](/documentation/articles/hdinsight-apache-spark-python-package-installation/)
