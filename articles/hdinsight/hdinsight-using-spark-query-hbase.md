...
3. Navigate to your HBase cluster using the [Azure portal](https://portal.azure.cn).
...
1. Navigate to your Spark cluster using the [Azure portal](https://portal.azure.cn).
