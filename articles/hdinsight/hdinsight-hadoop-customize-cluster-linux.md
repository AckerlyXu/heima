...
| Name | Script |
| --- | --- |
| **Add an Azure Storage account** |https://hdiconfigactions.blob.core.windows.net/linuxaddstorageaccountv01/add-storage-account-v01.sh. See [Add additional storage to an HDInsight cluster](/documentation/articles/hdinsight-hadoop-add-storage/). |
...
* [Add additional storage to an HDInsight cluster](/documentation/articles/hdinsight-hadoop-add-storage/)
