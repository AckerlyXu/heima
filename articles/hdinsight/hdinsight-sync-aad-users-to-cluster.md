...
1. In  the [Azure portal](https://portal.azure.cn), navigate to the Azure AD directory associated with your domain-joined cluster.
...
Open the [Ambari Web UI](hdinsight-hadoop-manage-ambari.md) to verify that the new Azure AD user was added. Access the Ambari Web UI by browsing to **`https://<YOUR CLUSTER NAME>.azurehdinsight.cn`**. Enter the cluster administrator username and password.
