...
This statement sets the environment variable **MDS_RUNNER_CUSTOM_CLUSTER** to the value 'true' and also sets the scope of this variable to be machine-wide. It is important that environment variables are set at the appropriate scope ¨C machine or user. Refer [here][1] for more information on setting environment variables.
