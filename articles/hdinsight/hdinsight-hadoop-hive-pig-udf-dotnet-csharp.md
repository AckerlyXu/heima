...
* Hadoop Tools for Visual Studio or Data Lake tools for Visual Studio. See [Get started using HDInsight Hadoop Tools for Visual Studio](/documentation/articles/hdinsight-hadoop-visual-studio-tools-get-started/) for steps on installing and configuring the tools.
