---
title: Azure Toolkit for Eclipse - Create Scala applications for HDInsight Spark | Azure
...
3. [!INCLUDE [azure-eclipse-login-guide](../../includes/azure-eclipse-login-guide.md)]
...
<!--Update_Description: update word & link: add 'Access the job view'-->