...
For more information on using SSH with HDInsight, see [Use SSH with Linux-based Hadoop on HDInsight from Linux, OS X, Unix, and Bash on Windows 10](/documentation/articles/hdinsight-hadoop-linux-use-ssh-unix/).
...
For more information on using PuTTY, see [Use SSH (PuTTY) with Linux-based Hadoop on HDInsight from Windows ](/documentation/articles/hdinsight-hadoop-linux-use-ssh-windows/).
