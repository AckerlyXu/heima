...
Azure Data Lake includes tools for working with generic Hadoop clusters, in addition to tools for working with Azure HDInsight. This document provides the steps needed to use the  Data Lake tools with the Hortonworks Sandbox running in a local virtual machine.
