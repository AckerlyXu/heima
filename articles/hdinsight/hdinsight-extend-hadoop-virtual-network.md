---
title: Extend HDInsight with Virtual Network
...
Use the following PowerShell script to create a virtual network that restricts inbound traffic and allows traffic from the IP addresses for the China North region.
