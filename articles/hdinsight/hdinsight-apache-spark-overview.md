<properties
    pageTitle="An overview of Apache Spark on Azure HDInsight | Azure"
...
**Want to get started with Apache Spark on Azure HDInsight?** See [QuickStart: create a Spark cluster on HDInsight and run sample applications using Jupyter](/documentation/articles/hdinsight-apache-spark-jupyter-spark-sql/).

> [AZURE.NOTE]
> For a list of known issues and limitations with the current release, see [Known issues of Apache Spark in Azure HDInsight](/documentation/articles/hdinsight-apache-spark-known-issues/).
> 
> 
