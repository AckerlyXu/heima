...
* **Familiarity with SSH and SCP**. For more information on using SSH and SCP with HDInsight, see the following documents:
    ...
    * **Linux, Unix, OS X, and Windows 10 clients**: See [Use SSH with Linux-based Hadoop on HDInsight from Linux, OS X, Unix, and Bash on Windows 10](/documentation/articles/hdinsight-hadoop-linux-use-ssh-unix/)
...
> [AZURE.NOTE]
> If you have a version of Windows that does not include the SSH command, see the[Use SSH (PuTTY) with Linux-based Hadoop on HDInsight from Windows](/documentation/articles/hdinsight-hadoop-linux-use-ssh-windows/) document. It contains information on using the PuTTY SSH client for Windows.
