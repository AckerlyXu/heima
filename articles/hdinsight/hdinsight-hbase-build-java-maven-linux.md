<properties
    pageTitle="Build a Java HBase application for Azure HDInsight | Azure"
...
* [A Linux-based Azure HDInsight cluster with HBase](/documentation/articles/hdinsight-hbase-tutorial-get-started-linux/#create-hbase-cluster)
...
* **Familiarity with SSH and SCP** or **Azure PowerShell**. This document provides steps for using both SSH/SCP and Azure PowerShell when running this example.
    ...
    * [Use SSH with Linux-based Hadoop on HDInsight from Linux, OS X, Unix, and Bash on Windows 10](/documentation/articles/hdinsight-hadoop-linux-use-ssh-unix/)
...
1. Edit the **pom.xml** file and add the following code inside the `<dependencies>` section:
    ...
    For more information on HDInsight versions and components, see [What are the different Hadoop components available with HDInsight](/documentation/articles/hdinsight-component-versioning/).
