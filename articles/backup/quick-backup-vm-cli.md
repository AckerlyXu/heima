...
Create a Recovery Services vault with [az backup vault create](/cli/backup/vault#az_backup_vault_create). Specify the same resource group and location as the VM you wish to protect. If you used the [VM quickstart](../virtual-machines/linux/quick-create-cli.md), then you created:

- a resource group named *myResourceGroup*,
- a VM named *myVM*,
- resources in the *chinanorth* location.
...
To monitor the status of backup jobs, use [az backup job list](/cli/backup/job#az_backup_job_list):
