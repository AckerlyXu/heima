...
- Protecting Azure file shares in Storage Accounts with zone redundant storage (ZRS) or [read-access geo-redundant storage](../storage/common/storage-redundancy-grs.md) (RA-GRS) replication.
