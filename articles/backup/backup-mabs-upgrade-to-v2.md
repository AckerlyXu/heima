...
9) From admin command line on new server cd to Azure Backup install location and bin folder

Path example:
C:\windows\system32>cd "c:\Program Files\Azure Backup\DPM\DPM\bin\
