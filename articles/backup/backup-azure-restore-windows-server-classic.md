...
This article explains how to recover data from a backup vault and restore it to a server or computer. Starting in March 2017, you can no longer create backup vaults in the Classic Management Portal.
...
To restore data, you use the Recover Data wizard in the Azure Recovery Services (MARS) agent. When you restore data, it is possible to:
