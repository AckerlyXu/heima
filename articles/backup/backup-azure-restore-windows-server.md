...
Instant Restore is available for use in Recovery Services vaults in the Azure portal. If you want to use Instant Restore, download the MARS update, and follow the procedures that mention Instant Restore.
...
2.  Ensure that you are on the latest version of the Azure Backup agent. To find out the version information of Azure Backup agent, click on **About Azure Recovery Services Agent** on the **Actions** pane of Azure Backup console and ensure that the **Version** number is equal to or higher than the version mentioned in [this article](https://go.microsoft.com/fwlink/?linkid=229525). You can download the latest version from [here](https://go.microsoft.com/fwLink/?LinkID=288905)
