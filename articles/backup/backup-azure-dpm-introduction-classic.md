...
- You’ll need an Azure account with the Azure Backup feature enabled. If you don't have an account, you can create a trial account in just a couple of minutes. Read about [Azure Backup pricing](http://www.azure.cn/pricing/details/backup/).
