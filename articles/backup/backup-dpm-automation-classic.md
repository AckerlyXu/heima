<properties
    pageTitle="Azure Backup: Use PowerShell to back up DPM workloads | Azure"
...
- [Classic](/documentation/articles/backup-dpm-automation-classic/)
...
### Registering with the Azure Backup service
Before you can register with the Azure Backup service, you need to ensure that the [prerequisites](/documentation/articles/backup-azure-dpm-introduction-classic/) are met. You must:
...
- For more information about Azure Backup for DPM see [Introduction to DPM Backup](/documentation/articles/backup-azure-dpm-introduction-classic/)
