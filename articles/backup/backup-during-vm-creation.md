---  
title: Enable Azure VM backup during creation | Microsoft Docs 
...
If you are not already in signed in to your account, sign in to the [Azure portal](http://portal.azure.cn).
...
No, backup costs are separate, or distinct, from virtual machines costs. For more information on backup pricing, see the [Backup Pricing site](https://www.azure.cn/pricing/details/backup/).
