...
A helpful user interface wizard named Azure Backup is installed with the Azure Recovery Services (MARS) agent. The Azure Backup wizard works with the Azure Recovery Services (MARS) agent to retrieve backup data from recovery points stored in Azure. Use the Azure Backup wizard to identify the files or folders you want to restore to Windows Server. 

1. Open the **Azure Backup** snap-in. You can find it by searching your machine for **Azure Backup**.
