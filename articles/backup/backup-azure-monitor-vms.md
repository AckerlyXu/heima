...
## Using Activity logs to get notifications for successful backupsty logs to get notifications for successful backups

If you want to be notified after backups are successful, you can use alerts built on the [activity logs](/azure-resource-manager/resource-group-audit) of the vault.
...
2. Alerts are sent from "alerts-noreply@mail.windowsazure.cn". Currently you can't modify the email sender.
