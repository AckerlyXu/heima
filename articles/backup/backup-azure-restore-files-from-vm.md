...
1. Sign into the [Azure portal](http://portal.azure.cn). Find the relevant Recovery services vault and the required backup item.
...
4. Click **Download Executable** (for Azure VM) or **Download Script** (for Linux Azure VM) to download the software that you'll use to copy files from the recovery point.
