...
Before you add the VMware server to Azure Backup Server, be sure that you have installed [Update 1 for Azure Backup Server](https://support.microsoft.com/zh-cn/help/3175529/update-1-for-microsoft-azure-backup-server).
...
1. Click the following icon (located on the server desktop) to open the Azure Backup Server console.
	...
	If you can't find the icon on the desktop, you can open the Azure Backup Server from the list of installed apps. In the list of installed apps, the Azure Backup Server app is named Azure Backup.
