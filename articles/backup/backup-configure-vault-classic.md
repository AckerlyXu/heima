<properties
    pageTitle="Back up a Windows server or client to Azure using the classic deployment model | Azure"
...
> [AZURE.SELECTOR]
- [Classic Management Portal](/documentation/articles/backup-configure-vault-classic/)
- [Azure portal](/documentation/articles/backup-configure-vault/)
...
6. Select the storage redundancy option by following the steps described here.
   ...
   > 
    ...
    If you are using Azure as a primary backup storage endpoint (for example, you are backing up to Azure from a Windows server), consider picking (the default) [geo-redundant storage](/documentation/articles/storage-redundancy/#geo-redundant-storage/) option.
   
    If you are using Azure as a tertiary backup storage endpoint (for example, you are using System Center Data Protection Manager to store a local backup copy on-premises and using Azure for long-term retention needs), consider choosing [locally redundant storage](/documentation/articles/storage-redundancy/#locally-redundant-storage/). This brings down the cost of storing data in Azure, while providing a lower level of durability for your data that might be acceptable for tertiary copies.
...
Learn more about [using vault credentials to authenticate with the Backup service](/documentation/articles/backup-introduction-to-azure-backup/#what-is-the-vault-credential-file/).
...
- [Back up IaaS VMs](/documentation/articles/backup-azure-vms-prepare/)
- [Back up workloads to Azure with DPM](/documentation/articles/backup-azure-dpm-introduction-classic/)
