<properties
	pageTitle="Continuous integration in VS Team Services using Azure Resource Group projects | Azure"
...
Read [Azure Resource Manager overview](/documentation/articles/resource-group-overview/) to learn more about Azure Resource Manager and Azure resource groups.
