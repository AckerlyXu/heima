...
1. [Connect to the VM](/documentation/articles/virtual-machines-linux-mac-create-ssh-keys/) using an SSH client of your choice.
...
4. Type **Exit** to close the SSH client.
    ...
    > [AZURE.NOTE]
    > The remaining steps assume you have already [installed the Azure CLI](/documentation/articles/cli-install-nodejs/) on your client computer. All the following steps can also be done in the [Azure Classic Management Portal][Azure Classic Management Portal].
