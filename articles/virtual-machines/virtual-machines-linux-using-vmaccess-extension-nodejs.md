...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-using-vmaccess-extension/) - our next generation CLI for the resource management deployment model
