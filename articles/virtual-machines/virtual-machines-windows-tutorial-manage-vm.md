---
title: Manage Windows virtual machines with Azure PowerShell | Azure
...
Create a resource group with [New-AzureRmResourceGroup](https://docs.microsoft.com/powershell/resourcemanager/AzureRM.Resources/v2.0.3/new-azurermresourcegroup).  In this example, a resource group named `myResourceGroup` is created in the `chinanorth` region:
