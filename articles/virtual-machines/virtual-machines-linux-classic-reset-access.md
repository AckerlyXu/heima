...
* You will need to [install the Azure CLI](/documentation/articles/cli-install-nodejs/) and [connect to your subscription](/documentation/articles/xplat-cli-connect/) to use Azure resources associated with your account.
