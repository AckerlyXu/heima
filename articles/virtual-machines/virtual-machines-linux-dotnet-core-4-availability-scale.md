...
For in-depth information on the Azure Network Load Balancer, see [Load balancing for Azure infrastructure services](/documentation/articles/load-balancer-overview/).
