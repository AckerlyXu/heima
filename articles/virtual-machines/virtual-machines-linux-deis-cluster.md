...
* Either -- depending on your client operating system -- the [Azure PowerShell](https://docs.microsoft.com/powershell/azureps-cmdlets-docs) or the [Azure CLI for Mac, Linux, and Windows](/documentation/articles/cli-install-nodejs/).
