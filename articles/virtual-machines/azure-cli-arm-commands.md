...
To get started, first [install the Azure CLI](/documentation/articles/cli-install-nodejs/) and [connect to your Azure subscription](/documentation/articles/xplat-cli-connect/).
