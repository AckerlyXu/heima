<properties
    pageTitle="Cannot connect with RDP to a Windows VM in Azure | Azure"
...
Continue reading if you need more detailed steps and explanations. Verify that local network equipment such as routers and firewalls are not blocking outbound TCP port 3389, as noted in [detailed RDP troubleshooting scenarios](/documentation/articles/virtual-machines-windows-detailed-troubleshoot-rdp/).
