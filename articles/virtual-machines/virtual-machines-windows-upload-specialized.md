<properties
    pageTitle="Upload a specialized VHD to Azure to use for creating a new VM | Azure"
...
* For information about pricing of the various VM sizes, see [Virtual Machines Pricing](/pricing/details/virtual-machines/#Windows).
* For information on storage pricing, see [Storage Pricing](/pricing/details/storage/blob/). 
...
* If you are going to use Managed Disks, review [Plan for the migration to Managed Disks](/documentation/articles/virtual-machines-windows-on-prem-to-azure/#plan-for-the-migration-to-managed-disks).
