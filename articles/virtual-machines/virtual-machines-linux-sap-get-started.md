---
title: Getting started with SAP on Linux VMs in Azure | Azure
...
[This guide can be found here](./linux/sap-hana-overview-architecture.md)
...
[This guide can be found here](./linux/sap-hana-overview-infrastructure-connectivity.md)
...
[This guide can be found here](./linux/sap-hana-overview-sap-hana-installation.md)
...
[This document can be found here](./linux/sap-hana-overview-high-availability-disaster-recovery.md)
...
[This document can be found here](./linux/sap-hana-overview-troubleshooting-monitoring.md)
