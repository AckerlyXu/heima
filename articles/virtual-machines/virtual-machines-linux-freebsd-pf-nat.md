<properties
    pageTitle="Use FreeBSD's Packet Filter to create a firewall in Azure | Azure"
...
If you want to learn the offering of FreeBSD in Azure, refer to [introduction to FreeBSD on Azure](/documentation/articles/virtual-machines-freebsd-intro-on-azure/).
