<properties
    pageTitle="Use a Linux troubleshooting VM with the Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-troubleshoot-recovery-disks/) - our next generation CLI for the resource management deployment model
...
Make sure that you have [the latest Azure CLI 1.0](/documentation/articles/cli-install-nodejs/) installed and logged in and using Resource Manager mode:
