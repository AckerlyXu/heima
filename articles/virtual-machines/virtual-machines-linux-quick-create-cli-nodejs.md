<properties
    pageTitle="Create a Linux VM using the Azure CLI 1.0 | Azure"
...
> [AZURE.NOTE]
To create a VM using the Azure CLI 2.0, see [Create a VM with the Azure CLI](/documentation/articles/virtual-machines-linux-quick-create-cli/).
