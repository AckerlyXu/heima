---
title: Azure PowerShell Script Sample - Create a VM from a snapshot | Azure
...
| Command | Notes |
|---|---|
| [Get-AzureRmSnapshot](https://docs.microsoft.com/powershell/module/azurerm.compute/get-azurermsnapshot) | Gets a snapshot using snapshot name. |
| [New-AzureRmDiskConfig](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermdiskconfig) | Creates a disk configuration. This configuration is used with the disk creation process. |
| [New-AzureRmDisk](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermdisk) | Creates a managed disk. |
...
| [Set-AzureRmVMOSDisk](https://docs.microsoft.com/powershell/module/azurerm.compute/set-azurermvmosdisk) | Attaches the managed disk as OS disk to the virtual machine |
...
| [New-AzureRmVM](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermvm) | Creates a virtual machine. |
