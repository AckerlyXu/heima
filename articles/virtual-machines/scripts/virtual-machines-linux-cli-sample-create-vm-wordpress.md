...
| [az vm extension set](https://docs.microsoft.com/cli/azure/vm#az_vm_create) | Add the Custom Script Extension to the virtual machine, which invokes a script to install WordPress. |
