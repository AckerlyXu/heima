<properties
    pageTitle="Azure PowerShell Script Sample - Create a Windows VM | Azure"
...
Additional virtual machine PowerShell script samples can be found in the [Azure Windows VM documentation](/documentation/articles/virtual-machines-windows-powershell-samples/).