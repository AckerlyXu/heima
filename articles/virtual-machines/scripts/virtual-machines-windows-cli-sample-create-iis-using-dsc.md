...
| [az vm extension set](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest#az_vm_create) | Add the Custom Script Extension to the virtual machine which invokes a script to install IIS. |
