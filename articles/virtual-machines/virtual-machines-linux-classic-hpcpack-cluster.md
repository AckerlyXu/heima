...
---
title: Linux compute VMs in an HPC Pack cluster | Azure
...
### Prerequisites
* **Azure subscription** - You can use a subscription in either the Azure Global or Azure China service. If you don't have an account, you can create a [free account](https://www.azure.cn/pricing/1rmb-trial/) in just a couple of minutes.
