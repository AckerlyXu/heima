<properties
    pageTitle="Storage solutions for Windows VMs in Azure | Azure"
...
This section does not apply to [Azure Managed Disks](/documentation/articles/storage-managed-disks-overview/), as you do not create separate storage accounts. 
