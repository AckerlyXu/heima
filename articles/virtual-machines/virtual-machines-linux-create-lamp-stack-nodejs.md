<properties
    pageTitle="Deploy LAMP on a Linux virtual machine with the Azure CLI 1.0 | Azure"
...
This article walks you through how to deploy an Apache web server, MySQL, and PHP (the LAMP stack) on Azure. You need an Azure Account ([get a trial](/pricing/1rmb-trial/)) and the [Azure CLI](/documentation/articles/cli-install-nodejs/) that is [connected to your Azure account](/documentation/articles/xplat-cli-connect/).

## CLI versions to complete the task
You can complete the task using one of the following CLI versions:

- [Azure CLI 1.0] - our CLI for the classic and resource management deployment models (this article)
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-create-lamp-stack/) - our next generation CLI for the resource management deployment model
...
You can start by creating a [resource group](/documentation/articles/resource-group-overview/) that will contain the new VM:
