...
<properties
    pageTitle="Reset access with the VMAccess Extension and Azure CLI 2.0 | Azure"
...
This article shows you how to use the Azure VMAcesss Extension to check or repair a disk, reset user access, manage user accounts, or reset the SSHD configuration on Linux. You can also perform these steps with the [Azure CLI 1.0](/documentation/articles/virtual-machines-linux-using-vmaccess-extension-nodejs/).
