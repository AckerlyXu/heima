...
This article shows you how to use the Azure VMAcesss Extension to check or repair a disk, reset user access, manage user accounts, or reset the SSHD configuration on Linux. You can also perform these steps with the [Azure CLI 1.0](./virtual-machines-linux-using-vmaccess-extension-nodejs.md).
