<properties
    pageTitle="Moving files to and from a Linux VM using SCP | Azure"
...
For more information on configuring your `~/.ssh/config` and SSH public and private keys, follow this article, [Create SSH keys](/documentation/articles/virtual-machines-linux-mac-create-ssh-keys/).
