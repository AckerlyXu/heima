...
* [Encrypt disks on a Linux VM using the Azure CLI](./virtual-machines-linux-encrypt-disks.md)

* [Access and security in Azure Resource Manager templates](./virtual-machines-linux-dotnet-core-3-access-security.md)