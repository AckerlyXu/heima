<properties
    pageTitle="Configure SSHD on Azure Linux Virtual Machines | Azure"
...
* [Encrypt disks on a Linux VM using the Azure CLI](/documentation/articles/virtual-machines-linux-encrypt-disks/)

* [Access and security in Azure Resource Manager templates](/documentation/articles/virtual-machines-linux-dotnet-core-3-access-security/)