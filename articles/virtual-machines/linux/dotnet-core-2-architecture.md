...
For more information on Azure Storage, see [Azure Storage documentation](/storage/).
...
For more information on Azure Virtual Networks, see [Azure Virtual Network documentation](/virtual-network/).
...
For more information on deploying Azure SQL Database, see [Azure SQL Database documentation](/sql-database/).
