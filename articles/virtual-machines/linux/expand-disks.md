...
4. SSH to your VM with the appropriate credentials. You can obtain the public IP address of your VM with [az vm show](https://docs.microsoft.com/cli/azure/vm#show):
