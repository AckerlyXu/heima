---
title: Overview of cloud-init support for Linux virtual machines in Azure | Azure
description: Overview of cloud-init capabilities in Azure
...
The final step is to create a VM with the [az vm create](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest#az_vm_create) command. 
