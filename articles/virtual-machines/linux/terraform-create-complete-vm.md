...
The following section creates a resource group named *myResourceGroup* in the *chinaeast* location:
...
<!--Update_Description: update meta properties， wording update, add new feature on create VM scripts.-->