---
title: Compute benchmark scores for Azure Linux VMs | Azure
...
<!--Pending for EV3 and DV3 releasement -->
<!--Pending for EV3 and DV3 releasement -->
...
<!-- Not Available ## G - Compute Optimized-->

<!-- Not Available ## GS - Storage Optimized-->

<!-- Not Available ## H - High Performance Compute (HPC) -->

<!-- Not Available ## HPC - A8-11 -->
<!-- Not Available ## Ls - Storage Optimized -->
<!-- Not Available ## M - Memory Optimized -->
## About CoreMark
...
date run. 
<!-- Pending B Series Release -->
Basic A and B (Burstable) series not shown because performance is variable. 
<!-- Pending B Series Release -->

<!-- Not Available on N series not shown as they are GPU centric and Coremark doesn't measure GPU performance.-->
