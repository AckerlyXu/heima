...
(machine) Azure: To sign in, use a web browser to open the page https://aka.ms/deviceloginchina. Enter the code <code> to authenticate.
...
![Running ngnix container](./media/docker-machine/nginxsuccess.png)

## Next steps
If you're interested, you can try out the Azure [Docker VM Extension](dockerextension.md?toc=%2fvirtual-machines%2flinux%2ftoc.json) to do the same operation using the Azure CLI or Azure resource manager templates. 
