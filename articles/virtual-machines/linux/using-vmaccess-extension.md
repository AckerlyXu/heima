...
The following examples use raw JSON files. Use [az vm extension set](https://docs.azure.cn/zh-cn/cli/vm/extension?view=azure-cli-latest#az-vm-extension-set) to then call your JSON files. These JSON files can also be called from Azure templates. 
