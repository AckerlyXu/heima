---
title: Manage Linux virtual machines with the Azure CLI | Azure
...
To complete this tutorial, make sure that you have installed the latest [Azure CLI 2.0](https://docs.microsoft.com/cli/azure/install-azure-cli).

## Step 1 - Log in to Azure

First, open up a terminal and log in to your Azure subscription with the [az login](https://docs.microsoft.com/cli/azure/#login) command.
...
An Azure resource group is a logical container into which Azure resources are deployed and managed. A resource group must be created before a virtual machine. In this example, a resource group named `myResourceGroup` is created in the `chinanorth` region. 
