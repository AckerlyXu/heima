...
- Customer on-premises infrastructure, datacenters and application deployments are connected to the Azure cloud platform through Azure ExpressRoute (recommended) or Virtual Private Network (VPN). Active Directory (AD) and DNS are also extended into Azure.
...
As of December 2016, SAP HANA on Azure (Large Instances) is available in six configurations in the Azure Regions of US West and China East:
...
The different configurations above are referenced in [SAP Support Note #2316233 - SAP HANA on Azure (Large Instances)](https://launchpad.support.sap.com/#/notes/2316233/E).
...
- Microsoft Premier Mission Critical Support. See [SAP Support Note #2015553 - SAP on Azure: Support Prerequisites](https://launchpad.support.sap.com/#/notes/2015553) for specific information related to running SAP in Azure.
...
While a hybrid SAP landscape (with four or more different deployment scenarios) is typical, there are instances of a complete SAP landscape in Azure, and as Azure VMs become ever more powerful, the number of SAP solutions deploying on Azure VMs will grow.
