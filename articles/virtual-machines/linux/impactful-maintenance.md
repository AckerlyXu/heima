---
title: VM restarting maintenance for Linux VMs in Azure | Azure
...
of its pair. For example, when updating the Virtual Machines in China North,
Azure will not update any Virtual Machines in China East
