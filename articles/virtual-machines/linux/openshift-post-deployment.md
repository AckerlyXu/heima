---
title: OpenShift on Azure post-deployment tasks | Azure
...
- Home page: OpenShift console URL (for example, https://masterdns343khhde.chinanorth.cloudapp.chinacloudapi.cn:8443/console)
- Identifier URI: OpenShift console URL (for example, https://masterdns343khhde.chinanorth.cloudapp.chinacloudapi.cn:8443/console)
- Reply URL: Master public URL and the app registration name (for example, https://masterdns343khhde.chinanorth.cloudapp.chinacloudapi.cn:8443/oauth2callback/OCPAzureAD)
