...
- [Azure CLI 2.0](./virtual-machines-linux-expand-disks.md) - our next generation CLI for the resource management deployment model

## Prerequisites
You need the [latest Azure CLI 1.0](/documentation/articles/cli-install-nodejs/) installed and logged in to an [Azure account](https://www.azure.cn/pricing/1rmb-trial/) using the Resource Manager mode as follows:
