<properties
    pageTitle="Upload a custom Linux image with Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-upload-vhd/) - our next generation CLI for the resource management deployment model
