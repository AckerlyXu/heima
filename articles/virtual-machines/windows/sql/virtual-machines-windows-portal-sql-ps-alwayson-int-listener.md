...
> [!NOTE]
> If you created your availability group with the [Azure template](virtual-machines-windows-portal-sql-alwayson-availability-groups.md), the internal load balancer was already created. 
> 
> 
