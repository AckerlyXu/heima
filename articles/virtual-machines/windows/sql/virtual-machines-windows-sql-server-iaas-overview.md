...
## Next steps
For questions about pricing, see [Pricing](/pricing/details/virtual-machines/). Select your target edition of SQL Server in the **VM type** list. Then view the prices for differently sized virtual machines. 
