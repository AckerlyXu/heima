...
> [!NOTE]
> When you query SQL Server in a VM over the internet, all outgoing data from the Azure datacenter is subject to normal [pricing on outbound data transfers](https://www.azure.cn/pricing/details/data-transfer/).
...
<!--Update_Description: wording update, add Manual configuration and troubleshooting content -->