...
For more information, see [Configure availability groups in Azure (manually)](virtual-machines-windows-portal-sql-alwayson-availability-groups-manual.md).
