...
- [Install the latest Azure PowerShell commands](https://docs.microsoft.com/powershell/azure/overview) if you plan to configure Automated Backup with PowerShell.
