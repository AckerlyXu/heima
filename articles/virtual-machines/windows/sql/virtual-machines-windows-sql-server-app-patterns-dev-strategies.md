...
Note that the Load Balancer in Azure works similar to load balancers in an on-premises environment. For more information, see [Load balancing for Azure infrastructure services](../load-balance.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json).
