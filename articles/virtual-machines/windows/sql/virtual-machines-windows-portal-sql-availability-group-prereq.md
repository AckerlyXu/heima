...
You need an Azure account. You can [open a trial Azure account](https://www.azure.cn/pricing/1rmb-trial) or [activate Visual Studio subscriber benefits](https://www.azure.cn/support/legal/offer-rate-plans/?WT.mc_id=A261C142F).
