...
You can now view this machine in the Azure Portal Preview to see [its public IP address and its fully qualified domain name](/documentation/articles/virtual-machines-windows-portal-sql-server-provision/).
