---
title: Desired State Configuration extension with Azure Resource Manager templates | Azure
...
This article describes the Azure Resource Manager template for the [Desired State Configuration (DSC) extension handler](extensions-dsc-overview.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json). 
...
The following snippet goes in the **Resource** section of the template. The DSC extension inherits default extension properties. For more information, see [VirtualMachineExtension class](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.management.compute.models.virtualmachineextension?view=azure-dotnet.).
...
The DSC extension inherits default extension properties. For more information, see [VirtualMachineScaleSetExtension class](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.management.compute.models.virtualmachinescalesetextension?view=azure-dotnet).
...
For more information about the following values, see [Local Configuration Manager basic settings](https://docs.microsoft.com/powershell/dsc/metaconfig#basic-settings). You can use the DSC extension default configuration script to configure only the LCM properties that are listed in the following table.
...
The following example is from the [DSC extension handler overview](extensions-dsc-overview.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json). This example uses Resource Manager templates instead of cmdlets to deploy the extension. Save the IisInstall.ps1 configuration, place it in a .zip file, and then upload the file in an accessible URL. This example uses Azure Blob storage, but you can download .zip files from any arbitrary location.
...
* Find more details about [DSC's secure credential management](extensions-dsc-credentials.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json).
* Get an [introduction to the Azure DSC extension handler](extensions-dsc-overview.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json).
