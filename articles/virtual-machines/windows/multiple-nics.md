---
title: Create a Windows virtual machine that has multiple NICs | Azure
...
This article provides quick commands to create a VM that has multiple NICs attached to it. For detailed information, including how to create multiple NICs within your own PowerShell scripts, read more about [deploying multiple-NIC VMs](../../virtual-network/virtual-network-deploy-multinic-arm-ps.md). Different [VM sizes](sizes.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json) support a varying number of NICs, so size your VM accordingly.

## Prerequisites
Make sure that you have the [latest Azure PowerShell version installed and configured](https://docs.microsoft.com/powershell/azure/overview). Log in to your Azure account:
