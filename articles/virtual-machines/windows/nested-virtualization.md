---
title: How to enable nested virtualization in Azure Virtual Machines | Azure 
...
You can view the regional availability of Dv3 or Ev3 series virtual machines [here](https://www.azure.cn/support/service-dashboard/services/).

>[!NOTE]
>
>For detailed instructions on creating a new virtual machine, see [Create and Manage Windows VMs with the Azure PowerShell module](/virtual-machines/windows/tutorial-manage-vm)
