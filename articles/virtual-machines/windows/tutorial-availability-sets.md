...
When you create a VM configuration using [New-AzureRMVMConfig](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermvmconfig) you use the `-AvailabilitySetId` parameter to specify the ID of the availability set.
