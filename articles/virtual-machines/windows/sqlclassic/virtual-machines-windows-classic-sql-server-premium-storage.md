...
## Overview
[Azure Premium Storage](../premium-storage.md) is the next generation of storage that provides low latency and high throughput IO. It works best for key IO intensive workloads, such as SQL Server on IaaS [Virtual Machines](https://www.azure.cn/home/features/virtual-machines/).
