...
Create three virtual machines. One is for a cluster node and two are for SQL Server. To create each of the virtual machines, go back to the Azure Classic Management Portal, click **New** > **Compute** > **Virtual Machine** > **From Gallery**. Then, use the templates in the following table to help you create the virtual machines.
