...
For more information, see [Capturing a VM to an image](/virtual-machines/windows/capture-image-resource).
...
Additionally, your development tasks or technologies might need more scale - like varieties of development configurations and multiple machine configurations.  You can use Azure DevTest Labs to create _recipes_ that automate the construction of your 'golden image,' and to manage policies for your team's running VMs.  [Using Azure DevTest Labs for developers](/devtest-lab/devtest-lab-developer-lab) is the best source for more information on DevTest Labs.
