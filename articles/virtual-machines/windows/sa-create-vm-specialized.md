...
You should see the newly created VM either in the [Azure portal](https://portal.azure.cn), under **All services** > **Virtual machines**, or by using the following PowerShell commands:
