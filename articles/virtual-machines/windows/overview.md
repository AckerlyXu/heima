...
Azure provides many [marketplace images](https://market.azure.cn/zh-cn/marketplace/virtual-machines/) to use with various versions and types of Windows Server operating systems. Marketplace images are identified by image publisher, offer, sku, and version (typically version is specified as latest). 
...
| Azure CLI |[Create a VM with the Azure CLI](/virtual-machines/scripts/virtual-machines-windows-cli-sample-create-vm) |
...
| Azure PowerShell |For information about using PowerShell to manage VMs, see [Create and manage Windows VMs with the Azure PowerShell module](tutorial-manage-vm.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json). |
...
| Azure CLI |For information about using Azure CLI to manage VMs, see [Azure CLI Reference](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest). |
