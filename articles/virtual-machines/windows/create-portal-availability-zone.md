---
title: Create a zoned Windows VM with the Azure portal | Azure
...
When the VM is deployed in an availability zone, the IP address and managed disk resources are deployed in the same availability zone. You can confirm the zone settings using Azure PowerShell. If you need to install or upgrade, see [Install Azure PowerShell module](https://docs.microsoft.com/powershell/azure/install-azurerm-ps).
...
Find the zone of the public IP address with [Get-AzureRmPublicIpAddress](https://docs.microsoft.com/powershell/module/azurerm.network/get-azurermpublicipaddress):
...
The managed disk resource for the VM is also created in the same availability zone. You can verify this with [Get-AzureRmDisk](https://docs.microsoft.com/powershell/module/azurerm.compute/get-azurermdisk):
...
<!-- Update_Description: new articles on create availablility zone on portal  -->
<!--ms.date: 03/19/2018-->