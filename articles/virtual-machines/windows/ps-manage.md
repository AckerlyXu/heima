...
See [Sizes for virtual machines in Azure](sizes.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json) for a list of available sizes for a virtual machine.
...
- Take advantage of using a template to create a virtual machine by using the information in [Create a Windows virtual machine with a Resource Manager template](ps-template.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)
