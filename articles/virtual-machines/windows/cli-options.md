...
This document details the ways that the Azure CLI can be installed and run on Windows and details syntactical considerations for each. For in-depth Azure CLI documentation see, [Azure CLI documentation]( https://docs.azure.cn/zh-cn/cli/overview?view=azure-cli-latest).
...
| Install the Azure CLI |[Install the CLI on WSL/Ubuntu 14.04](https://docs.azure.cn/zh-cn/cli/install-az-cli2?view=azure-cli-latest#ubuntu)|
...
To use the Azure CLI on Windows, install the package using these instructions, [Install the CLI on Windows](https://docs.azure.cn/zh-cn/cli/install-az-cli2?view=azure-cli-latest#windows).
