...
For a complete walk-through of how to prepare, upload and create a new VM using managed disks, see [Upload a specialized VHD to create a VM in Azure](upload-specialized.md).
