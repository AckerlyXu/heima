...
* [How to attach a data disk to a Linux VM in the Azure portal preview](./virtual-machines-linux-attach-disk-portal.md)
...
* [Create a Fully Qualified Domain Name in the Azure portal preview](./virtual-machines-linux-portal-create-fqdn.md)

## Next steps
You now have an overview of Linux on Azure.  The next step is to dive in and create a few VMs!

* [Explore our growing list of Sample Scripts for common tasks via AzureCLI](./virtual-machines-linux-cli-samples.md)