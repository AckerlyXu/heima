...
If you don't have another VM in the same virtual network, you can easily create one. For more information, see [Create a Linux VM on Azure using the CLI](./virtual-machines-linux-quick-create-cli.md). Delete the extra VM when you are done with your testing.
