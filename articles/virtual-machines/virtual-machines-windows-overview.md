...
Azure charges an [hourly price](/pricing/details/virtual-machines/) based on the VM's size and operating system. For partial hours, Azure charges only for the minutes used. Storage is priced and charged separately.
...
Virtual machines use [virtual hard disks (VHDs)](/documentation/articles/storage-about-disks-and-vhds-windows/) to store their operating system (OS) and data. VHDs are also used for the images you can choose from to install an OS. 
...
* **Collect diagnostics data** - The [Azure Diagnostics Extension](/documentation/articles/virtual-machines-windows-extensions-diagnostics-template/) helps you configure the VM to collect diagnostics data that can be used to monitor the health of your application.
...
| [Network interface](/documentation/articles/virtual-network-network-interface/) |Yes |The VM needs the network interface to communicate in the network. |
