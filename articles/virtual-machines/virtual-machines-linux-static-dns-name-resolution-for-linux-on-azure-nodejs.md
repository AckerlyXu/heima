<properties
    pageTitle="Using internal DNS for VM name resolution on Azure | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-static-dns-name-resolution-for-linux-on-azure/) - our next generation CLI for the resource management deployment model
...
A Resource Group is needed to organize everything we create in this walkthrough.  For more information on Azure Resource Groups, see [Azure Resource Manager overview](/documentation/articles/resource-group-overview/)
