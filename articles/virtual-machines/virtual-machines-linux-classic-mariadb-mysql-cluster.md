...
9. Optimize the system for performance. For more information, see [performance tuning strategy](./virtual-machines-linux-classic-optimize-mysql.md).
...
You might want to look at [another way to cluster MySQL on Linux](./virtual-machines-linux-classic-mysql-cluster.md) and ways to [optimize and test MySQL performance on Azure Linux VMs](./virtual-machines-linux-classic-optimize-mysql.md).
