<properties
    pageTitle="Using cloud-init to customize a Linux VM during creation in Azure | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-using-cloud-init/) - our next generation CLI for the resource management deployment model
