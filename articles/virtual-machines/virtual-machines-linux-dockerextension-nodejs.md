---
title: Use the Azure Docker VM extension with the Azure CLI 1.0 | Azure
...
- [Azure CLI 2.0](./virtual-machines-linux-dockerextension.md) - our next generation CLI for the resource management deployment model 
