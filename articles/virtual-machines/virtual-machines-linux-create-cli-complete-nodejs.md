...
To create this custom environment, you need the latest [Azure CLI 1.0](/documentation/articles/cli-install-nodejs/) in Resource Manager mode (`azure config mode arm`). You also need a JSON parsing tool. This example uses [jq](https://stedolan.github.io/jq/).
...
- [Azure CLI 2.0](./virtual-machines-linux-create-cli-complete.md) - our next generation CLI for the resource management deployment model
