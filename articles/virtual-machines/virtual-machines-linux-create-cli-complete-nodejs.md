<properties
    pageTitle="Create a complete Linux environment with the Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-machines-linux-create-cli-complete/) - our next generation CLI for the resource management deployment model
