<properties
    pageTitle="Create a managed disk from a VHD in Azure| Azure"
...
## Next Steps	
- If you already have a VM, you can [attach a data disk](/documentation/articles/virtual-machines-windows-attach-disk-portal/).