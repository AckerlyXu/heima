<properties
    pageTitle="Create an Azure function app and Azure Storage account | Azure"
...
## What you will do
Use an Azure Resource Manager template to create an Azure function app and an Azure storage account. The Azure function app listens to Azure IoT hub events, processes incoming messages, and writes them to Azure Table storage. If you have any problems, seek solutions on the [troubleshooting page](/documentation/articles/iot-hub-raspberry-pi-kit-node-troubleshooting/).
...
* [Get started with Raspberry Pi 3](/documentation/articles/iot-hub-raspberry-pi-kit-node-get-started/)
* [Create your Azure IoT hub](/documentation/articles/iot-hub-raspberry-pi-kit-node-get-started/)
...
* Replace **[your IoT Hub name]** with **{my hub name}** that you specified when you [created your IoT hub and registered Raspberry Pi 3](/documentation/articles/iot-hub-raspberry-pi-kit-node-lesson2-prepare-azure-iot-hub/).
...
## Next steps
[Run a sample application to send device-to-cloud messages on Raspberry Pi 3](/documentation/articles/iot-hub-raspberry-pi-kit-node-lesson3-run-azure-blink/)
