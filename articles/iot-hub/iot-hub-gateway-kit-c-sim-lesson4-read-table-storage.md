...
- [Created the Azure function app and the Azure storage account](/documentation/articles/iot-hub-gateway-kit-c-sim-lesson4-deploy-resource-manager-template/).
- [Run the gateway sample application](/documentation/articles/iot-hub-gateway-kit-c-sim-lesson3-configure-simulated-device-app/).
...
2. Replace `[Azure storage connection string]` with the Azure storage connection string that you obtained.
   ...
   `[IoT hub connection string]` should already be replaced in section [Read messages from Azure IoT Hub](/documentation/articles/iot-hub-gateway-kit-c-sim-lesson3-read-messages-from-hub/) in Lesson3.
