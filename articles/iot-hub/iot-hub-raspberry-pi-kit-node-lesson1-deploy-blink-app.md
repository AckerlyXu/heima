...
* [Configure your device](/documentation/articles/iot-hub-raspberry-pi-kit-node-lesson1-configure-your-device/)
...
You should now see the LED on Pi blinking every two seconds.  If you don’t see the LED blinking, see the [troubleshooting guide](/documentation/articles/iot-hub-raspberry-pi-kit-node-troubleshooting/) for solutions to common problems.
...
## Next steps
[Get the Azure tools](/documentation/articles/iot-hub-raspberry-pi-kit-node-lesson2-get-azure-tools-win32/)
