...
* **sku-name**. The name of the sku, one of: [F1, S1, S2, S3]. For details about each sku, see [Azure IoT Hub pricing](https://www.azure.cn/pricing/details/iot-hub/). Currently, basic tiers are only available through the portal. 
