<properties
    pageTitle="Create an IoT Hub using Azure CLI (az.py) | Azure"
...
* [Azure CLI (azure.js)](/documentation/articles/iot-hub-create-using-cli-nodejs/) – the CLI for the classic and resource management deployment models.
