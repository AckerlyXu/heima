<properties
    pageTitle="Create an Azure IoT Hub using a template (.NET) | Azure"
...
> [AZURE.NOTE] Azure has two different deployment models for creating and working with resources:  [Azure Resource Manager and classic](/documentation/articles/resource-manager-deployment-model/).  This article covers using the Azure Resource Manager deployment model.
