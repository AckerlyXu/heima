<properties
    pageTitle="Run a sample application to receive cloud-to-device messages | Azure"
...
## What you need
* Raspberry Pi 3, set up for use. To learn how to set up Pi, see [Configure your device](/documentation/articles/iot-hub-raspberry-pi-kit-c-lesson1-configure-your-device/).
* An IoT hub that is created in your Azure subscription. To learn how to create your IoT hub, see [Create your IoT hub and register Raspberry Pi 3](/documentation/articles/iot-hub-raspberry-pi-kit-c-lesson2-prepare-azure-iot-hub/).
...
2. Initialize the configuration file by running the following commands:
   ...
   If you completed the steps in [Create an Azure function app and storage account](/documentation/articles/iot-hub-raspberry-pi-kit-c-lesson3-deploy-resource-manager-template/) on this computer, all the configurations are inherited, so you can skip to step to the task of deploying and running the sample application. If you completed the steps in [Create an Azure function app and storage account](/documentation/articles/iot-hub-raspberry-pi-kit-c-lesson3-deploy-resource-manager-template/) on a different computer, you need to replace the placeholders in the `config-raspberrypi.json` file. The `config-raspberrypi.json` file is in the subfolder of your home folder.
...
## Next steps
[Change the on and off behavior of the LED](/documentation/articles/iot-hub-raspberry-pi-kit-c-lesson4-change-led-behavior/)
