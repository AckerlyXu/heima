...
These files are typically batch processed in the cloud using tools such as the [Hadoop](../hdinsight/index.md) stack. When you need to upland files from a device, you can still use the security and reliability of IoT Hub.
...
You can use the **iothubowner** connection string from your IoT Hub to complete this section. You will find the connection string in the [Azure portal](https://portal.azure.cn/) on the **Shared access policy** blade.
...
<!-- Links -->
[Azure IoT Developer Center]: https://docs.azure.cn/zh-cn/develop/iot
