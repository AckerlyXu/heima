...
- For the **Username** field, use `{iothubhostname}/{device_id}/api-version=2016-11-14`, where {iothubhostname} is the full CName of the IoT hub.
    ...
    For example, if the name of your IoT hub is **contoso.azure-devices.cn** and if the name of your device is **MyDevice01**, the full **Username** field should contain:
...
client.username_pw_set(username=iot_hub_name+".azure-devices.cn/" + device_id, password=sas_token)
