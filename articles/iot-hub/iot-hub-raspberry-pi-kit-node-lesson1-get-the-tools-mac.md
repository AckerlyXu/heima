<properties
    pageTitle="Get the tools (macOS 10.10) | Azure"
...
## What you will do
Download the development tools and the software for the first sample application for your Raspberry Pi 3. If you have any problems, look for solutions on the [troubleshooting page](/documentation/articles/iot-hub-raspberry-pi-kit-node-troubleshooting/).
...
If you experience issues installing Node.js and these additional development tools on macOS, see the [troubleshooting guide](/documentation/articles/iot-hub-raspberry-pi-kit-node-troubleshooting/) for solutions to common problems.
