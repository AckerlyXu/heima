<properties
    pageTitle="IP address types in Azure (Classic) | Azure"
...
You can assign a public IP address directly to an IaaS [VM](/documentation/articles/virtual-machines-linux-azure-overview/) or PaaS role instance within a cloud service. This is referred to as an instance-level public IP address ([ILPIP](/documentation/articles/virtual-networks-instance-level-public-ip/)). This public IP address can be dynamic only.
