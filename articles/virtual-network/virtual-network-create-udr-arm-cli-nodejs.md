<properties
    pageTitle="Control routing and virtual appliances using the Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-network-create-udr-arm-cli/) - our next generation CLI for the resource management deployment model 
