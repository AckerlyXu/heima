---
title: Configure reverse lookup zones for an SMTP banner check in Azure| Azure
...
If you host an SMTP server in Azure, you may receive the following error message when send or receive a message from remote mail servers:
