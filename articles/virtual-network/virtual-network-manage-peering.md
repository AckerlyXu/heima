...
- If using Azure Command-line interface (CLI) commands to complete tasks in this article, [install and configure the Azure CLI](https://docs.azure.cn/zh-cn/cli/install-azure-cli?toc=%2fvirtual-network%2ftoc.json?view=azure-cli-latest). Ensure you have the most recent version of the Azure CLI installed. To get help for CLI commands, type `az <command> --help`. Rather than installing the CLI and its pre-requisites, you can use the Azure Cloud Shell. The Azure Cloud Shell is a free Bash shell that you can run directly within the Azure portal. The Cloud Shell has the Azure CLI preinstalled and configured to use with your account. To use the Cloud Shell, click the Cloud Shell **>_** button at the top of the [portal](https://portal.azure.cn). 
...
1. Log in to the [portal](https://portal.azure.cn) with an account that is assigned the necessary [role or permissions](#permissions).
...
|Tool|Command|
|---|---|
|CLI|[az network vnet peering create](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?view=azure-cli-latest#create?toc=%2fvirtual-network%2ftoc.json#create)|
...
|Tool|Command|
|---|---|
|CLI|[az network vnet peering list](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?toc=%2fvirtual-network%2ftoc.json?view=azure-cli-latest#list) to list peerings for a virtual network, [az network vnet peering show](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?toc=%2fvirtual-network%2ftoc.json?view=azure-cli-latest#show) to show settings for a specific peering, and [az network vnet peering update](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?toc=%2fvirtual-network%2ftoc.json?view=azure-cli-latest#update) to change peering settings.|
...
|Tool|Command|
|---|---|
|CLI|[az network vnet peering delete](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?toc=%2fvirtual-network%2ftoc.json?view=azure-cli-latest#delete)|
|PowerShell|[Remove-AzureRmVirtualNetworkPeering](https://docs.microsoft.com/powershell/module/azurerm.network/remove-azurermvirtualnetworkpeering?toc=%2fvirtual-network%2ftoc.json)|
