...
|Tool|Command|
|---|---|
|CLI|[az network vnet peering create](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?view=azure-cli-latest#create)|
...
|Tool|Command|
|---|---|
|CLI|[az network vnet peering list](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?view=azure-cli-latest#list) to list peerings for a virtual network, [az network vnet peering show](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?view=azure-cli-latest#show) to show settings for a specific peering, and [az network vnet peering update](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?view=azure-cli-latest#update) to change peering settings.|
...
|Tool|Command|
|---|---|
|CLI|[az network vnet peering delete](https://docs.azure.cn/zh-cn/cli/network/vnet/peering?view=azure-cli-latest#delete)|
