...
Visit the [Virtual network documentation](/virtual-network/) to get started. This content provides overview and deployment information for all of the VNet features.
...
Yes. You can deploy a [WAN optimization network virtual appliance](https://market.azure.cn/zh-cn/marketplace/apps?search=wan+optimization) from several vendors through the Azure Marketplace.
...
Yes. See [Azure limits](../azure-subscription-service-limits.md?toc=%2fvirtual-network%2ftoc.json#networking-limits) for details. Subnet address spaces cannot overlap one another.
...
- **An Azure VPN Gateway**: For details, see [Configure a VNet-to-VNet connection](../vpn-gateway/vpn-gateway-howto-vnet-vnet-resource-manager-portal.md?toc=%2fvirtual-network%2ftoc.json). 
...
Reference [Azure limits](../azure-subscription-service-limits.md?toc=%2fvirtual-network%2ftoc.json#networking-limits).
...
* [Integrate your app with an Azure Virtual Network](../app-service/web-sites-integrate-with-vnet.md?toc=%2fvirtual-network%2ftoc.json)
* [Using VNet Integration and Hybrid Connections with Web Apps](../app-service/web-sites-integrate-with-vnet.md?toc=%2fvirtual-network%2ftoc.json)
...
Yes. You can deploy a [firewall network virtual appliance](https://market.azure.cn/zh-cn/marketplace/apps?search=firewall) from several vendors through the Azure Marketplace.

### Is there information available about securing VNets?
Yes. For details, see [Azure Network Security Overview](../security/security-network-overview.md?toc=%2fvirtual-network%2ftoc.json).

## APIs, schemas, and tools

### Can I manage VNets from code?
Yes. You can use REST APIs for VNets in the [Azure Resource Manager](https://docs.microsoft.com/rest/api/virtual-network) and [classic (Service Management)](http://go.microsoft.com/fwlink/?LinkId=296833) deployment models.
...
- PowerShell to manage VNets deployed through the [Resource Manager](https://docs.microsoft.com/powershell/module/azurerm.network) and [classic](https://docs.microsoft.com/powershell/module/azure/?view=azuresmps-3.7.0) deployment models.
- The Azure command-line interface (CLI) to deploy and manage VNets deployed through the [Resource Manager](https://docs.azure.cn/zh-cn/cli/network/vnet?view=azure-cli-latest) and [classic](../virtual-machines/azure-cli-arm-commands.md?toc=%2fvirtual-network%2ftoc.json#azure-network-commands-to-manage-network-resources) deployment models.
