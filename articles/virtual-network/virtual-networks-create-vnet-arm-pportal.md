---
title: Create an Azure virtual network with subnets | Azure
...
1. In an Internet browser, go to the [Azure portal](https://portal.azure.cn). Sign in by using your [Azure account](../azure-glossary-cloud-terminology.md?toc=%2fvirtual-network%2ftoc.json#account). If you don't have an Azure account, you can sign up for a [trial](https://azure.microsoft.com/offers/ms-azr-0044p).
...
- Create a [Windows virtual machine](../virtual-machines/virtual-machines-windows-hero-tutorial.md?toc=%2fvirtual-network%2ftoc.json) or a [Linux virtual machine](../virtual-machines/linux/quick-create-portal.md?toc=%2fvirtual-network%2ftoc.json), and then connect it to the virtual network.
