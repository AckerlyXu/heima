---
title: Create a user-defined route to route network traffic through a network virtual appliance - PowerShell | Azure
...
You can either install and configure the latest version of the PowerShell [AzureRM](https://www.powershellgallery.com/packages/AzureRM/) module on your PC.
...
2. If running PowerShell from your computer, log in to Azure with your [Azure account](../azure-glossary-cloud-terminology.md?toc=%2fvirtual-network%2ftoc.json#account) using the `Login-AzureRmAccount -EnvironmentName AzureChinaCloud` command.
...
2. Log in to Azure using your [Azure account](../azure-glossary-cloud-terminology.md?toc=%2fvirtual-network%2ftoc.json#account). If you don't have an Azure account, you can sign up for a [trial](https://www.azure.cn/pricing/1rmb-trial-full).
...
<!-- Update_Description: update meta properties, update cmdlet code, wording update -->