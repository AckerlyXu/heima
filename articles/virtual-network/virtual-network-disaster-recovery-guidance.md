---
title: Virtual network business continuity | Azure
...
A VNet is created within the scope of a region. You can create VNets with same address space in two different regions (For example, China East and US West), but cannot connect them together. 
