<properties
    pageTitle="Create a virtual network using the Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-networks-create-vnet-arm-cli/) - our next generation CLI for the resource management deployment model
