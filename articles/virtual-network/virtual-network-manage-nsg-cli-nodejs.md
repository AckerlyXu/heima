<properties
    pageTitle="Manage network security groups - Azure CLI 1.0 | Azure"
...
- [Azure CLI 2.0](/documentation/articles/virtual-network-manage-nsg-arm-cli/) - our next generation CLI for the resource management deployment model (this article)
