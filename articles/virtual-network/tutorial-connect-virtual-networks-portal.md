---
title: Connect virtual networks with virtual network peering - Azure portal | Azure
...
> [Connect your computer to a virtual network](../vpn-gateway/vpn-gateway-howto-point-to-site-resource-manager-portal.md?toc=%2fvirtual-network%2ftoc.json)
