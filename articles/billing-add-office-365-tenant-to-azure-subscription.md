<properties
    pageTitle="Use an Office 365 tenant with an Azure subscription | Azure"
...
## Detailed steps
In this scenario, Kelley Wall is a user who has an Azure subscription under the account kelley.wall@outlook.com. Kelley also has an Office 365 subscription under the account kelley.wall@contoso.partner.onmschina.cn. Now Kelley wants to access the Office 365 tenant with the Azure subscription.
...
1. Sign in to the [Account Management portal](https://account.windowsazure.cn/subscriptions).
...
1. Sign in to the [Account Management portal](https://account.windowsazure.cn/subscriptions) with the service administrator credentials.
...
3. Add the Office 365 tenant to your Azure subscription.
    ...
    f. Sign in to the [Account Management portal](https://account.windowsazure.cn/subscriptions) with the service administrator credentials.
...
4. Change the directory associated with the Azure subscription.
    ...
    ![Screenshot of Azure Classic Management Portal settings icon](./media/billing-add-office-365-tenant-to-azure-subscription/s315_azure-classic-portal-settings-icon.png)
   ...
   > [AZURE.WARNING]
   > Additionally, all [Role-Based Access Control (RBAC)](/documentation/articles/role-based-access-control-configure/) users with Assigned access in the existing resource groups will also be removed. However, the warning you receive only mentions the removal of co-administrators.
   > 
   > 
...
5. Now you can add your Office 365 organizational accounts as co-administrators to the Azure Active Directory tenant.
    ...
    ![Screenshot of Azure Classic Management Portal settings administrators tab](./media/billing-add-office-365-tenant-to-azure-subscription/s319_azure-classic-portal-settings-administrators.png)
...
6. Next you can test access with the co-administrator.
    ...
    b. Open the [Account Management portal](https://account.windowsazure.cn/subscriptions) or the [Azure portal](https://portal.azure.cn/).
...
To learn how to accomplish these tasks, see [Use your existing Office 365 account with your Azure subscription, or vice versa](/documentation/articles/billing-use-existing-office-365-account-azure-subscription/).
