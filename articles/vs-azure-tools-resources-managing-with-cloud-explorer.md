<properties
    pageTitle="Managing Azure resources with Cloud Explorer | Azure"
...
- You must also have an Azure account and be logged into it to view Azure resources in Cloud Explorer. If you don't have one, you can create an account in just a couple of minutes. See [create a trial account](/pricing/1rmb-trial/).
