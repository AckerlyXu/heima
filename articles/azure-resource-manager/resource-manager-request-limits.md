<properties
    pageTitle="Azure Resource Manager request limits | Azure"
...
* For more information about limits and quotas, see [Azure subscription and service limits, quotas, and constraints](/documentation/articles/azure-subscription-service-limits/).
* To learn about handling asynchronous REST requests, see [Track asynchronous Azure operations](/documentation/articles/resource-manager-async-operations/).