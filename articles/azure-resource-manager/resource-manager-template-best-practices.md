...
For help with establishing a naming convention, see [Infrastructure naming guidelines](../virtual-machines/virtual-machines-windows-infrastructure-naming-guidelines.md).
...
1. Assign publicIPAddresses to a virtual machine only when required for an application. To connect for debug, management or administrative purposes, use either inboundNatRules, virtualNetworkGateways or a jumpbox.
    ...
    * [Allow external access to your VM using the Azure portal preview](../virtual-machines/virtual-machines-windows-nsg-quickstart-portal.md)
