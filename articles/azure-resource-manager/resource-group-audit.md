...
To retrieve log entries, run the [az monitor activity-log list](https://docs.azure.cn/zh-cn/cli/monitor/activity-log?view=azure-cli-latest#az-monitor-activity-log-list) command.
...
* To see the list of operations available for each Azure Resource Manager provider, see [Azure Resource Manager Resource Provider operations](../role-based-access-control/resource-provider-operations.md)
