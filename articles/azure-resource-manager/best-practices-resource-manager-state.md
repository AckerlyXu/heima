<properties
    pageTitle="Pass complex values between Azure templates | Azure"
...
For an example of using the outputs section of a linked template to return data disks for a virtual machine, see [Creating multiple data disks for a Virtual Machine](/documentation/articles/resource-group-create-multiple/).
...
## Next steps
* To learn about the sections of the template, see [Authoring Azure Resource Manager Templates](/documentation/articles/resource-group-authoring-templates/)
* To see the functions that are available within a template, see [Azure Resource Manager Template Functions](/documentation/articles/resource-group-template-functions/)