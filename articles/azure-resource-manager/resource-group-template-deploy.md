...
The following example shows the PowerShell script for deploying a template that is generated by the [export template](/documentation/articles/resource-manager-export-template/) feature:
