...
To test your template and parameter values without actually deploying any resources, use [Test-​Azure​Rm​Resource​Group​Deployment](https://docs.microsoft.com/powershell/module/azurerm.resources/test-azurermresourcegroupdeployment). 
...
## Next steps
* The examples in this article deploy resources to a resource group in your default subscription. To use a different subscription, see [Manage multiple Azure subscriptions](https://docs.microsoft.com/powershell/azure/manage-subscriptions-azureps).
