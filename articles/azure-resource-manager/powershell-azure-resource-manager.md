...
This article was updated for version 3.3.0. If you have an earlier version, your experience might not match the steps shown in this article. For documentation about the cmdlets in this version, see [AzureRM.Resources Module](https://docs.microsoft.com/powershell/module/azurerm.resources).
