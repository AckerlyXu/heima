---
title: Azure resource providers and resource types | Azure
...
* To view the operations for a resource provider, see [Azure REST API](https://docs.microsoft.com/zh-cn/rest/api/).