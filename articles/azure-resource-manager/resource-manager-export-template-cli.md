...
You can retrieve a template from your deployment history by using the [az group deployment export](https://docs.azure.cn/zh-cn/cli/group/deployment?view=azure-cli-latest#export) command. The following example saves the template that you previously deploy:
