...
| BadRequest | You sent deployment values that do not match what is expected by Resource Manager. Check the inner status message for help with troubleshooting. | [Template reference](https://docs.microsoft.com/en-us/azure/templates/) and [Supported locations](resource-manager-template-location.md) |
