...
## <a name="deploy-local-template"></a>Deploy local template
...
To test your template and parameter values without actually deploying any resources, use [az group deployment validate](https://docs.azure.cn/zh-cn/cli/group/deployment?view=azure-cli-latest#az_group_deployment_validate). 
