<properties
    pageTitle="Troubleshoot two-step verification | Azure"
...
If your phone was lost or stolen, we also recommend that you have your administrator reset your app passwords and clear any remembered devices. If your admin isn't sure how to accomplish this, point them to this article: [Manage users and devices](/documentation/articles/multi-factor-authentication-manage-users-and-devices/).
...
4. After you're back in your account, [manage your settings](/documentation/articles/multi-factor-authentication-end-user-manage-settings/) to change your authentication phone number.
...
### Clear your settings
If you have not configured a secondary authentication phone number, then you will have to contact your administrator for help. Have them clear your settings so the next time you sign in, you will be prompted to [set up your account](/documentation/articles/multi-factor-authentication-end-user-first-time/) again.
...
If you don’t have another method configured, contact your admin and ask them to clear your settings. The next time you sign in, you will be prompted to [set up multi-factor authentication](/documentation/articles/multi-factor-authentication-end-user-first-time/) again.
...
## Related topics
- [Manage your settings for two-step verification](/documentation/articles/multi-factor-authentication-end-user-manage-settings/)  
