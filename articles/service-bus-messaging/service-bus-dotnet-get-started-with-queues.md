...
> [!NOTE] 
> You can also create a Service Bus namespace and messaging entities using [PowerShell](https://docs.microsoft.com/en-us/powershell/azure/get-started-azureps). For more information, see [Use PowerShell to manage Service Bus resources](service-bus-manage-with-ps.md).
