<properties
    pageTitle="Create a Service Bus namespace with queue using an Azure Resource Manager template | Azure"
...
>-    [Create a Service Bus namespace ](/documentation/articles/service-bus-resource-manager-namespace-topic/)
...
[Service Bus queues](/documentation/articles/service-bus-queues-topics-subscriptions/#queues) offer First In, First Out (FIFO) message delivery to one or more competing consumers.
