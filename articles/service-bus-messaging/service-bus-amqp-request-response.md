<properties
    pageTitle="AMQP 1.0 in Service Bus request-response-based operations | Azure"
...
Represents a message in Service Bus which is mapped to an AMQP message. The mapping is defined in the [Service Bus AMQP protocol guide](/documentation/articles/service-bus-amqp-protocol-guide/) article.  
