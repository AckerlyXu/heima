...
For the full documentation for creating a monitor profile with the CLI, see the [CLI command reference](/cli/monitor/log-profiles#az-monitor-log-profiles-create)
