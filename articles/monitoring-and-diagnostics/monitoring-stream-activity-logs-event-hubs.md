<properties
	pageTitle="Stream the Azure Activity Log to Event Hubs | Azure"
...
The [**Azure Activity Log**](/documentation/articles/monitoring-overview-activity-logs/) can be streamed in near real time to any application using the built-in “Export” option in the portal, or by enabling the Service Bus Rule Id in a Log Profile via the Azure PowerShell Cmdlets or Azure CLI.
...
[The schema for the Activity Log is available here](/documentation/articles/monitoring-overview-activity-logs/). Each event is in an array of JSON blobs called “records.”

## Next Steps
- [Archive the Activity Log to a storage account](/documentation/articles/monitoring-archive-activity-log/)
- [Read the overview of the Azure Activity Log](/documentation/articles/monitoring-overview-activity-logs/)
- [Set up an alert based on an Activity Log event](/documentation/articles/insights-auditlog-to-webhook-email/)
