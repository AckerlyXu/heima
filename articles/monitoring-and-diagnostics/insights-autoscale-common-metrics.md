...
Azure Monitor autoscale applies only to [Virtual Machine Scale Sets](/virtual-machine-scale-sets/), [Cloud Services](/cloud-services/), and [App Service - Web Apps](/app-service/web/). Other Azure services use different scaling methods.
