<properties
	pageTitle="Archive Azure Diagnostic Logs | Azure"
...
[See this document](https://msdn.microsoft.com/zh-cn/library/azure/dn931931.aspx) for information on how you can set up a diagnostic setting using the Insights REST API.
...
## Next Steps
- [Download blobs for analysis](/documentation/articles/storage-dotnet-how-to-use-blobs/#download-blobs)
- [Stream Diagnostic Logs to Event Hubs](/documentation/articles/monitoring-stream-diagnostic-logs-to-event-hubs/)
- [Read more about Diagnostic Logs](/documentation/articles/monitoring-overview-of-diagnostic-logs/)
