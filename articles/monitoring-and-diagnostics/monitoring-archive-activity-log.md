<properties
	pageTitle="Archive the Azure Activity Log | Azure"
...
- [Stream the Activity Log to Event Hubs](/documentation/articles/monitoring-stream-activity-logs-event-hubs/)
- [Read more about the Activity Log](/documentation/articles/monitoring-overview-activity-logs/)
