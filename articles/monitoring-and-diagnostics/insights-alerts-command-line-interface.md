<properties
	pageTitle="Create alerts for Azure services - Cross-platform CLI | Azure"
...
1. Perform the Prerequisites and login to Azure. See [Azure Monitor CLI samples](/documentation/articles/insights-cli-samples/). In short, install the CLI and run these commands. They get you logged in, show what subscription you are using, and prepare you to run Azure Monitor commands.
...
* Get an [overview of collecting diagnostic logs](/documentation/articles/monitoring-overview-of-diagnostic-logs/) to collect detailed high-frequency metrics on your service.
