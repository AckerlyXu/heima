---
title: Azure Diagnostics extension configuration schema versions and history
...
The Azure Diagnostics extension is used with other Microsoft diagnostics products like Azure Monitor. For more information see [Microsoft Monitoring Tools Overview](monitoring-overview.md).
