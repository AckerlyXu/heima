...
6. Under **Actions** add 1 or more actions by providing a **Name** for the action, the **Action type** (for example, email or webhook), and **Details** for that particular action type (for example, a webhook URL, or email address).
