---
title: Get started with Power BI Workspace Collections
...
ms.author: v-junlch
---
# Get started with Power BI Workspace Collections
...
Resources for **Power BI Workspace Collections** are provisioned through the [Azure Resource Manager APIs](https://msdn.microsoft.com/library/mt712306.aspx). In this case, the resource provisioned is a **Power BI Workspace Collection**.
