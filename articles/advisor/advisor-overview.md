...
## What is Advisor?
Advisor is a personalized cloud consultant that helps you follow best practices to optimize your Azure deployments. It analyzes your resource configuration and usage telemetry and then recommends solutions that can help you improve the cost effectiveness, performance, high availability of your Azure resources.
...
You can access Advisor through the [Azure portal](https://portal.azure.cn/#blade/Microsoft_Azure_Expert/AdvisorBlade). Sign in to the [portal](https://portal.azure.cn), locate **Advisor** in the navigation menu, or search for it in the **All services** menu.
...
Advisor provides recommendations for virtual machines, availability sets, application gateways, SQL databases.
