<properties
    pageTitle="Manage Key Vault using CLI | Azure"
...
> 
> Currently, you cannot configure Azure Key Vault in the Azure portal. Instead, use these Cross-Platform Command-Line Interface  instructions. Or, for Azure PowerShell instructions, see [this equivalent tutorial](/documentation/articles/key-vault-get-started/).
> 
> 
...
For more information about using an organizational account with Azure, see [Sign up for Azure as an Organization](/documentation/articles/sign-up-organization/).
