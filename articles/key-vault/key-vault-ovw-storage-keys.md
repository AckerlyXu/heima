...
1. Create [CloudStorageAccount](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount) to interact with storage.
...
Developers create a [KeyVaultClient](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.keyvault.keyvaultclient)
and leverage that to get the SAS token for their storage. Afterwards, they
create [CloudStorageAccount](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.windowsazure.storage.cloudstorageaccount)
with that token.
