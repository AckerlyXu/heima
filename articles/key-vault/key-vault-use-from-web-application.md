<properties
    pageTitle="Use Azure Key Vault from a Web Application | Azure"
...
> [AZURE.NOTE]
> It is essential that you have completed the steps listed in [Get Started with Azure Key Vault](/documentation/articles/key-vault-get-started/) for this tutorial so that you have the URI to a secret and the Client ID and Client Secret for a web application.
> 
> 
...
This tutorial is designed for web developers that understand the basics of creating web applications on Azure. For more information about Azure Web Apps, see [Web Apps overview](/documentation/services/web-sites/).
