<properties
    pageTitle="Secure your key vault | Azure"
...
- [Manage Role-Based Access Control with Azure PowerShell](/documentation/articles/role-based-access-control-manage-access-powershell/)
...
- [Authorize access to web applications using OAuth 2.0 and Azure Active Directory](/documentation/articles/active-directory-protocols-oauth-code/)
