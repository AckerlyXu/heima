...
Azure App Service provides built-in authentication and authorization support, so you can sign in users and access data by writing minimal or no code in your web app, API, and mobile back end. This article describes how App Service helps simplify authentication and authorization for your app. 
...
In the [Azure portal](https://portal.azure.cn), you can configure App Service authorization with a number of behaviors.
