...
Create a [web app](../../app-service-web/app-service-web-overview.md) in the `myAppServicePlan` App Service plan with the [az webapp create](https://docs.microsoft.com/cli/azure/webapp#create) command. Don't forget to replace `<app name>` with a unique app name.

The runtime in the following command is set to `DOTNETCORE|1.1`. To see all supported runtimes, run [az webapp list-runtimes](https://docs.microsoft.com/cli/azure/webapp#list-runtimes).
...
To https://cephalin-dotnetcore.scm.chinacloudsites.cn/cephalin-dotnetcore.git
