...
In the Cloud Shell, create a Cosmos DB account with the [az cosmosdb create](https://docs.microsoft.com/cli/azure/cosmosdb#create) command.
...
To connect to the Cosmos DB database, you need the database key. In the Cloud Shell, use the [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#list-keys) command to retrieve the primary key.
...
To set app settings, use the [az webapp config appsettings update](https://docs.microsoft.com/cli/azure/webapp/config/appsettings#update) command in the Cloud Shell. 
