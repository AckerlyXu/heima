...
#### Restart the web app
Restarting is often the simplest way to recover from one-time issues. On the [Azure portal](https://portal.azure.cn/), on your web app¡¯s blade, you have the options to stop or restart your app.
