---
title: Bind an existing custom SSL certificate to Azure Web Apps
...
Open the [Azure portal](https://portal.azure.cn).
...
You can automate SSL bindings for your web app with scripts, using the [Azure CLI](https://docs.azure.cn/zh-cn/cli/install-azure-cli?view=azure-cli-lastest) or [Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/overview).
