...
If you do not have an existing web app, you can create one from the [Azure portal](https://portal.azure.cn). In the top left corner, click **Create a resource** > **Web + Mobile** > **Web app**.
