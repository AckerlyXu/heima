---
title: Deploy a Spring Boot Application to the Azure App Service | Azure
...
[Configure web apps in Azure App Service]: /app-service-web/web-sites-configure
[Deploy your app to Azure App Service using FTP/S]: /app-service-web/app-service-deploy-ftp
