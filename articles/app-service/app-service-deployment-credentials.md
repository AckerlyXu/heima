...
[Azure App Service](app-service-web-overview.md) supports two types of credentials for [local Git deployment](app-service-deploy-local-git.md) 
...
1. In the [Azure portal](https://portal.azure.cn), click App Service > **&lt;any_app>** > **Deployment credentials**.
    ...
    > [!NOTE]
    > In the portal, you must have at least one app before you can access the deployment credentials blade. However, with the [Azure CLI](https://docs.microsoft.com/cli/azure/webapp/deployment/user#set), 
