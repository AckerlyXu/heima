---
title: Customize authentication and authorization in Azure App Service
...
The portal configuration doesn't offer a turn-key way to present multiple sign-in options to your users. However, it isn't difficult to add the functionality to your web app. The steps are outlined as follows:
...
To extend the default expiration window, run the following command.
