...
## Overview
Azure provides built-in diagnostics to assist with debugging an [App Service web app](app-service-web-overview.md). In this article you'll learn how to enable diagnostic logging and add instrumentation to your application, as well as how to access the information logged by Azure.
...
>
> [!NOTE]
> Diagnostics can also be enabled from Azure PowerShell using the **Set-AzureWebsite** cmdlet. If you have not installed Azure PowerShell, or have not configured it to use your Azure Subscription, see [How to Use Azure PowerShell](/powershell-install-configure).
>
>
