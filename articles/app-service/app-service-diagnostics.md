---
title: Azure App Service diagnostics overview
...
To access App Service diagnostics, navigate to your App Service web app in the [Azure portal](https://portal.azure.cn). 
