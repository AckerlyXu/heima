...
To verify domain ownership, Add a TXT record. The TXT record maps from _awverify.&lt;subdomain>_ to _&lt;appname>.chinacloudsites.cn_. 
...
| - | - | - |
| @ (root) | _awverify_ | _&lt;appname>.chinacloudsites.cn_ |
| www (sub) | _awverify.www_ | _&lt;appname>.chinacloudsites.cn_ |
| \* (wildcard) | _awverify.\*_ | _&lt;appname>.chinacloudsites.cn_ |
...
In the [Azure portal](https://portal.azure.cn), in the left navigation of the app page, select **Custom domains**. 
...
| \*.contoso.com (wildcard) | CNAME | _\*_ | _&lt;appname>.chinacloudsites.cn_ |
