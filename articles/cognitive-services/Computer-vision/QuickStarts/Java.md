...
public class Main
{
    public static void main(String[] args)
    {
        ...
        try
        {
            URIBuilder builder = new URIBuilder("https://api.cognitive.azure.cn/vision/v1.0/analyze");
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            URIBuilder uriBuilder = new URIBuilder("https://api.cognitive.azure.cn/vision/v1.0/models/landmarks/analyze");
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        try
        {
            URIBuilder uriBuilder = new URIBuilder("https://api.cognitive.azure.cn/vision/v1.0/generateThumbnail");
...
Use the [Optical Character Recognition (OCR) method](https://dev.cognitive.azure.cn/docs/services/56f91f2d778daf23d8ec6739/operations/56f91f2e778daf14a499e1fc) to detect printed text in an image and extract recognized characters into a machine-usable character stream.
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        try
        {
            URIBuilder uriBuilder = new URIBuilder("https://api.cognitive.azure.cn/vision/v1.0/ocr");
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            URI uri = new URI("https://api.cognitive.azure.cn/vision/v1.0/recognizeText?handwriting=true");
