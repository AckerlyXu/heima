...
<script type="text/javascript">
    $(function() {
        ...
        $.ajax({
            url: "https://api.cognitive.azure.cn/vision/v1.0/analyze?" + $.param(params),
...
<script type="text/javascript">
    $(function() {
        ...
        $.ajax({
            ...
            url: "https://api.cognitive.azure.cn/vision/v1.0/models/landmarks/analyze?" + $.param(params),
...
<script type="text/javascript">
    $(function() {
        ...
        $.ajax({
            url: "https://api.cognitive.azure.cn/vision/v1.0/ocr?" + $.param(params),
            beforeSend: function(xhrObj){
                // Request headers
                xhrObj.setRequestHeader("Content-Type","application/json");
