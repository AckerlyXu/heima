...
1. Get API keys for the Vision APIs from [Azure portal](https://portal.azure.cn) if you create cognitive services with computer vision api. For video frame analysis, the applicable APIs are:
	- [Computer Vision API](/cognitive-services/computer-vision/home)
	- [Emotion API](/cognitive-services/emotion/home)
	- [Face API](/cognitive-services/face/overview)
