...
train a model using the [Recommendations UI](https://recommendations-portal.chinacloudsites.cn/).
...
1. If you have not done so already, you need to [sign-up](https://portal.azure.cn/#create/Microsoft.CognitiveServices/apitype/Recommendations/pricingtier/S1) for a 
   ...
   [http://portal.azure.cn/](https://portal.azure.cn/#create/Microsoft.CognitiveServices/apitype/Recommendations/pricingtier/S1) and sign in with your Azure account. Detailed instructions on the 
   sign up process are provided in *Task 1* of the [Getting Started Guide](cognitive-services-recommendations-quick-start.md) 
2. Once you have obtained a **Key** for your Recommendations API subscription, go to [Recommendations UI](https://recommendations-portal.chinacloudsites.cn/). 
...
Upon logging in to the [Recommendations UI](https://recommendations-portal.chinacloudsites.cn/), you see the Projects Page. 
