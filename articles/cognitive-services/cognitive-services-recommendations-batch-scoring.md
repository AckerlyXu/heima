...
The next step is to submit a new batch job. For more information, check the [API reference](https://dev.cognitive.azure.cn/docs/services/Recommendations.V4.0/).
...
You track the operation by using the Retrieve Operation Status API, just like you do for tracking the operation of a build operation.
