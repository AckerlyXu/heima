...
to the [Azure Cognitive Services Recommendations API](https://www.microsoft.com/cognitive-services/en-us/recommendations-api).
...
1. If you don’t already have an Azure subscription, [sign up](https://portal.azure.cn/#create/Microsoft.CognitiveServices/apitype/Recommendations/pricingtier/S1) for one. 
...
> and get the Account Key needed to use the new Recommendations UI.
