...
For more details about emotion detection, please refer to the API Reference: 
  - Basic: If a user has already called the Face API, they can submit the face rectangle as an input and use the basic tier. [API Reference](https://dev.cognitive.azure.cn/docs/services/5639d931ca73072154c1ce89/operations/56f23eb019845524ec61c4d7)
  - Standard: If a user does not submit a face rectangle, they should use standard mode.  [API Reference](https://dev.cognitive.azure.cn/docs/services/5639d931ca73072154c1ce89/operations/563b31ea778daf121cc3a5fa)
...
For more details about emotion detection in video, please refer to the [API Reference](https://dev.cognitive.azure.cn/docs/services/5639d931ca73072154c1ce89).
