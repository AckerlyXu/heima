---
title: Call REST endpoints with HTTP + Swagger connector for Azure Logic Apps
...
3. Upload the Swagger file to the blob. 
   ...
   You can perform this step from the [Azure portal](https://portal.azure.cn) or from a tool like [Azure Storage Explorer](http://storageexplorer.com/).

4. Reference an HTTPS link to the document in Azure Blob storage. 

   The link uses this format:

   `https://*storageAccountName*.blob.core.chinacloudapi.cn/*container*/*filename*`
