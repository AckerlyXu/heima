...
## Overview
In this tutorial, you add push notifications to the [Windows quick start](/documentation/articles/app-service-mobile-windows-store-dotnet-get-started) project so that a push notification is sent to the device every time a record is inserted.
