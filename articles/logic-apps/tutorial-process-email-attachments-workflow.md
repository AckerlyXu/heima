---
title: Build workflows to process emails and attachments - Azure Logic Apps
...
<a href="https://www.azure.cn/pricing/1rmb-trial" target="_blank">sign up for a free Azure account</a> 
before you begin. 
...
get your storage account's access key:
   ...
   You can also use [Azure PowerShell](https://docs.microsoft.com/powershell/module/azurerm.storage/get-azurermstorageaccountkey) or [Azure CLI](/cli/azure/storage/account/keys?view=azure-cli-latest.md#az_storage_account_keys_list). 
...
3. Create a storage container for your email attachments.
   ...
   or [Azure CLI](/cli/azure/storage/container?view=azure-cli-latest#az_storage_container_create). 
...
with these settings:
   ...
   | **Location** | China East | The same region that you previously used | 
   ...
   find your app in the <a href="https://portal.azure.cn" target="_blank">Azure portal</a>. On the main Azure menu, choose **App Services**, and select your function app.
