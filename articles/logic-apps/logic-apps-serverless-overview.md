---
title: Overview of Azure Serverless 
...
The core services in Azure around Serverless are [Azure Functions](/functions/) and [Azure Logic Apps](/logic-apps/).  Both of these solutions follow the principles above, and allow developers to build robust cloud applications with minimal code.
