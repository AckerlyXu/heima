---
title: Monitor and get insights about your logic app runs using OMS - Azure Logic Apps
...
1. In [Azure portal](https://portal.azure.cn), create a logic app. 
...
1. In the [Azure portal](https://portal.azure.cn), choose **More Services**. 
