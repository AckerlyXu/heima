---
title: Automate tasks and processes with Visual Studio and Azure Logic Apps
...
<a href="https://portal.azure.cn" target="_blank">Azure portal</a>, 
...
* Download and install these tools, if you don't have them already: 
  ...
  * <a href="/downloads/" target="_blank">Azure SDK (2.9.1 or later)</a> 
...
<a href="/connectors/" target="_blank">review the connectors list here</a>. 
...
which creates a new Azure resource group. 
   ...
   | **Resource Group** | MyLogicApp-RG <br> (China North) | The Azure resource group and location for storing and deploying resources for your logic app | 
   | **Location** | MyLogicApp-RG2 <br> (China East) | A different location if you don't want to use the resource group location |
   ||||
