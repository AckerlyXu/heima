---
title: Create workflows from templates - Azure Logic Apps
...
[sign up for an Azure account](https://www.azure.cn/pricing/1rmb-trial/) before you begin. For more information about building a logic app, see [Create a logic app](../logic-apps/quickstart-create-first-logic-app-workflow.md).

## Create logic apps from templates

1. If you haven't already, sign in to the 
[Azure portal](https://portal.azure.cn "Azure portal").
...
3. Create your logic app with the settings in the table under this image:
   ...
   | **Location** | *your-Azure-datacenter-region* | Select the datacenter region for deploying your logic app, for example, China East. | 
   |||| 
...
1. In the [Azure portal](https://portal.azure.cn "Azure portal"), 
