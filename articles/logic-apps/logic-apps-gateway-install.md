...
[work or school account](/active-directory/sign-up-organization) 
...
and the [Azure Service Bus](/service-bus-messaging/). 
...
The gateway creates an outbound connection to [Azure Service Bus](/service-bus-messaging/) 
