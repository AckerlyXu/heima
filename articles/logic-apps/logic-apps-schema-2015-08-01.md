---
title: Schema updates August-1-2015 preview - Azure Logic Apps
...
`GET https://management.azure.cn/subscriptions/{subid}/providers/Microsoft.Web/managedApis/?api-version=2015-08-01-preview`.
...
```
PUT https://management.azure.cn/subscriptions/{subid}/resourceGroups/{rgname}/providers/Microsoft.Web/connections/{name}?api-version=2015-08-01-preview
```
...
```
{
    "$schema": "https://schema.management.azure.cn/providers/Microsoft.Logic/schemas/2014-12-01-preview/workflowdefinition.json#",
    "contentVersion": "1.0.0.0",
    "parameters": {
