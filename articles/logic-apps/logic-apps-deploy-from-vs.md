---
title: Create, build, and deploy logic apps in Visual Studio - Azure Logic Apps
...
[Azure Resource Manager template functions](/azure-resource-manager/resource-group-template-functions) in your logic app deployment template. 
