<properties 
    pageTitle="Configure Active Geo-Replication for Azure SQL Database using PowerShell | Azure" 
...
To initiate failover using PowerShell, see [Initiate a planned or unplanned failover for Azure SQL Database with PowerShell](/documentation/articles/sql-database-geo-replication-failover-powershell/).
