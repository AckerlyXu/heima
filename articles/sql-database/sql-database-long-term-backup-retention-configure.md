---
title: 'Configure long-term backup retention - Azure SQL database | Azure' 
...
You can configure the Azure Recovery Services vault to store Azure SQL database backups and then recover a database using backups retained in the vault using the Azure portal preview or PowerShell.

## Azure portal preview

The following sections show you how to use the Azure portal preview to configure the Azure Recovery Services vault, view backups in the vault, and restore from the vault.
...
### View backups in long-term retention using Azure portal preview

View information about your database backups in [long-term backup retention](sql-database-long-term-retention.md). 

1. In the Azure portal preview, open your Azure Recovery Services vault for your database backups (go to **All resources** and select it from the list of resources for your subscription) to view the amount of storage used by your database backups in the vault.
...
### Restore a database from a backup in long-term backup retention using the Azure portal preview
