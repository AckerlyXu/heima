...
Restoring from long-term backup retention uses the [Restore-AzureRmSqlDatabase](https://docs.microsoft.com/powershell/module/azurerm.sql/restore-azurermsqldatabase) cmdlet.
