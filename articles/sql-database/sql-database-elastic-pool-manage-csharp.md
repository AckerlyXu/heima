---
title: 'C#: Create & manage an Azure SQL Database elastic pool | Azure'
...
This topic shows you how to create and manage scalable [elastic pools](sql-database-elastic-pool.md) with C#. You can also create and manage an Azure elastic pool with the [Azure portal](https://portal.azure.cn/), [PowerShell](sql-database-elastic-pool-manage-powershell.md), or the REST API. You can also create and move databases into and out of elastic pools using [Transact-SQL](sql-database-elastic-pool-manage-tsql.md).
...
2. Type `Install-Package Microsoft.Azure.Management.Sql -Pre` to install the [Azure SQL Management Library](https://www.nuget.org/packages/Microsoft.Azure.Management.Sql).
...
namespace SqlElasticPoolConsoleApp
{
    class Program
        ...
        // /resource-group-authenticate-service-principal/
