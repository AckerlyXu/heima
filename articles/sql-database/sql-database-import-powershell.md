<properties
    pageTitle="Import a BACPAC file to create an Azure SQL database by using PowerShell | Azure"
...
- A BACPAC file of the database you want to import. The BACPAC needs to be in an [Azure Storage account](/documentation/articles/storage-create-storage-account/) blob container.
...
## Next steps
* To learn to connect to and query an imported SQL Database, see [Connect to SQL Database with SQL Server Management Studio and perform a sample T-SQL query](/documentation/articles/sql-database-connect-query-ssms/).
