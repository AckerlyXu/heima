...
To work through the steps in this article, you'll need a SQL server in Azure with at least one database and an elastic pool. If you do not have an elastic pool, see [create a pool](/documentation/articles/sql-database-elastic-pool-create-portal/); if you don't have a database, see the [SQL database tutorial](/documentation/articles/sql-database-get-started/). 
...
Before you use jobs, install elastic jobs components and provide your credentials. For more information, see [Elastic database jobs overview](/documentation/articles/sql-database-elastic-jobs-overview/).
...
- [Create an elastic database pool with the portal](/documentation/articles/sql-database-elastic-pool-create-csharp/)
- [Create an elastic database pool with PowerShell](/documentation/articles/sql-database-elastic-pool-create-powershell/)
- [Create an elastic database pool with C#](/documentation/articles/sql-database-elastic-pool-create-csharp/)
- [Price and performance considerations for elastic database pools](/documentation/articles/sql-database-elastic-pool-guidance/)
