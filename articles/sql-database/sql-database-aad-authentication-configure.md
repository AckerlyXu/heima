<properties
    pageTitle="Configure Azure Active Directory authentication - SQL | Azure"
...
This article shows you how to create and populate Azure AD, and then use Azure AD with Azure SQL Database and SQL Data Warehouse. For an overview, see [Azure Active Directory Authentication](/documentation/articles/sql-database-aad-authentication/).
...
* .NET Framework 4.6 or later from [https://msdn.microsoft.com/library/5a4x27ek.aspx](https://msdn.microsoft.com/zh-cn/library/5a4x27ek.aspx).
