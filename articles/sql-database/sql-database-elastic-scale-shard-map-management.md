...
In this code, an application tries to open an existing **ShardMapManager** with the TryGetSqlShardMapManager (Java, [.NET](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmapmanagerfactory.trygetsqlshardmapmanager)) method.  If objects representing a Global **ShardMapManager** (GSM) do not yet exist inside the database, the client library creates them there using the CreateSqlShardMapManager (Java, [.NET](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmapmanagerfactory.createsqlshardmapmanager)) method.
...
* To add or remove shards: use **CreateShard** (Java, [.NET](https://msdn.microsoft.com/library/azure/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap.createshard.aspx)) and **DeleteShard** (Java, [.NET](https://msdn.microsoft.com/library/azure/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap.deleteshard.aspx)) of the Shardmap (Java, [.NET](https://msdn.microsoft.com/library/azure/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap.aspx)) class. 
...
* To create or remove points or ranges that are mapped to the shards: use **CreateRangeMapping** (Java, [.NET](https://msdn.microsoft.com/library/azure/dn841993.aspx)), **DeleteMapping** (Java, [.NET](https://msdn.microsoft.com/library/azure/dn824200.aspx)) of the RangeShardMapping (Java, [.NET](https://msdn.microsoft.com/library/azure/dn807318.aspx)) class, and **CreatePointMapping** (Java, [.NET](https://msdn.microsoft.com/library/azure/dn807218.aspx)) of the ListShardMap (Java, [.NET](https://msdn.microsoft.com/library/azure/dn842123.aspx)) class.
...
* To split existing ranges into two, or merge adjacent ranges into one: use **SplitMapping** (Java, [.NET](https://msdn.microsoft.com/library/azure/dn824205.aspx)) and **MergeMappings** (Java, [.NET](https://msdn.microsoft.com/library/azure/dn824201.aspx)).  
...
* To re-map (or move) individual points or ranges to different shards: use **UpdateMapping** (Java, [.NET](https://msdn.microsoft.com/library/azure/dn824207.aspx)).  
