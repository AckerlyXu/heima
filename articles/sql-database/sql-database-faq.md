...
We guarantee at least 99.99% of the time, you have connectivity between your Azure SQL Database and our Internet gateway, regardless of your service tier. For more information, see [SLA](https://www.azure.cn/support/legal/sla/).
...
[Managed Instance](sql-database-managed-instance.md) is available only with the vCore-based model. For more information, also see the [SQL Database pricing page](https://www.azure.cn/pricing/details/sql-database/managed/). 
...
For details, see [SQL Database pricing](https://www.azure.cn/pricing/details/sql-database/) and [Service tiers](sql-database-service-tiers.md).
