---
title: What is the Azure SQL Database service? | Azure
...
> [!NOTE]
> See [Azure Trust Center](https://www.trustcenter.cn/) for information about Azure's platform security.
>
...
You can configure SQL Database to store resource usage, workers and sessions, and connectivity into one of these Azure resources:
...
Azure's industry leading 99.99% availability service level agreement [(SLA)](https://www.azure.cn/support/legal/sla/), powered by a global network of Microsoft-managed datacenters, helps keep your app running 24/7. In addition, SQL Database provides built-in [business continuity and global scalability](sql-database-business-continuity.md) features, including:
...
SQL Database participates in regular audits and has been certified against several compliance standards. For more information, see the [Azure Trust Center](https://www.trustcenter.cn/).
...
- **[The Azure portal](https://portal.azure.cn/)**: A web-based application for managing all Azure services 
