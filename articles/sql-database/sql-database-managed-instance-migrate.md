...
However, there are some cases when you need to consider an alternative option, such as [SQL Server on Virtual Machines in Azure](https://www.azure.cn/home/features/virtual-machines/). Here are some examples:
...
RESTORE of native backups (.bak files) taken from SQL Server on-premises or [SQL Server on Virtual Machines](https://www.azure.cn/home/features/virtual-machines/), available on [Azure Storage](https://azure.microsoft.com/services/storage/), is one of key capabilities on SQL DB Managed Instance that enables quick and easy offline database migration. 
