...
* Now that you know about the SQL Database tiers, try them out with a [1rmb account](https://www.azure.cn/pricing/1rmb-trial/) and learn [how to create your first SQL database](sql-database-get-started-portal.md).
