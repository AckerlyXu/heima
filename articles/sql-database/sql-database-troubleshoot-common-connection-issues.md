...
##<a name="troubleshoot-the-persistent-errors"></a> Troubleshoot persistent errors
...
<!--Update_Description: remove "All topics for Azure SQL Database connection problems" section-->