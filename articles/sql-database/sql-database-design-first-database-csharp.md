...
Azure SQL Database is a relational database-as-a service (DBaaS) in the Azure. In this tutorial, you learn how to use the Azure portal and ADO.NET with Visual Studio to: 
