...
> [AZURE.SELECTOR]
- [Azure Key Vault](/documentation/articles/sql-database-always-encrypted-azure-key-vault/)
- [Windows certificate store](/documentation/articles/sql-database-always-encrypted/)
...
- [Azure PowerShell](/documentation/articles/powershell-install-configure/), minimum version of 1.0.
...
To quickly create an Azure Key Vault you can run the script below. For a detailed explanation of these cmdlets and more information about creating and configuring an Azure Key Vault, see [Get started with Azure Key Vault](/documentation/articles/key-vault-get-started/)
