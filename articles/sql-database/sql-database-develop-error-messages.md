<properties
	pageTitle="SQL error codes - database connection error | Azure"
...
- [Actions to fix connection errors and transient errors in SQL Database](/documentation/articles/sql-database-connectivity-issues/)
...
The following errors can be encountered while copying a database in Azure SQL Database. For more information, see [Copy an Azure SQL Database](/documentation/articles/sql-database-copy/).
...
* More detailed information is available here: [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits/)

|Error code|Severity|Description|
|---:|---:|:---|
|10928|20|Resource ID: %d. The %s limit for the database is %d and has been reached. For more information, see [http://go.microsoft.com/fwlink/?LinkId=267637](http://go.microsoft.com/fwlink/?LinkId=267637).<br/><br/>The Resource ID indicates the resource that has reached the limit. For worker threads, the Resource ID = 1. For sessions, the Resource ID = 2.<br/><br/>*Note:* For more information about this error and how to resolve it, see:<br/>• [Azure SQL Database resource limits](/documentation/articles/sql-database-resource-limits/). |
...
* [Create an elastic database pool (C#)](/documentation/articles/sql-database-elastic-pool-create-csharp/) 
* [Manage an elastic database pool (C#)](/documentation/articles/sql-database-elastic-pool-manage-csharp/). 
* [Create an elastic database pool (PowerShell)](/documentation/articles/sql-database-elastic-pool-create-powershell/) 
* [Monitor and manage an elastic database pool (PowerShell)](/documentation/articles/sql-database-elastic-pool-manage-powershell/).
