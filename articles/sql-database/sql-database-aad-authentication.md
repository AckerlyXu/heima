...
3. Create an Azure Active Directory administrator for the Azure SQL Database server, the Managed Instance, or the [Azure SQL Data Warehouse](https://www.azure.cn/home/features/sql-data-warehouse/).
