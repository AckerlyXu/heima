<properties
	pageTitle="Try SQL Database: Use C# to create a SQL database | Azure"
...
Learn how to use C# to create an Azure SQL database with the [Azure SQL Management Library for .NET](https://www.nuget.org/packages/Microsoft.Azure.Management.Sql). This article describes how to create a single database with SQL and C#. To create elastic database pools, see [Create an Elastic database pool](/documentation/articles/sql-database-elastic-pool-create-csharp/).

The Azure SQL Database Management Library for .NET provides an [Azure Resource Manager](/documentation/articles/resource-group-overview/)-based API that wraps the [Resource Manager-based SQL Database REST API](https://msdn.microsoft.com/zh-cn/library/azure/mt163571.aspx).
