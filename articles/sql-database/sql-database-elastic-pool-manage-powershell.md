<properties 
    pageTitle="Manage an elastic database pool (PowerShell) | Azure" 
...
Manage an [elastic database pool](/documentation/articles/sql-database-elastic-pool/) using PowerShell cmdlets. 
...
Values for pools can be found in [eDTU and storage limits](/documentation/articles/sql-database-elastic-pool/#eDTU-and-storage-limits-for-elastic-pools-and-elastic-databases). 

## Prerequisites

* Azure PowerShell 1.0 or higher. For detailed information, see [How to install and configure Azure PowerShell](/documentation/articles/powershell-install-configure/).
* Elastic database pools are only available with SQL Database V12 servers. If you have a SQL Database V11 server, [use PowerShell to upgrade to V12 and create a pool](/documentation/articles/sql-database-upgrade-server-portal/) in one step.
...
When performance suffers, you can change the settings of the pool to accommodate growth. Use the [Set-AzureRmSqlElasticPool](https://msdn.microsoft.com/zh-cn/library/azure/mt603511.aspx) cmdlet. Set the -Dtu parameter to the eDTUs per pool. See [eDTU and storage limits](/documentation/articles/sql-database-elastic-pool/#eDTU-and-storage-limits-for-elastic-pools-and-elastic-databases) for possible values.  
