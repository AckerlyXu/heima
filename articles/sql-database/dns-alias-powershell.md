...
- Example server string: `any-unique-alias-name.database.chinacloudapi.cn`.
...
- An Azure subscription and account. For a trial, click [https://www.azure.cn/pricing/1rmb-trial/][https://www.azure.cn/pricing/1rmb-trial/].
