<properties
    pageTitle="Query across cloud databases with different schema | Azure"
...
To query horizontally partitioned databases (also known as sharded databases), see [Queries across sharded cloud databases (horizontally partitioned)](/documentation/articles/sql-database-elastic-query-horizontal-partitioning/).
