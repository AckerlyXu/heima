<properties
	pageTitle="Upgrade to Azure SQL Database V12 using PowerShell | Azure"
...
After upgrading to V12, [service tier recommendations](/documentation/articles/sql-database-service-tier-advisor/) and [elastic pool recommendations](/documentation/articles/sql-database-elastic-pool-create-portal/) will not immediately be available until the service has time to evaluate your workloads on the new server. V11 server recommendation history does not apply to V12 servers so it is not retained.  

## Prepare to upgrade

- **Upgrade all Web and Business databases**: Use the portal, or use [PowerShell to upgrade databases and server](/documentation/articles/sql-database-upgrade-server-powershell/).
...
To upgrade a server to V12 with PowerShell, you need to have the latest Azure PowerShell installed and running. For detailed information, see [How to install and configure Azure PowerShell](/documentation/articles/powershell-install-configure/).
...
For more information, see [Create an elastic database pool](/documentation/articles/sql-database-elastic-pool-create-portal/) and [Azure SQL Database pricing tier recommendations](/documentation/articles/sql-database-service-tier-advisor/).
...
In addition to monitoring individual databases you can monitor elastic database pools [using the portal](/documentation/articles/sql-database-elastic-pool-manage-portal/) or with [PowerShell](/documentation/articles/sql-database-elastic-pool-manage-powershell/)
...
- [Create an elastic database pool](/documentation/articles/sql-database-elastic-pool-create-portal/) and add some or all of the databases into the pool.
