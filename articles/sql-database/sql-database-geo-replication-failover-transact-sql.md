<properties
    pageTitle="Initiate a planned or unplanned failover for Azure SQL Database with Transact-SQL | Azure"
...
This article shows you how to initiate failover to a secondary SQL Database using Transact-SQL. To configure geo-replication, see [Configure geo-replication for Azure SQL Database](/documentation/articles/sql-database-geo-replication-transact-sql/).
...
- To learn recovering after a disaster using Active Geo-Replication, including pre and post recovery steps and performing a disaster recovery drill, see [Disaster Recovery](/documentation/articles/sql-database-disaster-recovery/)
