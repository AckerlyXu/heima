<properties
    pageTitle="Auditing, TDS redirection, and IP endpoints for Azure SQL Database | Azure"
...
[SQL Database Table Auditing](/documentation/articles/sql-database-auditing-get-started/) works automatically with SQL clients that support TDS redirection. Note that redirection does not apply when using the Blob Auditing method.
