...
If your application’s downtime can result in business liability you should be using failover groups. It will enable the application to quickly restore availability in a different region in case of an outage. Learn how to [configure failover groups](sql-database-geo-replication-portal.md).
