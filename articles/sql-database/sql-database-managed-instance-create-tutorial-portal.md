...
> [!IMPORTANT]
> Do not continue until your Managed Instance is successfully provisioned. After it is provisioned, retrieve the host name for your instance in the **Managed instance** field on the **Overview** tab for your Managed Instance. The name is similar to this: **drfadfadsfd.tr23.chinanorth1-a.worker.database.chinacloudapi.cn**.
