...
For **SQL Database** Basic, Standard, and Premium service tiers Azure provides an availability SLA of 99.99%. For the latest information, see [Service Level Agreement](https://www.azure.cn/support/sla/sql-data/). For the latest information on SQL Database service tiers and the supported business continuity plans, see [Service Tiers](sql-database-service-tiers.md).
