<properties
    pageTitle="Fix a SQL connection error, transient error | Azure"
...
[SQL error codes for SQL Database client applications](/documentation/articles/sql-database-develop-error-messages/).
...
- For troubleshooting other common Azure SQL Database connection issues, visit [Troubleshoot connection issues to Azure SQL Database](/documentation/articles/sql-database-troubleshoot-common-connection-issues/).
