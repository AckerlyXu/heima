<properties
   pageTitle="Azure SQL Database Web and Business Edition sunset FAQ | Azure"
...
- [Upgrade to SQL Database V12 using the Azure portal](/documentation/articles/sql-database-upgrade-server-portal/)
...
Use the pricing tier recommendations described above, or for detailed information to assist you in selecting an appropriate new service tier, see [Upgrade to Azure SQL Database V12](/documentation/articles/sql-database-upgrade-server-portal/).
...
For detailed information about the new service tiers and performance model, see [Service tiers](/documentation/articles/sql-database-service-tiers/). For detailed pricing information for the new service tiers, see [SQL Database pricing](/pricing/details/sql-database/).
...
[Web and Business Pricing](/pricing/details/sql-database//web-business)

[Service tiers](/documentation/articles/sql-database-service-tiers/)

[Upgrade to Azure SQL Database V12](/documentation/articles/sql-database-upgrade-server-portal/)
