<properties
    pageTitle="Service quotas and limits for Azure Batch | Azure"
...
## Related topics
- [Create an Azure Batch account using the Azure portal](/documentation/articles/batch-account-create-portal/)
