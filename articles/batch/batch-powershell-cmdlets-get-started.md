<properties
    pageTitle="Get started with PowerShell for Azure Batch | Azure"
...
- For more information about applications and application packages in Batch, see [Application deployment with Azure Batch application packages](/documentation/articles/batch-application-packages/).
