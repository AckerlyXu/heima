...
Type the cloud administrator user name in UPN format serviceadmin@contoso.partner.onmschina.cn (AAD). When prompted, type the password to the cloud administrator account.
...
## Next steps
 ...
 - To learn more about troubleshooting, see [Azure Stack troubleshooting](azure-stack-troubleshooting.md)
