...
Azure Stack Storage is the set of storage cloud services in Azure Stack. Azure Stack Storage provides blob, table, queue, and account management functionality with Azure-consistent semantics.
