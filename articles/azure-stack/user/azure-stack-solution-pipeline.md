...
- [Introduction to Azure](/fundamentals-introduction-to-azure)
...
### Azure
 ...
 - Create a Web App and configure it for [FTP publishing](../../app-service/app-service-deploy-ftp.md).  Make note of the new Web App URL, as it is used later.
