---
title: Azure Stack Development Kit release notes | Microsoft Docs
...
- Creation of items directly on SQL and MySQL hosting servers that are not performed by the resource provider is not supported and may result in a mismatched state.
	...
	> [!NOTE]
	> See the individual [SQL](/azure-stack/azure-stack-sql-resource-provider-deploy) and [MySQL](/azure-stack/azure-stack-mysql-resource-provider-deploy) setup articles for version compatibility guidance.
