...
> [!IMPORTANT]
> Do not attempt to create virtual machines during the 1712 update installation process. See [manage updates in Azure Stack overview](/azure-stack/azure-stack-updates#plan-for-updates) for more details.

### Prerequisites

You must first install the Azure Stack [1711 Update](/azure-stack/azure-stack-update-1711) before applying this update.
