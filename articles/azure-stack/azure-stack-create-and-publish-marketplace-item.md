...
4. To make sure that the resource can be deployed successfully, test the template with the Azure Stack APIs.
...
| Description |X |[HTML](https://auxdocs.chinacloudsites.cn/en-us/documentation/articles/gallery-metadata#html-sanitization) |500 to 5,000 characters | |
