...
|Marketplace syndication - The ability to select and add Gallery packages directly from the Azure Marketplace|Unavailable - This feature requires connectivity to Azure and an Azure Active Directory account.|
