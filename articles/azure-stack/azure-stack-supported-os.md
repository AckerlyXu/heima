...
***Note 1:***  *To deploy Windows 10 client operating systems on Azure Stack, you must have Windows per User Licensing or purchase through a Qualified Multitenant Hoster (QMTH).*


## Linux

Linux distributions listed here include the necessary Azure Linux Agent (WALA).
