...
For more information about creating an SPN, see [Create service principal for AD FS](/azure-stack/azure-stack-create-service-principals#create-service-principal-for-ad-fs).
