...
Install and configured PowerShell for Azure Stack and the Azure Stack tools. See [Get up and running with PowerShell in Azure Stack](/azure-stack/azure-stack-powershell-configure-quickstart).
