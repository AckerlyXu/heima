...
description: View the Azure Stack Development Kit architecture.
...
| **AzS-DC01** | Active Directory, DNS, and DHCP services for Azure Stack.|
...
| **AzS-XRP01** | Infrastructure management controller for Azure Stack, including the Compute, Network, and Storage resource providers.|
