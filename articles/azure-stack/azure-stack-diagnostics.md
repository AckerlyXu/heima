...
To learn more about the ERCS_AzureStackLogs.ps1 PowerShell script, you can view the script’s [readme file](https://github.com/Azure/AzureStack-Tools/blob/master/Support/ERCS_Logs/ReadMe.md) located in the Azure Stack tools GitHub repository. 
...
## Next steps
[Azure Stack troubleshooting](azure-stack-troubleshooting.md)
