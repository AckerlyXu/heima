...
- [Web Apps](/app-service-web/app-service-web-overview) for hosting websites and web applications.
- [API Apps](/app-service-api/app-service-api-apps-why-best-platform) for hosting RESTful APIs.
