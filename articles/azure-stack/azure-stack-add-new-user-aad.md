...
description: After deploying Azure Stack Development Kit, you’ll need to create at least one tenant user account so you can explore the tenant portal.
...
1. Log in to [Azure](https://portal.azure.cn).
2. In Azure left navigation bar, click **Active Directory**.
...
15. Log in to Azure with the new account. Change the password when prompted.
