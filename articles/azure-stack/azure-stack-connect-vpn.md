...
- A valid Azure subscription.  If you don’t have an Azure subscription, you can create a [Azure account here](https://www.azure.cn/pricing/1rmb-trial/?b=17.06).
...
First you create the network resources for Azure. The following instructions show how to create the resources by using the [Azure portal](http://portal.azure.cn/).

### Create the virtual network and VM subnet

1. Sign in to the [Azure portal](http://portal.azure.cn/) using your Azure account.
...
7. Select the **Location** of your VNet.  If you're using the example values, select **China North** or use another location if you prefer.
