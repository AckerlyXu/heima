...
- A hosting plan (App Service plan)
- A function app 
...
The definition of the hosting plan varies, depending on whether you use a App Service plan. See [Deploy a function app on the App Service plan](#app-service-plan).
