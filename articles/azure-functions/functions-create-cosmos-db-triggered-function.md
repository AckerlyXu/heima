...
6. When creating a new Cosmos DB account, use the **New account** settings as specified in the table.
    ...
    | **Location**  | ChinaNorth | Select a location near to either your function app or to other apps that use the stored documents.  |
...
1. Open a second instance of the [Azure portal](https://portal.azure.cn) in a new tab in the browser. 
