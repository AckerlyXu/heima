...
- **Query string**: The provider passes the key name in the `clientid` query string parameter, such as `https://<yourapp>.chinacloudsites.cn/api/<funcname>?clientid=<keyname>`.
