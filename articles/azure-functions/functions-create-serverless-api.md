...
You can learn more about customizing HTTP functions in [Azure Functions HTTP and webhook bindings](/azure-functions/functions-bindings-http-webhook#customizing-the-http-endpoint).
...
- Azure Functions 
- API apps in [Azure App Service](/app-service/app-service-web-overview)
...
Select `proxies.json` in the left navigation. This is the file which stores the configuration for all of your proxies. If you use one of the [Functions deployment methods](/azure-functions/functions-continuous-deployment), this is the file you will maintain in source control. To learn more about this file, see [Proxies advanced configuration](/azure-functions/functions-proxies#advanced-configuration).
...
- [Azure Functions HTTP and webhook bindings](/azure-functions/functions-bindings-http-webhook)
- [Working with Azure Functions Proxies]
- [Documenting an Azure Functions API (preview)](/azure-functions/functions-api-definition-getting-started)


[Create your first function]: /azure-functions/functions-create-first-azure-function
[Working with Azure Functions Proxies]: /azure-functions/functions-proxies
