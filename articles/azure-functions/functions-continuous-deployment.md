...
1. In your function app in the [Azure portal](https://portal.azure.cn), click **Platform features** and **Deployment options**. 
...
1. In your function app in the [Azure portal](https://portal.azure.cn), click **Platform features** and **Deployment credentials**.
...
1. In your function app in the [Azure portal](https://portal.azure.cn), click **Platform features** and **Properties**, then copy the values for **FTP/Deployment User**, **FTP Host Name**, and **FTPS Host Name**.  
