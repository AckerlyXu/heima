...
- An active Azure subscription. If you don't have an Azure subscription, [Trials account](https://www.azure.cn/pricing/1rmb-trial/?WT.mc_id=A261C142F) are available.
...
- [Using the Azure CLI](https://docs.microsoft.com/cli/azure/functionapp/config/appsettings#az_functionapp_config_appsettings_set). 
