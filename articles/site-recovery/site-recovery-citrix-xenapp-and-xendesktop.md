---
title: Replicate a multi-tier Citrix XenDesktop and XenApp deployment using Azure Site Recovery | Azure
...
3. For VMware virtual machines: Select source as VMware process server, target as Azure,
and deployment model as Resource Manager and click on Select items.
4. For Hyper-V virtual machines:
Select source as VMM server, target as Azure, and deployment model as Resource Manager and
