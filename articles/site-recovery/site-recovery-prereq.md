...
**Requirement** | **Details**
--- | ---
**Azure account** | A [Azure account](https://www.azure.cn/). You can start with a [trial](https://www.azure.cn/pricing/1rmb-trial/).
...
**Network mapping** | If you replicate Hyper-V VMs in VMM clouds, you must set up network mapping. This ensures that Azure VMs connect to appropriate networks when they're created after failover.
