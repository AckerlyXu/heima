---
title: How does Azure virtual machine replication between Azure regions work in Azure Site Recovery?  | Azure
...
The following diagram provides a high-level view of an Azure VM environment in a specific region (in this example, the China East location). In an Azure VM environment:
