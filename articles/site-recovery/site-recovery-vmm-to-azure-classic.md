...
2. In the dropdown list, select **Between an on-premises VMM site and Azure**.
...
1. In **Quick Start** > **Prepare VMM servers**, click **Download Azure Site Recovery Provider for installation on VMM servers** to obtain the latest version of the Provider installation file.
