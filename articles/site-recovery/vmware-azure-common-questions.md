---
title: 'Common questions - VMware to Azure replication with Azure Site Recovery | Azure'
...
This article provides answers to common questions we see when replicating on-premises VMware VMs to Azure. If you have questions after reading this article, post them on the [Azure Recovery Services Forum](https://social.msdn.microsoft.com/Forums/en-US/home?forum=hypervrecovmgr).
...
Yes, both encryption-in-transit and [encryption in Azure](/storage/storage-service-encryption) are supported.
...
[Failover](site-recovery-failover.md) isn't automatic. You initiate failovers with single click in the portal, or you can use [ PowerShell](https://docs.microsoft.com/powershell/module/azurerm.siterecovery) to trigger a failover.
