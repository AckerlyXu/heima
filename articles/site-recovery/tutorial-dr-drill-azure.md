---
title: Run a disaster recovery drill for on-premises machines to Azure with Azure Site Recovery | Azure
...
<!-- Update_Description: new articles on site recovery tutorial dr drill azure -->