...
### Azure prerequisites
* You'll need a [Azure](https://www.azure.cn/) account. If you don't have one, start with a [trial account](https://www.azure.cn/pricing/1rmb-trial). In addition, you can read about the [Azure Site Recovery Manager pricing](https://www.azure.cn/pricing/details/site-recovery/).
...
* [How to configure and monitor virtual networks in Azure](/virtual-network/)
