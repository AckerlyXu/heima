---
title: Replicate and fail over VMware VMs to Azure using PowerShell in Azure Site Recovery | Azure
...
Log in to your Azure subscription using the Login-AzureRmAccount -EnvironmentName AzureChinaCloud cmdlet
