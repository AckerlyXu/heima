---
title: Set up a replication policy for Hyper-V VM (with VMM) replication to Azure with Azure Site Recovery | Azure
...
<!--Update_Description: new articles on site recovery replication from vmm to azure-->