<properties
    pageTitle="Fail back VMware VMs from Azure in the classic legacy portal | Azure"
...
This article describes how to fail back VMware virtual machines and Windows/Linux physical servers from Azure to your on-premises site after you've replicated from your on-premises site to Azure using [Azure Site Recovery?](/documentation/articles/site-recovery-overview/).
...
- [Read about](/documentation/articles/site-recovery-vmware-to-azure-classic/) replicating VMware virtual machines and physical servers to Azure using the enhanced deployment.
