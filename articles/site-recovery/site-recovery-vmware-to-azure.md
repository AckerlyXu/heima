...
--- | ---
**Azure** | Learn about [Azure requirements](./site-recovery-prereq.md)
...
2. Set up an [Azure storage account](../storage/common/storage-create-storage-account.md#create-a-storage-account) for replicated data.
