 ...
 * The name of the image is *Azure Site Recovery Process Server V2*. Select **Classic** as the deployment model.
...
<!--Update_Description: new articles on failback frm azure to vmware in site recovery -->
