<properties
    pageTitle="Set up the source environment (VMware to Azure) | Azure"
...
2. A dedicated account in your VMware vCenter that can be used for [automatic discovery](/documentation/articles/site-recovery-vmware-to-azure/#vmware-account-permissions)
...
[AZURE.INCLUDE [site-recovery-add-vcenter-account](../../includes/site-recovery-add-vcenter-account.md)]
