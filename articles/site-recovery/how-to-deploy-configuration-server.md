---
title: Deploy the configuration server for VMware disaster recovery with Azure Site Recovery | Azure
...
<!--The parent file of includes file of site-recovery-configuration-and-scaleout-process-server-requirements.md-->
<!--ms.date:03/05/2018-->
<!-- Update_Description: new articles on how to deploy the configuration server in site recovery -->
<!--ms.date: 03/05/2018-->