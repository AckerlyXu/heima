---
title: Plan networking for Hyper-V replication to a secondary VMM site with Azure Site Recovery | Azure
...
<!--Update_Description: new articles on site recovery network from vmm to vmm-->