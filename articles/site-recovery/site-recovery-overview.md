---
title: What is Azure Site Recovery? | Azure
...
- **Backup service**: In addition, the [Azure Backup](/backup/) service keeps your data safe and recoverable by backing it up to Azure.
