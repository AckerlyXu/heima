---
title: Plan networking for Hyper-V (withSystem Center VMM) to Azure replication with Azure Site Recovery | Azure
...
1. If you don't have one, prepare a [VMM logical network](/system-center/vmm/network-logical) that's associated with the cloud in which the Hyper-V hosts are located.
2. If you don't have one, created a [VM network](/system-center/vmm/network-virtual) linked to the logical network you prepared above.
...
<!--Update_Description: new articles on site recovery network from vmm to azure-->