...
On the configuration/process server, go to the file PushinstallService located at <Azure Site Recovery Install Location>\home\svsystems\pushinstallsvc\ to understand the source of the problem. Use the following troubleshooting steps to resolve the problem.</br>
...
<!--Update_Description: new articles on vmware to azure error code -->