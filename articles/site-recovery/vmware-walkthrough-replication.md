---
title: Set up a replication policy for VMware VM replication to Azure with Azure Site Recovery | Azure
...
<!--Update_Description: new articles on site recovery replication from vmware to azure-->