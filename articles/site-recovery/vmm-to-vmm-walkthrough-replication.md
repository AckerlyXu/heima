---
title: Set up a replication policy for Hyper-V replication to a secondary site with Azure Site Recovery | Azure
...
<!--Update_Description: new articles on site recovery replication from vmm to vmm-->