<properties
    pageTitle="Replicate Hyper-V VMs in VMM to a secondary site (Azure classic) | Azure"
...
--- | ---
**Azure**| You need a [Azure](https://azure.cn/) account. You can start with a [trial](/pricing/1rmb-trial/). [Learn more](/pricing/details/site-recovery/) about Site Recovery pricing.
