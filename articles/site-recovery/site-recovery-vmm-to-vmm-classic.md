...
| --- | --- |
| **Azure** |You need a [Azure](https://www.azure.cn/) account. You can start with a [trial](https://www.azure.cn/pricing/1rmb-trial/). [Learn more](https://www.azure.cn/pricing/details/site-recovery/) about Site Recovery pricing. |
...
1. Sign in to the [Management Portal](https://portal.azure.cn) from the VMM server you want to register.
...
This section provides additional privacy information for the Azure Site Recovery service. 
