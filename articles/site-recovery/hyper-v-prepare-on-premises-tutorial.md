---
title: Prepare on-premises Hyper-V server for disaster recovery of Hyper-V VMs to Azure| Azure
...
1. Make sure you have a [VMM logical network](https://docs.microsoft.com/zh-cn/system-center/vmm/network-logical) that's associated with the cloud in which the Hyper-V hosts are located.
2. Ensure you have a [VM network](https://docs.microsoft.com/zh-cn/system-center/vmm/network-virtual) linked to the logical network.
