<properties
    pageTitle="Replicate Hyper-V VMs in VMM to a secondary site with PowerShell (Azure Resource Manager) | Azure"
...
> [AZURE.SELECTOR]
- [Azure Management Portal](/documentation/articles/site-recovery-vmm-to-vmm/)
...
> [AZURE.NOTE] Azure has two different [deployment models](/documentation/articles/resource-manager-deployment-model/) for creating and working with resources: Azure Resource Manager and classic. Azure also has two portals – the Azure classic portal that supports the classic deployment model, and the Azure portal with support for both deployment models. This article covers the Resource Manager deployment model.
