---
title: Set up disaster recovery for Azure VMs after migration to Azure with Azure Site Recovery | Azure
...
- You need to manually uninstall the Mobility service from the Azure VM, using one of the following methods. Restart the VM before you configure replication.
    - For Windows, in the Control Panel > **Add/Remove Programs**, uninstall **Azure Site Recovery Mobility Service/Master Target server**. At an elevated command prompt, run:
        ```
