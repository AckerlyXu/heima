---
title: Prerequisites for VMware to Azure replication using Azure Site Recovery | Azure
...
<!--Update_Description: new articles on site recovery prerequisites from vmware to azure-->