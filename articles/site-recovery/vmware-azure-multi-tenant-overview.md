---
title: Overview of multi-tenant support for VMware VM replication to Azure (CSP) using Azure Site Recovery | Azure
...
<!-- Update_Description: new articles on vmware azure multi tenant overview -->
<!--ms.date: 04/02/2018-->