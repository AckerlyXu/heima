...
| **Azure resources** |Make sure you have enough Azure resources to deploy all components.  | |
...
<!--Update_Description: new articles on site recovery from vmware to azure legant -->