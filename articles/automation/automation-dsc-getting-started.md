...
---
title: Getting started with Azure Automation DSC | Azure
...
* An Azure Resource Manager VM (not Classic) running Windows Server 2008 R2 or later. For instructions on creating a VM, see 
  [Create your first Windows virtual machine in the Azure portal preview](/documentation/articles/virtual-machines-windows-hero-tutorial/)
...
After you have imported a configuration, you can view it in the Azure portal preview.
