...
2. A Log Analytics workspace. For more information, see [Get started with Log Analytics](/documentation/articles/log-analytics-get-started/). 
...
If you need to find the *Name* of your Automation account, in the Azure portal preview select your Automation account from the **Automation account** blade and select **All settings**.  From the **All settings** blade, under **Account Settings** select **Properties**.  In the **Properties** blade, you can note these values.<br> ![Automation Account properties](./media/automation-manage-send-joblogs-log-analytics/automation-account-properties.png).
...
3. To open the **Add Alert Rule** screen, click **Alert** at the top of the page. For further details on the options to configure the alert, see [Alerts in Log Analytics](/documentation/articles/log-analytics-alerts/#creating-alert-rules).
