...
- This solution only deploys to the following Azure regions - Australia Southeast, China East, China North, and China North.  The runbooks that manage the VM schedule can target VMs in any region.  
...
1. From the home-screen in the Azure portal preview, select the **Marketplace** tile.  If the tile is no longer pinned to your home-screen, from the left navigation pane, select **New**.  
