...
1. Click **ENVIRONMENTNAME**,select **PowerShell expression** for the **Data source** and type AzureChinaCloud surrounded with double quotes that you start with this runbook , and then click **OK**.
