...
* Azure PowerShell 1.0 and later. For information about the PowerShell 1.0 release, see [How to install and configure Azure PowerShell](https://docs.microsoft.com/powershell/azureps-cmdlets-docs).
...
1. Save the following script on your computer. In this example, save it with the filename *New-RunAsAccount.ps1*.
		 ...
		 if ($CreateClassicRunAsAccount) {
			  ...
			  $UploadMessage = "Please upload the .cer format of #CERT# to the Management store by following the steps below." + [Environment]::NewLine +
					  "Log in to the Microsoft Azure portal (https://portal.azure.cn) and select Subscriptions -> Management Certificates." + [Environment]::NewLine +
...
4. Execute the script by using the parameter values for the configuration you require.
    ...
    **Create a Run As account and a Classic Run As account by using a self-signed certificate in the Azure China cloud**  
