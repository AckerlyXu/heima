...
You can compile Desired State Configuration (DSC) configurations in two ways with Azure Automation: in the Azure portal preview, and with Windows PowerShell. The following table will help you determine when to use which method based on the characteristics of each:
...
## Compiling a DSC Configuration with the Azure portal preview
...
### Importing a node configuration in the Azure portal preview
