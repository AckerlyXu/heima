<properties
    pageTitle="PHP web and worker roles | Azure"
...
For more information about these options, see [Compute hosting options provided by Azure](/documentation/articles/cloud-services-choose-me/).
