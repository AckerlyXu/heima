<properties
    pageTitle="Managing roles in Azure Cloud Service projects with Visual Studio | Azure"
...
## Next steps
- [Configure the Roles for an Azure Cloud Service with Visual Studio](/documentation/articles/vs-azure-tools-configure-roles-for-cloud-service/)
