<properties
	pageTitle="Azure Cloud Services roles FAQ | Azure"
...
# Cloud Services FAQ
This article answers some frequently asked questions about Microsoft Azure Cloud Services. You can also visit the [Azure Support FAQ](http://go.microsoft.com/fwlink/?LinkID=185083) for general Azure pricing and support information. You can also consult the [Cloud Services VM Size page](/documentation/articles/cloud-services-sizes-specs/) for size information.
...
When the virtual machine instance recycles, all local changes are lost. Use a [startup task](/documentation/articles/cloud-services-startup-tasks/) to install certificates to the virtual machine each time the role starts.

### I cannot find my management certificates in the portal

[Management certificates](/documentation/articles/azure-api-management-certs/) are only available in the Azure Classic Portal. The current Azure portal does not use management certificates. 

### How can I disable a management certificate?

[Management certificates](/documentation/articles/azure-api-management-certs/) cannot be disabled. You delete them through the Azure Classic Portal when you do not want them to be used anymore.

### How do I create an SSL certificate for a specific IP address?
Follow the directions in the [create a certificate tutorial](/documentation/articles/cloud-services-certs-create/). Use the IP address as the DNS Name.
