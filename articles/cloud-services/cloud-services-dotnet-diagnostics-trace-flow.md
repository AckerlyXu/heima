<properties
	pageTitle="Trace the flow in a Cloud Services Application with Azure Diagnostics | Azure"
...
Before you complete the following procedure, you must initialize the Azure diagnostic monitor. To do this, see [Enabling Diagnostics in Azure](/documentation/articles/cloud-services-dotnet-diagnostics/).
