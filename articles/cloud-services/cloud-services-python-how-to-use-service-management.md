...
To use the Service Management API, you need to [create an Azure account](/pricing/1rmb-trial/). 
...
All the features described in this article are available in the `azure-servicemanagement-legacy` package, which you can install using pip. For more details about installation (for example, if you are new to Python), consult this article: [Installing Python and the Azure SDK](/documentation/articles/python-how-to-install/)
...
The command creates the `.cer` file, and installs it in the **Personal** certificate store. For more details, see [Certificates Overview for Azure Cloud Services](/documentation/articles/cloud-services-certs-create/).
...
To learn more about how to capture a Linux Virtual Machine, see [How to Capture a Linux Virtual Machine.](/documentation/articles/virtual-machines-linux-classic-capture-image/)

To learn more about how to capture a Windows Virtual Machine, see [How to Capture a Windows Virtual Machine.](/documentation/articles/virtual-machines-windows-classic-capture-image/)
