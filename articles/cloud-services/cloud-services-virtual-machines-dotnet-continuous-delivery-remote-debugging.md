<properties
	pageTitle="Enable remote debugging with continuous delivery | Azure"
...
1. Create an Azure virtual machine. See [Create a Virtual Machine Running Windows Server](/documentation/articles/virtual-machines/virtual-machines-windows-hero-tutorial/) or [Create and Manage Azure Virtual Machines in Visual Studio](/documentation/articles/virtual-machines/virtual-machines-windows-classic-manage-visual-studio/).
...
3. Create a client certificate as outlined in [Certificates Overview for Azure Cloud Services](/documentation/articles//cloud-services/cloud-services-certs-create/) (keep the .pfx and RDP certificate thumbprint).
