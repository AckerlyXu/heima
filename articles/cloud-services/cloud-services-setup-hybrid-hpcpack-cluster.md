...
Perform the following steps in the [Azure portal](https://portal.azure.cn) with your Azure subscription. After completing these steps, you can deploy Azure nodes from the on-premises head node. 
...
1. From the head node computer, sign in to the [Azure portal](https://portal.azure.cn).
