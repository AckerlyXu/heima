<properties
	pageTitle="Configure a custom domain name in Cloud Services | Azure"
...
> [AZURE.NOTE]
> The procedures in this task apply to Azure Cloud Services. For App Services, see [this](/documentation/articles/app-service-web/web-sites-custom-domain-name/). For storage accounts, see [this](/documentation/articles/storage/storage-custom-domain-name/).
...
[VIP swaps]:/documentation/articles/cloud-services/cloud-services-how-to-manage-portal/#how-to-swap-deployments-to-promote-a-staged-deployment-to-production
