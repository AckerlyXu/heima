<properties
	pageTitle="How to use Azure diagnostics (.NET) with Cloud Services | Azure"
...
See [Azure Diagnostics Overview](/documentation/articles/azure-diagnostics/) for a background on Azure Diagnostics.
...
If you have trouble, see [Troubleshooting Azure Diagnostics](/documentation/articles/azure-diagnostics-troubleshooting/) for help with common problems.

## Next Steps
[See a list of virtual machine related Azure Diagnostics articles](/documentation/articles/azure-diagnostics/#cloud-services-using-azure-diagnostics) to change the data you are collecting, troubleshoot problems or learn more about diagnostics in general.
