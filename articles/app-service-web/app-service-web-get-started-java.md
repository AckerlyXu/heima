...
In order to simplify the process of publishing Java web apps to Azure, the steps in this tutorial will use the [Azure Toolkit for Eclipse](/azure-toolkit-for-eclipse). For instructions on how to install the toolkit, see [Installing the Azure Toolkit for Eclipse](/azure-toolkit-for-eclipse-installation).
...
* A unique name for your web app, which will become the DNS address for your web app; for example: **MyJavaWebApp** will be *myjavawebapp.chinacloudsites.cn*.
...
When your new app service has been created, the last option which you need to choose is whether to deploy your web app to the root of your new website. For example, if you have an app service at *wingtiptoys.chinacloudsites.cn* and you do not deploy to the root, then your web app named **MyFirstJavaOnAzureWebApp** will be deployed to *wingtiptoys.chinacloudsites.cn/MyFirstJavaOnAzureWebApp*.
...
For more information about using Azure with Java, see the [Azure Java Developer Center](/develop/java/) and the [Java Tools for Visual Studio Team Services](https://java.visualstudio.com/).
