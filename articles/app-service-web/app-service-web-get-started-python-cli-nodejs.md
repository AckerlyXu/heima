...
- [Azure CLI 1.0](/documentation/articles/app-service-web-get-started-python-cli-nodejs/) - our CLI for the classic and resource management deployment models
- [Azure CLI 2.0](/documentation/articles/app-service-web-get-started-python/) - our next generation CLI for the resource management deployment model
