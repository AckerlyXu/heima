...
The **Free** [App Service](./app-service-changes-existing-services.md) plan mode does not support adding custom domains to Web Apps. You will need to switch to **Shared** or **Standard** mode. To do this:
