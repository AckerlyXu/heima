...
Set the PHP version that the application requires by using the [az webapp config set](https://docs.microsoft.com/cli/azure/webapp/config#set) command.
...
az webapp config appsettings set \
    --name <app_name> \
    --resource-group myResourceGroup \
    --settings DB_HOST="<mysql_server_name>.database.chinacloudapi.cn" DB_DATABASE="sampledb" DB_USERNAME="phpappuser@<mysql_server_name>" DB_PASSWORD="MySQLAzure2017" MYSQL_SSL="true"
```
