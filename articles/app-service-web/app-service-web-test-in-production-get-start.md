...
With the Traffic Routing feature in [Azure App Service](/app-service-web/app-service-changes-existing-services), you can direct a portion of live user traffic to one or more [deployment slots](web-sites-staged-publishing.md), and then analyze your app with [Azure HDInsight](https://www.azure.cn/home/features/hdinsight/), or a third-party tool like New Relic to validate your change. For example, you can implement the following scenarios with App Service:
