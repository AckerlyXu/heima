---
title: Create a PHP application on Azure Web App | Azure
...
This quickstart tutorial walks through how to develop and deploy a PHP app to Azure. We'll run the app using an [Azure App Service plan](/app-service/azure-web-sites-web-hosting-plans-in-depth-overview), and create and configure a new Web App within it using the Azure CLI. We'll then use git to deploy our PHP app to Azure.
...
Create a "FREE" [App Service plan](../app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md) with the [az appservice plan create](https://docs.microsoft.com/cli/azure/appservice/plan#create) command.
