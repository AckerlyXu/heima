<properties
    pageTitle="Develop Node.js web apps for Azure App Service | Azure"
...
- [Azure CLI 1.0](/documentation/articles/app-service-web-nodejs-get-started-cli-nodejs/) - our CLI for the classic and resource management deployment models
- [Azure CLI 2.0](/documentation/articles/app-service-web-nodejs-get-started/) - our next generation CLI for the resource management deployment model
...
3. Create a new [resource group](/documentation/articles/resource-group-overview/). For this node.js tutorial, you don't really need to know
what it is.
...
3. Create a new "FREE" [App Service plan](/documentation/articles/azure-web-sites-web-hosting-plans-in-depth-overview/). For this node.js tutorial, just 
