<properties
    pageTitle="Deploy a Sails.js web app to Azure App Service | Azure"
...
- [Azure CLI 1.0](/documentation/articles/app-service-web-nodejs-sails-cli-nodejs/) - our CLI for the classic and resource management deployment models
- [Azure CLI 2.0](/documentation/articles/app-service-web-nodejs-sails/) - our next generation CLI for the resource management deployment model
...
3. Create a [resource group](/documentation/articles/resource-group-overview/) with a name. For this PHP tutorial, you don't really need to know
what it is.
...
3. Create a "FREE" [App Service plan](/documentation/articles/azure-web-sites-web-hosting-plans-in-depth-overview/) with a name. For this PHP tutorial, just 
...
show you how to connect to MongoDB by using an [Azure DocumentDB](/documentation/articles/documentdb-protocol-mongodb/) database, which can support MongoDB client connections.

1. [Create a DocumentDB account with MongoDB protocol support](/documentation/articles/documentdb-create-mongodb-account/).
2. [Create a DocumentDB collection and database](/documentation/articles/documentdb-create-collection/). The name of the collection doesn't matter,
but you need the name of the database when you connect from Sails.js.
3. [Find the connection information for your DocumentDB database](/documentation/articles/documentdb-connect-mongodb-account/#a-idgetcustomconnectiona-get-the-mongodb-connection-string-to-customize).
...
3. Open config/connections.js and add the following connection object to the list:
    ...
    > [AZURE.NOTE] 
    > The `ssl: true` option is important because [Azure DocumentDB requires it](/documentation/articles/documentdb-connect-mongodb-account/#connection-string-requirements). 
    >
    >
