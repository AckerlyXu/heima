...
* For information on creating an ASP.NET web application that uses a hybrid connection, see [Connect to an on-premises SQL Server from an Azure web site using Hybrid Connections](./web-sites-hybrid-connection-connect-on-premises-sql-server.md). 
...
[Hybrid Connections web site](https://www.azure.cn/home/features/biztalk-services/)
