...
- A **TXT** record to map to the app's default hostname `<app_name>.chinacloudsites.cn`. This record lets App Service verify that you own the custom domain you want to map.
