<properties
    pageTitle="Create a static HTML web app in Azure in five minutes | Azure"
...
This Quickstart helps you deploy a simple HTML+CSS site to [Azure App Service](/documentation/articles/app-service-value-prop-what-is/) in just a few minutes.
