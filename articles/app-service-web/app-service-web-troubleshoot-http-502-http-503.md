...
"502 bad gateway" and "503 service unavailable" are common errors in your web app hosted in [Azure App Service](/app-service-web/app-service-changes-existing-services). This article helps you troubleshoot these errors.
