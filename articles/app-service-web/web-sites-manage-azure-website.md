...
This topic contains links to resources for managing a web app in [Azure App Service](./app-service-changes-existing-services.md). Management includes all of the tasks that keep your web app running smoothly. 
