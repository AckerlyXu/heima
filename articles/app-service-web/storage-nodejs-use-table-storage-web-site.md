...
## Overview
This tutorial shows you how to use Table service provided by Azure Data Management to store and access data from a [node] application hosted in [Azure App Service](./app-service-changes-existing-services.md) Web Apps. This tutorial assumes that you have some prior experience using node and [Git].
