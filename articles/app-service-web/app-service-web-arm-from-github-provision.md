<properties
    pageTitle="Deploy a web app that is linked to a GitHub repository | Azure"
...
> [AZURE.NOTE] This sample GitHub Repo cannot be deployed correctly in Azure China because the Jquery package of Nuget cannot be downloaded correctly. You can create a usable project and push it to GitHub.
