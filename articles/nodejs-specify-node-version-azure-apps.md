...
## Next Steps
Now that you understand how to specify the version of Node.js used by your application, learn how to [work with modules], [build and deploy a Node.js Web Site](/documentation/articles/web-sites-nodejs-develop-deploy-mac/), and [How to use the Azure Command-Line Tools for Mac and Linux].
