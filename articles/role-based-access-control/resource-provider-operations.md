...
|/redis/listKeys/action|View the value of Redis Cache access keys in portal|
...
|/redis/read|View the Redis Cache's settings and configuration in ortal|
|/redis/regenerateKey/action|Change the value of Redis Cache access keys in portal|
|/redis/start/action|Start a cache instance.|
|/redis/stop/action|Stop a cache instance.|
|/redis/write|Modify the Redis Cache's settings and configuration in portal|
...
|/operatingSystemFamilies/read|Lists the guest operating system families available in Azure, and also lists the operating system versions available for each family.|
...
|/Namespaces/NotificationHubs/pnsCredentials/action|Get All Notification Hub PNS Credentials. This includes, WNS, MPNS, APNS and Baidu credentials|
