...
- [Azure CLI 2.0](/cli). You can [install](/cli/install-azure-cli) it on macOS, Linux, and Windows and run it from the command line.
...
To create a role assignment for a user at the resource group scope, use [az role assignment create](/cli/role/assignment#az_role_assignment_create):
...
To create a role assignment for a group, use [az role assignment create](/cli/role/assignment#az_role_assignment_create):
...
To create a role for an application, use [az role assignment create](/cli/role/assignment#az_role_assignment_create):
