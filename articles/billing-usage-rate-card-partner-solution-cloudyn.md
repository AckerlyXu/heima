<properties
    pageTitle="Azure Usage and RateCard APIs Enable Cloudyn to Provide ITFM for Customers | Azure"
    description="Provides a unique perspective from Azure Billing partner Cloudyn, on their experiences integrating the Azure Billing APIs into their product.  This is especially useful for Azure and Cloudyn customers that are interested in using/trying Cloudyn for Azure Services."
    services=""
    documentationcenter=""
    author="BryanLa"
    manager="mbaldwin"
...
Upon registration for [Cloudyn for Azure](https://www.cloudyn.com/microsoft-azure/) services, customers can add their OfferDurableID code, which allows Cloudyn to pull their relevant pricing information through the RateCard API.  Information on the different types of offers can be found one the [Azure Offer Details](/support/legal/offer-details/) page.
...
## Next Steps
- Start a free [Cloudyn for Azure](https://www.cloudyn.com/microsoft-azure/) trial to see how you can obtain cost transparency with customized reporting and analytics for your Azure cloud deployment.
- See [Gain insights into your Azure resource consumption](/documentation/articles/billing-usage-rate-card-overview/) for an overview of the Azure Resource Usage and RateCard APIs.
...
## Learn More
- To learn more about Azure Enterprise Agreement (EA) offers, please visit [Licensing Azure for the Enterprise](/pricing/enterprise-agreement/)
