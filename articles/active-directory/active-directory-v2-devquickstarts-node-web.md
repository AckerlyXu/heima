<properties
	pageTitle="Azure AD v2.0 NodeJS Web App | Azure"
...
[Secure a node.js web api using the v2.0 endpoint >>](/documentation/articles/active-directory-v2-devquickstarts-node-api/)
