<properties
    pageTitle="Install an Active Directory forest on an Azure virtual network | Azure"
...
- [Install a Replica Active Directory Domain Controller in an Azure virtual network](/documentation/articles/active-directory-install-replica-active-directory-domain-controller/)
