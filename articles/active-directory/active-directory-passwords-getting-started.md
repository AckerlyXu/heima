...
- Create an AAD tenant. For more information, see [Getting Started with Azure AD](/documentation/services/identity/)
...
- Upgrade to Azure AD Premium, Basic, or use an O365 paid license. For more information, see [Azure Active Directory Editions](/pricing/details/identity/).
