<properties
    pageTitle="Azure AD v2.0 Protocols | Azure"
...
For more details, learn how to [register an app](/documentation/articles/active-directory-v2-app-registration/).
...
Further details of different types of tokens used in the v2.0 endpoint is available in [the v2.0 endpoint token reference](/documentation/articles/active-directory-v2-tokens/).
...
check out [the types of apps you can build with the v2.0](/documentation/articles/active-directory-v2-flows/).
...
- [Build Daemons or Server Side Processes with the OAuth 2.0 Client Credentials Flow](/documentation/articles/active-directory-v2-protocols-oauth-client-creds/)
