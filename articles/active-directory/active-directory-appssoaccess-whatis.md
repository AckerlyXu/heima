<properties
	pageTitle="What is application access and single sign-on with Azure Active Directory? | Azure"
...
The Access Panel at https://myapps.microsoft.com is a web-based portal that allows an end user with an organizational account in Azure Active Directory to view and launch cloud-based applications to which they have been granted access by the Azure AD administrator. If you are an end-user with [Azure Active Directory Premium](/pricing/details/identity/), you can also utilize self-service group management capabilities through the Access Panel.
...
- [Introduction to Managing Access to Apps](/documentation/articles/active-directory-managing-access-to-apps/)
