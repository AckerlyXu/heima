...
To use this sample, you will need an [Azure Active Directory](/documentation/articles/active-directory-whatis/) tenant.
...
1. Navigate to the [Azure classic portal](https://manage.windowsazure.cn/).
