...
3.	Start a new command prompt or PowerShell session. Navigate to folder <drive>\program files\Azure AD Connect. Run command .\AzureADConnect.exe /useexistingdatabase to start the Azure AD Connect wizard in “Use existing database” setup mode.
