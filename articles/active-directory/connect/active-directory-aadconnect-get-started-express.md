...
7. The [**Azure AD sign-in configuration**](active-directory-aadconnect-user-signin.md#azure-ad-sign-in-configuration) page only shows if you did not complete [verify your domains](../add-custom-domain.md) in the [prerequisites](active-directory-aadconnect-prerequisites.md).
