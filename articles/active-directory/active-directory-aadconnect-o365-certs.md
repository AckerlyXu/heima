<properties
    pageTitle="Certificate renewal for Office 365 and Azure AD users | Azure"
...
For more information, see [Repairing the trust](/documentation/articles/active-directory-aadconnect-federation-management/).
