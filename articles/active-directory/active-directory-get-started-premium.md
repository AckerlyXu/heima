...
If you have used Azure before, you can proceed to [Step 4](#step-4-assign-license-to-user-accounts). 
...
1. Sign into the Azure Classic Management Portal as the global administrator of the directory you wish to customize.
