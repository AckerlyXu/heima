...
> [!IMPORTANT]
> Microsoft recommends that you manage Azure AD using the [Azure AD admin center](https://aad.portal.azure.cn) in the Azure portal instead of using the Azure portal referenced in this article.
