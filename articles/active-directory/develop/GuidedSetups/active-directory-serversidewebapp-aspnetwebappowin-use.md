...
<!--start-collapse-->
### More Information
> This page adds a sign-in button in SVG format with a black background:<br/>![Sign-in with Microsoft](./media/active-directory-serversidewebapp-aspnetwebappowin-use/aspnetsigninbuttonsample.png)<br/> For more sign-in buttons, please go to the [this page](/active-directory/develop/active-directory-branding-guidelines/).
<!--end-collapse-->
