...
- Gets access tokens for calling a To-Do List API using [OAuth 2.0 authentication protocol](/active-directory/develop/active-directory-protocols-oauth-code).
...
1. Add a reference to your project and specify it as an Android library. 
...
The authority URL needs an STS instance and a [tenant name](https://login.partner.microsoftonline.cn/yourtenant.partner.onmschina.cn).
...
To learn more about what errors your app should handle, checkout the [Error handling best practices](/active-directory/develop/active-directory-devhowto-adal-error-handling). 
