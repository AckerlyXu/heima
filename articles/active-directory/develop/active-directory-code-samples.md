...
These code samples show how use [OAuth 2.0 in Azure AD](/active-directory/develop/active-directory-protocols-oauth-code) to build web applications that call web APIs that are secured by Azure AD.
