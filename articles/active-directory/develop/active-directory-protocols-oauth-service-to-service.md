...
| client_id |required |Specifies the Azure AD client id of the calling web service. To find the calling application's client ID, in the [Azure portal](https://portal.azure.cn), click **Active Directory**, switch directory, click the application. The client_id is the *Application ID* |
