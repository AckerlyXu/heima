...
- Azure account: if you don't have an Azure account, you can [sign up for a trial](https://www.azure.cn/pricing/1rmb-trial) .
...
1. You can also see the Active Directory domain on the [Azure portal](https://portal.azure.cn).
