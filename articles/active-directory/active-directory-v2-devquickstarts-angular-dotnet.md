<properties
    pageTitle="Azure AD v2.0 .NET AngularJS single page app getting started | Azure"
...
To continue learning about the v2.0 endpoint, head back to our [v2.0 developer guide](/documentation/articles/active-directory-appmodel-v2-overview/).  For additional resources, check out:
