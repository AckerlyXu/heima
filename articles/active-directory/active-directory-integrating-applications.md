<properties
    pageTitle="Integrating Applications with Azure Active Directory | Azure"
...
5. On the Tell us about your application page, you must specify a name for your application as well as indicate the type of application you are registering with Azure AD.  You can choose from either a [web application/client](/documentation/articles/active-directory-dev-glossary/#client-application/) / [web resource/API](/documentation/articles/active-directory-dev-glossary/#resource-server/) application (may also function as both), or a [native client](/documentation/articles/active-directory-dev-glossary/#native-client/) application. Once finished, click the arrow icon on the bottom-right corner of the page.
...
For more information on the way authentication works in Azure AD, see [Authentication Scenarios for Azure AD](/documentation/articles/active-directory-authentication-scenarios/).
...
For more detailed information about the consent framework, see [OAuth 2.0 in Azure AD](/documentation/articles/active-directory-protocols-oauth-code/), [Authentication Scenarios for Azure AD](/documentation/articles/active-directory-authentication-scenarios/), and Office 365 topic [Understanding authentication with Office 365 APIs](https://msdn.microsoft.com/office/office365/howto/common-app-authentication-tasks).
...
You can develop a web API and make it available to client applications by exposing access [scopes](/documentation/articles/active-directory-dev-glossary/#scopes/) and [roles](/documentation/articles/active-directory-dev-glossary/#roles/). A correctly configured web API is made available just like the other Microsoft web APIs, including the Graph API and the Office 365 APIs. Access scopes and roles are exposed through your [application's manifest](/documentation/articles/active-directory-dev-glossary/#application-manifest/), which is a JSON file that represents your application’s identity configuration.  
...
> [AZURE.NOTE]
> When enabling multi-tenant, you must ensure that your application’s App ID URI belongs in a verified domain. Additionally, the Return URL must begin with https://. For more information, see [Application Objects and Service Principal Objects](/documentation/articles/active-directory-application-objects/).
> 
> 
...
Single Page Application’s (SPAs) are typically structured with a JavaScript-heavy front end that runs in the browser, which calls the application’s web API back end to perform its business logic. For SPAs hosted in Azure AD, you use OAuth 2.0 Implicit Grant to authenticate the user with Azure AD and obtain a token that you can use to secure calls from the application's JavaScript client to its back end web API. After the user has granted consent, this same authentication protocol can be used to obtain tokens to secure calls between the client and other web API resources configured for the application. To learn more about the implicit authorization grant, and help you decide whether it's right for your application scenario, see [Understanding the OAuth2 implicit grant flow in Azure Active Directory ](/documentation/articles/active-directory-dev-understanding-oauth2-implicit-grant/).

By default, OAuth 2.0 implicit Grant is disabled for applications. You can enable OAuth 2.0 Implicit Grant for your application by setting the `oauth2AllowImplicitFlow` value in its [application manifest](/documentation/articles/active-directory-application-manifest/), which is a JSON file that represents your application's identity configuration.
...
## Next steps
- See the [Branding Guidelines for Integrated Apps](/documentation/articles/active-directory-branding-guidelines/) for tips on visual guidance for your app.
- For more details on the relationship between an application's Application and Service Principal object(s), see [Application Objects and Service Principal Objects](/documentation/articles/active-directory-application-objects/).
- To learn more about the role the app manifest plays, see [Understanding the Azure Active Directory application manifest](/documentation/articles/active-directory-application-manifest/)
- See the [Azure AD developer glossary](/documentation/articles/active-directory-dev-glossary/) for definitions of some of the core Azure Active Directory (AD) developer concepts.
- Visit the [Active Directory developer's guide](/documentation/articles/active-directory-developers-guide/) for an overview of all developer related content.
