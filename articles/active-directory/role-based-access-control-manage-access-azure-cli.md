<properties
    pageTitle="Manage Role-Based Access Control (RBAC) with Azure CLI | Azure"
...
- Azure Resource Manager in Azure CLI. Go to [Using the Azure CLI with the Resource Manager](/documentation/articles/xplat-cli-azure-resource-manager/) for more details.
