---
title: Unexpected application in my applications list | Azure
...
## I want to remove a specific user’s assignment to an application

To remove a user or group assignment to an application, follow the steps listed in the [Remove a user assignment from an enterprise app in Azure Active Directory](application-access-assignment-how-to-remove-assignment.md) article.
