---
title: Create a group for users in Azure Active Directory | Azure
...
6. To select members to add to the group, select **Assigned** in the **Membership type** box, and then select **Members**. 
