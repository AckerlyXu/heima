<properties
    pageTitle="Multiple input files and component properties with Premium Encoder - Azure | Azure"
...
- The first one is a *Workflow Asset* that contains a workflow file. You can design workflow files by using the [Workflow Designer](/documentation/articles/media-services-workflow-designer/), 
...
- [Encoding on-demand content with Azure Media Services](/documentation/articles/media-services-encode-asset/#media_encoder_premium_workflow)
