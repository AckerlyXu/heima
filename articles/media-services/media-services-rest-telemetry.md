<properties
    pageTitle="Configuring Azure Media Services telemetry with REST| Azure"
...
>[AZURE.NOTE]For the detailed explanation of what is AMS telemetry and how to consume it, see the [overview](/documentation/articles/media-services-telemetry-overview/) topic.
...
>[AZURE.NOTE]Don't forget to change the "https://telemetryvalidationstore.table.core.chinacloudapi.cn" value to your storage account.
...
For information about consuming telemetry information, see [this](/documentation/articles/media-services-telemetry-overview/) topic.
