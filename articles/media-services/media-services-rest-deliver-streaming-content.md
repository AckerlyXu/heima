...
>[!NOTE]
>After successfully connecting to https://media.chinacloudapp.cn, you will receive a 301 redirect specifying another Media Services URI. You must make subsequent calls to the new URI.
