<properties
    pageTitle="How to perform live streaming using Azure Media Services to create multi-bitrate streams with the Azure portal | Azure"
...
>[AZURE.NOTE]For more conceptual information related to Channels that are enabled for live encoding, see [Live streaming using Azure Media Services to create multi-bitrate streams](/documentation/articles/media-services-manage-live-encoder-enabled-channels/).
...
5. Select the **Ingest** tab.
	...
	1. On this page, you can select a streaming protocol. For the **Live Encoding** channel type, valid protocol options are:
		...
		For detailed explanation about each protocol, see [Live streaming using Azure Media Services to create multi-bitrate streams](/documentation/articles/media-services-manage-live-encoder-enabled-channels/).
...
For more information, see [Live streaming using Azure Media Services to create multi-bitrate streams](/documentation/articles/media-services-manage-live-encoder-enabled-channels/).
