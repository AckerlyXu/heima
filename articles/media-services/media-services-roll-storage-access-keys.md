<properties
    pageTitle="Update Media Services after rolling storage access keys | Azure"
...
To perform the actions described in this topic, you should be using [ARM APIs](https://docs.microsoft.com/rest/api/media/mediaservice) and [Powershell](https://docs.microsoft.com/powershell/resourcemanager/azurerm.media/v0.3.2/azurerm.media).  For more information, see [How to manage Azure resources with PowerShell and Resource Manager](/documentation/articles/powershell-azure-resource-manager/).
...
The following topic shows how to add storage accounts to your AMS account: [Attach multiple storage accounts to a Media Services account](/documentation/articles/meda-services-managing-multiple-storage-accounts/).
