<properties
    pageTitle="Perform advanced encoding by customizing MES presets | Azure"
...
This topic shows how to customize Media Encoder Standard presets. The [Encoding with Media Encoder Standard using custom presets](/documentation/articles/media-services-custom-mes-presets-with-dotnet/) topic shows how to use .NET to create an encoding task and a job that executes this task. Once you customize a preset, supply the custom presets to the encoding task. 
...
This section shows how to customize a preset that generates thumbnails. The preset defined below contains information on how you want to encode your file as well as information needed to generate thumbnails. You can take any of the MES presets documented [this](/documentation/articles/media-services-mes-presets-overview/) section and add code that generates thumbnails.  
...
For information about schema, see [this](/documentation/articles/media-services-mes-schema/) topic.
...
To trim your videos, you can take any of the MES presets documented [here](/documentation/articles/media-services-mes-presets-overview/) and modify the **Sources** element (as shown below).
...
You can take any of the MES presets documented in [this](/documentation/articles/media-services-mes-presets-overview/) section, and make the following modification:
...
See the [Crop videos with Media Encoder Standard](/documentation/articles/media-services-crop-video/) topic.
...
The [Media Encoder Standard](/documentation/articles/media-services-dotnet-encode-with-media-encoder-standard/) supports rotation by angles of 0/90/180/270. The default behavior is "Auto", where it tries to detect the rotation metadata in the incoming video file and compensate for it. Include the following **Sources** element to one of the presets defined in [this](/documentation/articles/media-services-mes-presets-overview/) section:
...
Also, see [this](/documentation/articles/media-services-mes-schema/#PreserveResolutionAfterRotation) topic for more information on how the encoder interprets the Width and Height settings in the preset, when rotation compensation is triggered.
