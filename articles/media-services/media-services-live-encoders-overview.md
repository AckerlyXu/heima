<properties
    pageTitle="Configure on-premise encoders when using Azure Media Services to create multi-bitrate streams | Azure"
...
[Live streaming using Azure Media Services to create multi-bitrate streams](/documentation/articles/media-services-manage-live-encoder-enabled-channels/).