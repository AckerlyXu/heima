<properties
    pageTitle="Stream live with on-premises encoders that create multi-bitrate streams - Azure | Azure"
...
* By default, you can add only 5 channels to your Media Services account. For more information, see [Quotas and limitations](/documentation/articles/media-services-quotas-and-limitations/).
* You are billed only when your channel is in the **Running** state. For more information, refer to the [Channel states and billing](/documentation/articles/media-services-live-streaming-with-onprem-encoders/#states) section.
...
[Azure Media Services overview and common scenarios](/documentation/articles/media-services-overview/)
