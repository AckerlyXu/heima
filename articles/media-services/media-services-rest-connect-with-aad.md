...
1. Open **Postman**.
2. Select **POST**.
3. Enter the URL that includes your tenant name using the following format: the tenant name should end with **.partner.onmschina.cn** and the URL should end with **oauth2/token**: 
...
1. Open **Postman**.
2. Select **GET**.
3. Paste the REST API endpoint (for example, https://amshelloworld.restv2.chinanorth.media.chinacloudapi.cn/api/Assets)
