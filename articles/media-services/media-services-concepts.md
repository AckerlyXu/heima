<properties
    pageTitle="Azure Media Services concepts | Azure"
...
To take advantage of [dynamic packaging](/documentation/articles/media-services-dynamic-packaging-overview/), you need to encode your mezzanine (source) file into a set of adaptive bitrate MP4 files or adaptive bitrate Smooth Streaming files and have at least one standard or premium streaming endpoint in started state.
...
For more information, see [this](/documentation/articles/media-services-portal-manage-streaming-endpoints/) topic.
