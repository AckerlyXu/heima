<properties
    pageTitle="How to perform live streaming using Azure Media Services to create multi-bitrate streams with .NET  | Azure"
...
For more conceptual information related to Channels that are enabled for live encoding, see [Live streaming using Azure Media Services to create multi-bitrate streams](/documentation/articles/media-services-manage-live-encoder-enabled-channels/).
