...
- An Azure account. For details, see [Azure Trial](/pricing/1rmb-trial/). 
...
- Understanding of how to develop with Media Services REST API. For more information, see [Media Services REST API overview](/documentation/articles/media-services-rest-how-to-use/).
...
For details about AMS REST entities used in this topic, see [Azure Media Services REST API Reference](https://docs.microsoft.com/rest/api/media/services/azure-media-services-rest-api-reference). Also, see [Azure Media Services concepts](/documentation/articles/media-services-concepts/).
...
For more information see, [Creating an Encoding Job with the Media Services REST API](/documentation/articles/media-services-rest-encode-asset/).
