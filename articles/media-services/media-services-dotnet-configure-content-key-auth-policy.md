<properties
    pageTitle="Configure content key authorization policy using Media Services .NET SDK | Azure"
...
[This topic](/documentation/articles/media-services-protect-with-drm/) shows how to encrypt your content with **PlayReady** and **Widevine**.
