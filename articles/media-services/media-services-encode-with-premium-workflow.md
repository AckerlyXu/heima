...
<properties 
	pageTitle="Advanced encoding with Media Encoder Premium Workflow | Azure" 
...
- The [compare encoders](/documentation/articles/media-services-encode-asset/#compare_encoders) section compares the encoding capabilities of **Media Encoder Premium Workflow** and **Media Encoder Standard**.
