<properties
    pageTitle="Azure Media Services input metadata schema | Azure"
...
If you want to examine the metadata file, you can create a **SAS** locator and download the file to your local computer. You can find an example on how to create a SAS locator and download a file  [Using the Media Services .NET SDK Extensions](/documentation/articles/media-services-dotnet-get-started/).  

This topic discusses the elements and types of the XML schema on which the input metada (&lt;asset_id&gt;_metadata.xml) is based.  For information about the file that contains metadata about the output asset, see [Output Metadata](/documentation/articles/media-services-output-metadata-schema/).  

> [AZURE.NOTE]You can find the [Schema Code](/documentation/articles/media-services-input-metadata-schema/#code) an [XML example](/documentation/articles/media-services-input-metadata-schema/#xml) at the end of this topic.  


## <a name="AssetFiles"></a> AssetFiles element (root element)
Contains a collection of [AssetFile element](/documentation/articles/media-services-input-metadata-schema/#AssetFile)s for the encoding job.  

See an XML example at the end of this topic: [XML example](/documentation/articles/media-services-input-metadata-schema/#xml).  

| Name | Description |
| --- | --- |
| **AssetFile**<br /><br /> minOccurs="1" maxOccurs="unbounded" |A single child element. For more information, see [AssetFile element](/documentation/articles/media-services-input-metadata-schema/#AssetFile). |
...
| Name | Type | Description |
| --- | --- | --- |
| **Programs**<br /><br /> minOccurs="0" | |Collection of all [Programs element](/documentation/articles/media-services-input-metadata-schema/#Programs) when the asset file is in MPEG-TS format. |
| **VideoTracks**<br /><br /> minOccurs="0" | |Each physical asset file can contain zero or more video tracks interleaved into an appropriate container format. This element contains a collection of all [VideoTracks element](/documentation/articles/media-services-input-metadata-schema/#VideoTracks) that are part of the asset file. |
| **AudioTracks**<br /><br /> minOccurs="0" | |Each physical asset file can contain zero or more audio tracks interleaved into an appropriate container format. This element contains a collection of all [AudioTracks element](/documentation/articles/media-services-input-metadata-schema/#AudioTracks) that are part of the asset file. |
| **Metadata**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[MetadataType](/documentation/articles/media-services-input-metadata-schema/#MetadataType) |Asset file’s metadata represented as key\value strings. For example:<br /><br /> **&lt;Metadata key="language" value="eng" /&gt;** |
...
| Name | Type | Description |
| --- | --- | --- |
| **Disposition**<br /><br /> minOccurs="0" maxOccurs="1" |[StreamDispositionType](/documentation/articles/media-services-input-metadata-schema/#StreamDispositionType) |Contains presentation information (for example, whether a particular audio track is for visually impaired viewers). |
| **Metadata**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[MetadataType](/documentation/articles/media-services-input-metadata-schema/#MetadataType) |Generic key/value strings that can be used to hold a variety of information. For example, key=”language”, and value=”eng”. |

## <a name="AudioTrackType"></a> AudioTrackType (inherits from TrackType)
 **AudioTrackType** is a global complex type that inherits from [TrackType](/documentation/articles/media-services-input-metadata-schema/#TrackType).  
...
**VideoTrackType** is a global complex type that inherits from [TrackType](/documentation/articles/media-services-input-metadata-schema/#TrackType).  
...
| Name | Type | Description |
| --- | --- | --- |
| **Program**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[ProgramType](/documentation/articles/media-services-input-metadata-schema/#ProgramType) |For asset files that are in MPEG-TS format, contains information about programs in the asset file. |
...
| Name | Type | Description |
| --- | --- | --- |
| **VideoTrack**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[VideoTrackType (inherits from TrackType)](/documentation/articles/media-services-input-metadata-schema/#VideoTrackType) |Contains information about video tracks in the asset file. |
...
| Name | Type | Description |
| --- | --- | --- |
| **AudioTrack**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[AudioTrackType (inherits from TrackType)](/documentation/articles/media-services-input-metadata-schema/#AudioTrackType) |Contains information about audio tracks in the asset file. |
