<properties
    pageTitle="Implementing failover streaming scenario | Azure"
...
- Two Media Services accounts in a new or existing Azure subscription. See [How to Create a Media Services Account](/documentation/articles/media-services-portal-create-account/).
