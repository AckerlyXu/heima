...
> [!NOTE]
>  You should get the Premium reserved unit type with 4K encodes. For more information, see [How to Scale Encoding](/media-services/media-services-scale-media-processing-overview).  
