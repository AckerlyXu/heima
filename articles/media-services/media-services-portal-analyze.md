<properties
    pageTitle="Analyze your media using the Azure portal | Azure"
...
### Job name
A friendly name that lets you identify the job. [This](/documentation/articles/media-services-portal-check-job-progress/) article describes how you can monitor the progress of a job. 

### Output file
A friendly name that lets you identify the output content. 

## Azure Media Hyperlapse
Azure Media Hyperlapse is an MP that creates smooth time-lapsed videos from first-person or action-camera content.  For more information, see [this](/documentation/articles/media-services-hyperlapse-content/) topic. This sections gives some details about options that you can specify for this MP.
