---
title: Use PowerShell to create an Azure AD app to access the Azure Media Services API | Azure
...
- An Azure account. If you don't have an account, start with an [Azure 1rmb trial](https://www.azure.cn/pricing/1rmb-trial/).
