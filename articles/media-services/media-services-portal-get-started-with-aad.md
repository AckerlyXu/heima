---
title: Get started with Azure AD authentication by using the Azure portal| Azure
...
- An Azure account. If you don't have an account, start with an [Azure trial](https://www.azure.cn/pricing/1rmb-trial/). 
...
1. In the [Azure portal](https://portal.azure.cn/), select your Media Services account.
