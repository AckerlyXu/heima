<properties
    pageTitle="Redact faces with Azure Media Analytics walkthrough | Azure"
...
For details about  **Azure Media Redactor**, see the [Face redaction overview](/documentation/articles/media-services-face-redaction/) topic.
