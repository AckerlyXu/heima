<properties
    pageTitle="Customizing Media Encoder Standard presets | Azure"
...
In this topic you will see how to customize a preset by taking the [H264 Multiple Bitrate 720p](/documentation/articles/media-services-mes-preset-H264-Multiple-Bitrate-720p/) preset and reducing the number of layers. The [Customizing Media Encoder Standard presets](/documentation/articles/media-services-advanced-encoding-with-mes/) topic demonstrates custom presets that can be used to perform advanced encoding tasks.

## <a id="customizing_presets"></a> Customizing a MES preset

### Original preset

Save the JSON defined in the [H264 Multiple Bitrate 720p](/documentation/articles/media-services-mes-preset-H264-Multiple-Bitrate-720p/) topic in some file with .json extension. For example, **CustomPreset_JSON.json**.
