<properties
    pageTitle="Encode an asset using Media Encoder Standard with the Azure portal | Azure"
...
- Get at least one streaming unit for the streaming endpoint from which you plan to delivery your content. For more information, see [configuring streaming endpoints](/documentation/articles/media-services-portal-vod-get-started/#configure-streaming-endpoints). 

To scale media processing, see [this](/documentation/articles/media-services-portal-scale-media-processing/) topic.
...
## Next step
You can monitor encoding job progress with the Azure portal, as described in [this](/documentation/articles/media-services-portal-check-job-progress/) article.  
