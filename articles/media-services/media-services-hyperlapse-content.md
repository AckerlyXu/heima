...
First you will need to upload your desired input file to Azure Media Services.  To learn more about the concepts involved with uploading and managing content, read the [content management article](/documentation/articles/media-services-portal-vod-get-started/).
...
> [AZURE.NOTE] You should already have a CloudMediaContext in scope with the name "context" for this code to work.  To learn more about this, read the [content management article](/documentation/articles/media-services-dotnet-get-started/).
