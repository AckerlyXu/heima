<properties
    pageTitle="Archive telemetry data with Azure Event Hubs Archive overview | Azure"
...
Event Hubs is a time-retention durable buffer for telemetry ingress, similar to a distributed log. The key to scale in Event Hubs is the [partitioned consumer model](/documentation/articles/event-hubs-what-is-event-hubs/#partitions). Each partition is an independent segment of data and is consumed independently. Over time this data ages off, based on the configurable retention period. As a result, a given Event Hub never gets "too full."
...
You can also configure Event Hubs Archive via Azure Resource Manager templates. For more information see [this article](/documentation/articles/event-hubs-resource-manager-namespace-event-hub-enable-archive/).
...
Apache Avro has complete Getting Started guides for [Java][Java] and [Python][Python]. You can also read the [Getting Started with Event Hubs Archive](/documentation/articles/event-hubs-archive-python/) article.
