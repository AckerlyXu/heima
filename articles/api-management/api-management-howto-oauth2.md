---
title: Authorize developer accounts using OAuth 2.0 in Azure API Management | Azure
...
## Next steps
For more information about using OAuth 2.0 and API Management, see the [article](./api-management-howto-protect-backend-with-aad.md).
