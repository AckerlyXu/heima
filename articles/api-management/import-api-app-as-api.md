---
title: Import an API App as an API with the Azure portal
...
+ Make sure there is an API App in your subscription. For more information, see [App Service Documentation](/app-service/)
