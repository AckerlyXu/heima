---
title: How to use Azure API Management in Virtual Network with Application Gateway | Azure
...
Create a Virtual Network named **appgwvnet** in resource group **apim-appGw-RG** for the China East region using the prefix 10.0.0.0/16 with subnets 10.0.0.0/24 and 10.0.1.0/24.
...
Create a public IP resource **publicIP01** in resource group **apim-appGw-RG** for the China East region.
