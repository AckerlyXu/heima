---
title: Protect an API using OAuth 2.0 with Azure Active Directory and API Management
...
For **Sign-on URL**, you can use `https://localhost` as a placeholder or use the sign-in URL of your APIM instance. In this example, `https://contoso5.portal.azure-api.cn/signin` is used.
