---
title: Azure API Management policy expressions | Azure
...
> -   21:00 - See how to use an [API Inspector](./api-management-howto-api-inspector/) trace to see how policies are evaluated and the results of the evaluations.  
