---
title: How to set or edit Azure API Management policies
...
1. Sign in to the Azure portal at [https://portal.azure.com](https://portal.azure.cn).
...
1. Sign in to the [Azure portal](https://portal.azure.cn/) and navigate to your APIM instance.
2. Click **All APIs**.
