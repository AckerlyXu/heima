---
title: Database Encryption At Rest - DocumentDB | Microsoft Docs
description: Learn how DocumentDB provides default encryption of all data.
services: documentdb
author: voellm
manager: jhubbard
editor: mimig
...
# DocumentDB database encryption at rest
...
often asked as a proxy question for meeting a compliance like PCI-DSS.  As part of building this feature we have worked with compliance auditors to ensure customers using DocumentDB meeting their requirements without needing to manage keys themselves.
...
For an overview of DocumentDB security and the latest improvements see [DocumentDB database security](documentdb-nosql-database-security.md).
