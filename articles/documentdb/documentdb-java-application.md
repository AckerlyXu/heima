...
This Java web application tutorial shows you how to use the [Azure Cosmos DB](https://portal.azure.cn/#gallery/Microsoft.Azure Cosmos DB) service to store and access data from a Java application hosted on Azure Websites. In this topic, you will learn:
