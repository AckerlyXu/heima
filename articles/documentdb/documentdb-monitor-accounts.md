...
You can monitor your DocumentDB accounts in the [Azure portal](https://portal.azure.cn/). For each DocumentDB account, both performance metrics, such as requests and server errors, and usage metrics, such as storage consumption, are available.
...
1. In the [Azure portal](https://portal.azure.cn/), click **More Services**, scroll to **Databases**, click **DocumentDB**, and then click the name of the DocumentDB account for which you would like to view performance metrics.
...
1. In the [Azure portal](https://portal.azure.cn/), click **More Services**, click **DocumentDB**, and then click the name of the DocumentDB account for which you would like to setup performance metric alerts.
