...
keywords: Hierarchical model, cosmosdb, azure, Azure
services: cosmosdb
documentationcenter: ''
author: AndrewHoh
manager: jhubbard
...
You can [create and manage Cosmos DB database accounts](documentdb-create-account.md) via the Azure Portal at [http://portal.azure.cn/](https://portal.azure.cn/). Creating and managing a database account requires administrative access and can only be performed under your Azure subscription. 
