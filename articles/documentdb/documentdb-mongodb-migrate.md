---
title: Use mongoimport & mongorestore with DocumentDB's API for MongoDB | Microsoft Docs
...
# DocumentDB: How to import MongoDB data? 

To migrate data from MongoDB to a DocumentDB account for use with the MongoDB API, you must:
...
1. In the [Azure portal](https://portal.azure.cn), in the left pane, click the **DocumentDB** entry.
