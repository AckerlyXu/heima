---
title: Python Flask web application tutorial for DocumentDB | Microsoft Docs
...
This tutorial shows you how to use DocumentDB to store and access data from a Python web application hosted on Azure and presumes that you have some prior experience using Python and Azure websites.

This database tutorial covers:

1. Creating and provisioning an DocumentDB account.
2. Creating a Python MVC application.
3. Connecting to and using DocumentDB from your web application.
...
Let's start by creating an DocumentDB account. If you already have an account or if you are using the DocumentDB Emulator for this tutorial, you can skip to [Step 2: Create a new Python Flask web application](#step-2:-create-a-new-python-flask-web-application).
...
## Next steps
Congratulations! You have just completed your first Python web application using DocumentDB and published it to Azure Websites.
