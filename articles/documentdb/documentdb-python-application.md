<properties
    pageTitle="Python Flask Web Application Development with DocumentDB | Azure"
...
To add additional functionality to your web application, review the APIs available in the [DocumentDB Python SDK](/documentation/articles/documentdb-sdk-python/).
