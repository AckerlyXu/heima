<properties
    pageTitle="Learn Node.js - DocumentDB Node.js Tutorial | Azure"
...
- An active Azure account. If you don't have an account, you can create a trial account in just a couple of minutes. For details, see [Azure 1rmb-trial](/pricing/1rmb-trial/).

   OR

   A local installation of the [Azure DocumentDB Emulator](/documentation/articles/documentdb-nosql-local-emulator/).
...
1. If you haven't already, enable a git repository for your Azure Website. You can find instructions on how to do this in the [Local Git Deployment to Azure App Service](/documentation/articles/app-service-deploy-local-git/) topic.
...
- Explore the [DocumentDB documentation](/home/features/documentdb/).
