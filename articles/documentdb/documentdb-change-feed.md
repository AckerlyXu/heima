...
You can use DocumentDB to receive and store event data from devices, sensors, infrastructure, and applications, and process these events in real-time with Azure Stream Analytics, [Apache Storm](/documentation/articles/hdinsight-storm-overview/), or [Apache Spark](/documentation/articles/hdinsight-apache-spark-overview/). 
