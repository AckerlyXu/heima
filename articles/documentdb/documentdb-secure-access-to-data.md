...
This article provides an overview of securing access to data stored in [DocumentDB](https://www.azure.cn/home/features/documentdb/).
...
## Resource tokens <a name="resource-tokens"></a>
...
## Next steps
- To learn more about DocumentDB database security, see [DocumentDB: Database security](documentdb-nosql-database-security.md).
