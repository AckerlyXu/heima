---
title: Performance tips - DocumentDB NoSQL | Microsoft Docs
description: Learn client configuration options to improve DocumentDB database performance
...
## Next steps
For a sample application used to evaluate DocumentDB for high-performance scenarios on a few client machines, see [Performance and scale testing with DocumentDB](documentdb-performance-testing.md).

Also, to learn more about designing your application for scale and high performance, see [Partitioning and scaling in DocumentDB](documentdb-partition-data.md).
