...
This tutorial shows you how to use an Azure Resource Manager template to deploy and integrate [Azure Cosmos DB](https://www.azure.cn/home/features/documentdb/), an [Azure App Service](../app-service-web/app-service-changes-existing-services.md) web app, and a sample web application.
...
10. Feel free to continue exploring the Azure Portal, or follow one of our Azure Cosmos DB [samples](documentdb-dotnet-samples.md) to create your own Azure Cosmos DB application.
...
> [!NOTE]
> If you want to get started with Azure App Service before signing up for an Azure account, go to [Try App Service](/documentation/services/app-service/), where you can immediately create a short-lived starter web app in App Service. No credit cards required; no commitments.
> 
> 
