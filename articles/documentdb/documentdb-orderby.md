...
If you receive an error that Order By is not supported, check to ensure that you're using a version of the [SDK](/documentation/articles/documentdb-sdk-dotnet/) that supports Order By. 
