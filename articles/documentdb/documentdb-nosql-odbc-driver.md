...
description: Learn how to use the DocumentDB ODBC driver to create tables and views so that normalized data can be viewed in BI and data analytics software.
...
1. Download the drivers for your environment:
    ...
    - [DocumentDB ODBC 64-bit.msi](https://aka.ms/documentdb-odbc-64x64) for 64-bit Windows
    - [DocumentDB ODBC 32x64-bit.msi](https://aka.ms/documentdb-odbc-32x64) for 32-bit on 64-bit Windows
    - [DocumentDB ODBC 32-bit.msi](https://aka.ms/documentdb-odbc-32x32) for 32-bit Windows

    Run the msi file locally, which starts the **DocumentDB ODBC Driver Installation Wizard**. 
...
3. Open the **ODBC Data source Administrator** app on your computer, you can do this by typing **ODBC Data sources** in the Windows search box. 
    You can confirm the driver was installed by clicking the **Drivers** tab and ensuring **DocumentDB ODBC Driver** is listed.
...
2. In the **Create New Data Source** window, select **DocumentDB ODBC Driver**, and then click **Finish**.
