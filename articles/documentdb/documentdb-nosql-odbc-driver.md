...
1. Download the drivers for your environment:
    ...
    - [Azure Cosmos DB ODBC 64-bit.msi](https://aka.ms/documentdb-odbc-64x64) for 64-bit Windows
    - [Azure Cosmos DB ODBC 32x64-bit.msi](https://aka.ms/documentdb-odbc-32x64) for 32-bit on 64-bit Windows
    - [Azure Cosmos DB ODBC 32-bit.msi](https://aka.ms/documentdb-odbc-32x32) for 32-bit Windows
...
3. Open the **ODBC Data source Administrator** app on your computer, you can do this by typing **ODBC Data sources** in the Windows search box. 
    ...
    ![Azure Cosmos DB ODBC Data Source Administrator](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver.png)
...
3. In the **Azure Cosmos DB ODBC Driver SDN Setup** window, fill in the following: 
    ...
    ![Azure Cosmos DB ODBC Driver DSN Setup window](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-dsn-setup.png)
    ...
    ![Azure Cosmos DB Keys blade](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-keys.png)
...
6. Once you complete and close the **Azure Cosmos DB ODBC Driver DSN Setup** window, the new User DSN is added to the User DSN tab.
    ...
    ![New Azure Cosmos DB ODBC DSN on the User DSN tab](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-user-dsn.png)
...
1. After completing steps 1-4 in [Connect to your Azure Cosmos DB database](#connect), click **Schema Editor** in the **Azure Cosmos DB ODBC Driver DSN Setup** window.
    ...
    ![Schema editor button in the Azure Cosmos DB ODBC Driver DSN Setup window](./media/documentdb-nosql-odbc-driver/documentdb-nosql-odbc-driver-schema-editor.png)
...
To learn more about Azure Cosmos DB, see [What is Azure Cosmos DB?](documentdb-introduction.md).
