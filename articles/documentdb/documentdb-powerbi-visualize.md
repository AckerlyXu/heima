...
- How can I connect to an DocumentDB account in Power BI Desktop?
...
- Access to our demo account or data in your DocumentDB account.
...
## Let's get started
In this tutorial, let's imagine that you are a geologist studying volcanoes around the world.  The volcano data is stored in an DocumentDB account and the JSON documents look like the one below.
...
5. Click on **Azure**, select **DocumentDB (Beta)**, and then click **Connect**.  The **DocumentDB Connect** window should appear.
