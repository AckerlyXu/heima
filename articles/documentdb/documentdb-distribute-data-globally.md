...
description: Learn about planet-scale geo-replication, failover, and data recovery using global databases from DocumentDB, a globally-distributed, mutli-model database service.
services: documentdb
documentationcenter: ''
author: arramac
manager: jhubbard
...
**A tenant's DocumentDB database account spanning 25 Azure regions**

![DocumentDB database account spanning 25 Azure regions](./media/documentdb-distribute-data-globally/documentdb-spanning-regions.png)
...
![Configuring failover priorities with DocumentDB](./media/documentdb-distribute-data-globally/documentdb-failover-priorities.png)
...
An DocumentDB collection gets distributed using two dimensions - within a region and then across regions. Here's how: 
...
![DocumentDB elastically provisioned throughput](./media/documentdb-distribute-data-globally/documentdb-elastic-throughput.png)
