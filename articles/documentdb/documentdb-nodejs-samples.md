<properties
    pageTitle="NoSQL Node.js examples for DocumentDB | Azure"
...
1. You need an Azure account to use these Node.js examples:
   - You can [open an Azure trial account](/pricing/1rmb-trial/): You get credits you can use to try out paid Azure services, and even after they're used up you can keep the account and use free Azure services, such as Websites. Your credit card will never be charged, unless you explicitly change your settings and ask to be charged.

2. You also need the [Node.js SDK](/documentation/articles/documentdb-sdk-node/).
...
For more information about partitioning data in DocumentDB, see [Partition and scale data in DocumentDB](/documentation/articles/documentdb-partition-data/).
