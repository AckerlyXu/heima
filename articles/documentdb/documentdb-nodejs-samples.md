---
title: Node.js examples for DocumentDB | Microsoft Docs
description: Find Node.js examples on github for common tasks in DocumentDB, including CRUD operations.
