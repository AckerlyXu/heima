<properties
    pageTitle="Multi-master database architectures with Azure DocumentDB | Azure"
...
DocumentDB supports turnkey [global replication](/documentation/articles/documentdb-distribute-data-globally/), which allows you to distribute data to multiple regions with low latency access anywhere in the workload. This model is commonly used for publisher/consumer workloads where there is a writer in a single geographic region and globally distributed readers in other (read) regions. 
...
If you would like to learn more about partitioning and partition keys, see [Partitioning and Scaling in Azure DocumentDB](/documentation/articles/documentdb-partition-data/).
...
- Learn about [automatic and manual failovers in Azure DocumentDB](/documentation/articles/documentdb-regional-failovers/)
