...
To use Azure Cosmos DB, you must have a [Azure Cosmos DB account](documentdb-create-account.md), a database, a collection, and documents. In the Azure portal, Azure Cosmos DB databases are now created at the same time as a collection is created. 
