---
title: Build mobile applications with Xamarin and DocumentDB | Microsoft Docs
description: A tutorial that creates a Xamarin iOS, Android, or Forms application by using DocumentDB. DocumentDB is a fast, planet scale, cloud database for mobile apps.
services: documentdb
...
---
# Build mobile applications with Xamarin and DocumentDB
Most mobile apps need to store data in the cloud, and DocumentDB is a cloud database for mobile apps. It has everything a mobile developer needs. It is a fully managed database as a service that scales on demand. It can bring your data to your application transparently, wherever your users are located around the globe. By using the [DocumentDB .NET Core SDK](documentdb-sdk-dotnet-core.md), you can enable Xamarin mobile apps to interact directly with DocumentDB, without a middle tier.
