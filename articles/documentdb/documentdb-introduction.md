<properties
    pageTitle="Introduction to DocumentDB, a JSON database | Azure"
...
- **Compatibility with MongoDB apps:** With DocumentDB: API for MongoDB, you can use DocumentDB databases as the data store for apps written for MongoDB. This means that by using existing drivers for MongoDB databases, your application written for MongoDB can now communicate with DocumentDB and use DocumentDB databases instead of MongoDB databases. In many cases, you can switch from using MongoDB to DocumentDB by simply changing a connection string. Learn more in [What is DocumentDB: API for MongoDB?](/documentation/articles/documentdb-protocol-mongodb/)
...
| n/a | [API for MongoDB](/documentation/articles/documentdb-protocol-mongodb/)

Using the [Azure DocumentDB Emulator](/documentation/articles/documentdb-nosql-local-emulator/), you can develop and test your application locally, without creating an Azure subscription or incurring any costs. When you're satisfied with how your application is working in the DocumentDB Emulator, you can switch to using an Azure DocumentDB account in the cloud.
...
## Next steps
Already have an Azure account? Then you can get started with DocumentDB in the [Azure Portal](https://portal.azure.cn/#gallery/Microsoft.DocumentDB) by [creating a DocumentDB database account](/documentation/articles/documentdb-create-account/).
...
- Download the the [Azure DocumentDB Emulator](/documentation/articles/documentdb-nosql-local-emulator/) to develop your application locally.
