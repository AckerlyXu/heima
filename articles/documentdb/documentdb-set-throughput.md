---
title: Provision throughput for DocumentDB | Microsoft Docs
...
# Set throughput for DocumentDB collections
...
2. On the left bar, click **DocumentDB**, or click **More Services** at the bottom, then scroll to **Databases**, and then click **DocumentDB**.
