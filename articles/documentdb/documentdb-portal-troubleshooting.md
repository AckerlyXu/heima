<properties
    pageTitle="Troubleshooting DocumentDB portal issues | Azure"
...
See [Troubleshoot Query Explorer](/documentation/articles/documentdb-query-collections-query-explorer/#troubleshoot/).

## No data available in monitoring tiles
See [Troubleshoot monitoring tiles](/documentation/articles/documentdb-monitor-accounts/#troubleshooting/).

## No documents returned in Document Explorer
See [Troubleshooting Document Explorer](/documentation/articles/documentdb-view-json-document-explorer/#troubleshoot/).
