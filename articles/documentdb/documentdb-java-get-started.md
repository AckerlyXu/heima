...
- An active Azure account. If you don't have one, you can sign up for a [Trial](https://www.azure.cn/pricing/1rmb-trial/). Alternatively, you can use the [Azure Cosmos DB Emulator](documentdb-nosql-local-emulator.md) for this tutorial.
