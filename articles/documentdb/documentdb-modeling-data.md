<properties
    pageTitle="Modeling data in Azure DocumentDB | Azure"
...
To learn more about Azure DocumentDB, refer to the service's [documentation](/documentation/services/documentdb/) page. 
