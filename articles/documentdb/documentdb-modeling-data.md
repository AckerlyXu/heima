---
title: Modeling data in DocumentDB | Microsoft Docs
description: Learn about modeling data for DocumentDB, a globally distributed, multi-model database.
...
To learn more about DocumentDB, refer to the service's [documentation](index.md) page. 

To learn about tuning indexes in DocumentDB, refer to the article on [indexing policies](documentdb-indexing-policies.md).
...
And finally, for guidance on modeling data and sharding for multi-tenant applications, consult [Scaling a Multi-Tenant Application with DocumentDB](http://blogs.msdn.com/b/documentdb/archive/2014/12/03/scaling-a-multi-tenant-application-with-azure-documentdb.aspx).
