<properties 
    pageTitle="DocumentDB change notifications using Logic Apps | Azure" 
    description="." 
...
The IT department said that they could easily provide this. They also said that they could push the documents to [Azure Blob Storage](/home/features/storage/) so the Cardiology department could easily access them.
...
4. If there are documents found, the response body is sent to your Azure Blob Storage.
    ...
    > [AZURE.NOTE] Blob storage requires an Azure Storage account. You need to provision an Azure Blob storage account and add a new Blob named patients. For more information, see [About Azure storage accounts](/documentation/articles/storage-create-storage-account/) and [Get started with Azure Blob storage](/documentation/articles/storage-dotnet-how-to-use-blobs/).
...
The next action is to save the documents to [Azure Blog storage](/home/features/storage/). 

> [AZURE.NOTE] Blob storage requires an Azure Storage account. You need to provision an Azure Blob storage account and add a new Blob named patients. For more information, see [Get started with Azure Blob storage](/documentation/articles/storage-dotnet-how-to-use-blobs/).
...
This operation uses the [DocumentDB .NET SDK](/documentation/articles/documentdb-sdk-dotnet/) to create a document query. 
