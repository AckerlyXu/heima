---
title: DocumentDB API Python examples for DocumentDB | Microsoft Docs
description: Find Python examples on github for common tasks in DocumentDB, including CRUD operations.
