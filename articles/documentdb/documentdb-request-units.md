...
- [Azure Cosmos DB pricing](https://www.azure.cn/pricing/details/documentdb/)
- [Partitioning data in Azure Cosmos DB](documentdb-partition-data.md)

To learn more about Azure Cosmos DB, see the Azure Cosmos DB [documentation](./index.md). 
