<properties
    pageTitle="DocumentDB scale and performance testing | Azure"
...
If you're looking for client-side configuration options to improve DocumentDB performance, see [DocumentDB performance tips](/documentation/articles/documentdb-performance-tips/).
...
Once you have the app running, you can try different [Indexing policies](/documentation/articles/documentdb-indexing-policies/) and [Consistency levels](/documentation/articles/documentdb-consistency-levels/) to understand their impact on throughput and latency. You can also review the source code and implement similar configurations to your own test suites or production applications.
...
- [Client configuration options to improve DocumentDB performance](/documentation/articles/documentdb-performance-tips/)
