<properties
    pageTitle="DocumentDB Automation - Resource Manager - Azure CLI 1.0 | Azure"
...
## Getting ready
Before you can use Azure CLI 1.0 with Azure resource groups, you need to have the right  version and an Azure account. If you don't have Azure CLI 1.0, [install it](/documentation/articles/cli-install-nodejs/).
...
> [AZURE.NOTE]
> If you don't have an Azure account, you see an error message indicating that you need a different type of account. To create one from your current Azure account, see [Creating a work or school identity in Azure Active Directory](/documentation/articles/virtual-machines-windows-create-aad-work-id?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json/).
>
>
