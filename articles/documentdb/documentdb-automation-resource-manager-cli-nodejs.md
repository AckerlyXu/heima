...
description: Use Azure Resource Manager templates or CLI to deploy a DocumentDB database account. DocumentDB is globally distributed cloud-based database.
services: documentdb
author: mimig1
manager: jhubbard
editor: ''
...
This article shows you how to create an DocumentDB account by using Azure Resource Manager templates or directly with Azure Command-Line Interface (CLI) 1.0. To create a DocumentDB account using the Azure portal, see [Create a DocumentDB database account using the Azure portal](documentdb-create-account.md).

DocumentDB database accounts are currently the only DocumentDB resources that can be created using Resource Manager templates and Azure CLI 1.0.
...
The kind must be set to MongoDB to specify that this account will support MongoDB APIs. If no kind property is specified, the default will be an DocumentDB account.
...
- The [DocumentDB SDKs](https://msdn.microsoft.com/library/azure/dn781482.aspx). DocumentDB have .NET, Java, Python, Node.js, and JavaScript API SDKs.
...
To learn more about DocumentDB, see the [DocumentDB multi-model introduction](./documentdb-resources.md).
