---
title: Manage Network Security Group Flow logs with Azure Network Watcher - PowerShell | Azure
...
```powershell
$NW = Get-AzurermNetworkWatcher -ResourceGroupName NetworkWatcherRg -Name NetworkWatcher_chinaeast
...
<!--Update_Description: new articles on network watcher nsg flow logging with powershell -->