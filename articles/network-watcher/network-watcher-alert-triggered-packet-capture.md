---
title: Use packet capture to do proactive network monitoring with alerts and Azure Functions | Azure
...
* The latest version of [Azure PowerShell](https://docs.microsoft.com/powershell/azure/install-azurerm-ps).
...
1. In the [Azure portal](https://portal.azure.cn), select **New** > **Compute** > **Function App**.
...
2. On the **Function App** blade, enter the following values, and then select **OK** to create the app:
    ...
    |**Location**|China North| The region in which to create the function app.|
...
<!--Update_Description: new articles on network watcher alert triggered packet capture.-->