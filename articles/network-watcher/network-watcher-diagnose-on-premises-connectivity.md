...
1. Site-to-site connection (route based) - [Connection between the VPN Gateway and the on-premises router](/vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal)
