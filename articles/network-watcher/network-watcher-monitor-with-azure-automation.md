...
title: Monitor VPN gateways with Azure Network Watcher troubleshooting | Azure
...
Navigate to Azure Automation in the [Azure portal](https://portal.azure.cn) and click **Runbooks**
