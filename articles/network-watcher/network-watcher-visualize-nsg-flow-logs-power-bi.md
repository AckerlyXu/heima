---
title: Visualizing Azure Network Security Group flow logs with Power BI | Azure
...
* Logs by default are stored in `https://{storageAccountName}.blob.core.chinacloudapi.cn/insights-logs-networksecuritygroupflowevent/`
