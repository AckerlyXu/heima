---
title: Find next hop with Azure Network Watcher Next Hop - Azure CLI 1.0 | Azure
...
<!--Update_Description: new articles on network watcher check next hop CLI nodejs-->