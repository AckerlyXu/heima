---
title: Introduction to security group view in Azure Network Watcher | Azure
...
<!--Update_Description: new articles on network watcher security group view overview -->