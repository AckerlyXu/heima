---
title: Analyze network security with Azure Network Watcher Security Group View - Azure CLI 1.0 | Azure
description: This article will describe how to use Azure CLI 1.0 to analyze a virtual machines security with Security Group View.
...
# Analyze your Virtual Machine security with Security Group View using Azure CLI 1.0
...
<!--Update_Description: new articles on network watcher security group view CLI nodejs  -->