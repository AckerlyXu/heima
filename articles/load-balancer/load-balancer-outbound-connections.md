---
title: Outbound connections in Azure | Azure
...
<a name="ilpip"></a>
### Scenario 1: VM with an Instance Level Public IP address
...
<a name="lb"></a>
### Scenario 2: Load-balanced VM without an Instance Level Public IP address
