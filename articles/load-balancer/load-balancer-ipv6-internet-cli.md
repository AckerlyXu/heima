<properties
    pageTitle="Create an Internet-facing load balancer with IPv6 - Azure CLI | Azure"
...
For more information, see [Azure Resource Manager support for Load Balancer](/documentation/articles/load-balancer-arm/).
...
2. Create a public IP address the front-end IP pool.
    ...
    > In this example, the FQDN is *contoso09152016.chinaeast.chinacloudapp.cn*.
...
To create VMs, you must have a storage account. For load balancing, the VMs need to be members of an availability set. For more information about creating VMs, see [Create an Azure VM using PowerShell](/documentation/articles/virtual-machines-windows-ps-create/)
...
1. Set up the PowerShell variables
        ...
        $osDisk1Uri = "https://$storageAccountName.blob.core.chinacloudapi.cn/vhds/$disk1Name.vhd"
        $osDisk2Uri = "https://$storageAccountName.blob.core.chinacloudapi.cn/vhds/$disk2Name.vhd"
        $imageurn "MicrosoftWindowsServer:WindowsServer:2012-R2-Datacenter:latest"
        $vmUserName = "vmUser"
        $mySecurePassword = "PlainTextPassword*1"

> [AZURE.WARNING]
    > This example uses the username and password for the VMs in clear text. Appropriate care must be taken when using credentials in the clear. For a more secure method of handling credentials in PowerShell, see the [Get-Credential](https://technet.microsoft.com/zh-cn/library/hh849815.aspx) cmdlet.
