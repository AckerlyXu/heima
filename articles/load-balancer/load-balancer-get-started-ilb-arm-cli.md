<properties
    pageTitle="Create an Internal load balancer - Azure CLI | Azure"
...
1. If you have never used Azure CLI, see [Install and configure the Azure CLI](/documentation/articles/cli-install-nodejs/). Follow the instructions up to the point where you select your Azure account and subscription.
...
[Configure a load balancer distribution mode by using source IP affinity](/documentation/articles/load-balancer-distribution-mode/)
