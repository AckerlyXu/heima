<properties
    pageTitle="Create an Azure Internet-facing load balancer - PowerShell | Azure"
...
This article covers the Resource Manager deployment model. You can also [learn how to create an Internet-facing load balancer by using the classic deployment model](/documentation/articles/load-balancer-get-started-internet-classic-cli/).
...
For guidance on creating a virtual machine and assigning a NIC, see [Create an Azure VM using PowerShell](/documentation/articles/virtual-machines-windows-ps-create/).
