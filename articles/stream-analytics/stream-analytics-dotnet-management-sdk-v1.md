...
> [!NOTE]
> Sample code in this article still uses legacy (1.x) version of Azure Stream Analytics Management .NET SDK. For sample code using the up-to-date SDK version, please see [Use the Management .NET SDK for Stream Analytics](/stream-analytics/stream-analytics-dotnet-management-sdk).
...
<!Update_Description: new article which migrate from .Net SDK 1.X source code -->