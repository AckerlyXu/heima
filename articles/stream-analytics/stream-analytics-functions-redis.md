...
<!-- Azure Function Not supported on Azure.cn-->
<!-- Follow [Create your first Azure Function][functions-getstarted] tutorial to get started with Azure Functions. -->
...
<!-- Azure Function Not supported on Azure.cn-->
<!--* [Azure Functions developer reference](/documentation/articles/functions-reference/)-->
<!--* [Azure Functions C# developer reference](/documentation/articles/functions-reference-csharp/)-->
