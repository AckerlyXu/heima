...
* Finish the steps up to "Create a Stream Analytics job" in the tutorial [Build an IoT solution by using Stream Analytics](/stream-analytics/stream-analytics-build-an-iot-solution-using-stream-analytics). 
...
* Follow the [installation instructions](/stream-analytics/stream-analytics-tools-for-visual-studio-install) to install Stream Analytics tools for Visual Studio.
