...
1. When Data Lake Store is selected as an output in the Azure Management portal, you will be prompted to authorize the usage of your existing Data Lake Store or to request access to the Data Lake Store via the Azure Classic Management Portal.
...
If you have not signed up for Data Lake Store, you can follow the "Sign up now" link to initiate the request, or follow the [get started instructions](/documentation/articles/data-lake-store-get-started-portal/).
