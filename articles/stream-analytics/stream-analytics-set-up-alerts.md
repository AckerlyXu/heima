...
## Set up alerts through the Azure Classic Management Portal

There are two ways to set up alerts in the Azure Classic Management Portal:  
...
1. Go to the **Alerts** tab in Management Services in the [Azure Classic Management Portal](https://manage.windowsazure.cn).  
2. Click **Add Rule**  
