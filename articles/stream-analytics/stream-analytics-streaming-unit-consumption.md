...
Event Hub partitions should be partitioned by the grouping key to avoid the need for a reduce step. Additional details are covered [here](/event-hubs/event-hubs-overview). 
#### Temporal join
