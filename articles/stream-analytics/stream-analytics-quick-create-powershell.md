---
title: Create a Stream Analytics job by using Azure PowerShell | Azure
...
Log in to your Azure subscription with the `Login-AzureRmAccount -EnvironmentName AzureChinaCloud` command and enter your Azure credentials in the pop-up browser. After signing in, if you have multiple subscriptions, select the subscription that you would like to use for this quickstart by running the following cmdlets. Make sure to replace <your subscription> with the name of your subscription:  
...
<!-- Update_Description: new articles on stream analytics quick create powershell -->
<!--ms.date: 05/07/2018-->