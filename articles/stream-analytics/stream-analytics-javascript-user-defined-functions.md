---
title: "Tutorial: Azure Stream Analytics JavaScript user-defined functions | Azure "
...
## Get help
For additional help, try our [Azure Stream Analytics forum](https://www.azure.cn/support/contact/).

## Next steps

In this tutorial, you have created a Stream Analytics job that runs a simple JavaScript user-defined function.
