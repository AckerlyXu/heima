...
You can create up to 50 application gateways per subscription, and each application gateway can have up to 10 instances each. Each application gateway can consist of 20 http listeners. 
...
To learn about some of the other key networking capabilities of Azure, see [Azure Networking](/virtual-network/virtual-networks-overview).
