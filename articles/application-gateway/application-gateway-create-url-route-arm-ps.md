...
Add the backend listener named *backendListener* that's needed to route traffic using [Add-AzureRmApplicationGatewayHttpListener](https://docs.microsoft.com/powershell/module/azurerm.network/add-azurermapplicationgatewayhttplistener).
...
The routing rule associates the URL map with the listener that you created. You can add the rule named **rule2* using [Add-AzureRmApplicationGatewayRequestRoutingRule](https://docs.microsoft.com/powershell/module/azurerm.network/add-azurermapplicationgatewayrequestroutingrule).
