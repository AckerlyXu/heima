...
To perform the steps in this article, you need to [install the Azure CLI for macOS, Linux, and Windows](/cli/install-az-cli2).

> [!NOTE]
> You need an Azure account to create an application gateway. If you don't have one, sign up for a [trial](../active-directory/sign-up-organization.md).
...
> [!NOTE]
> You can also use `az login` without the switch for device login that requires entering a code at https://aka.ms/deviceloginchina.

After you enter the preceding command, you'll receive a code. Go to https://aka.ms/deviceloginchina in a browser to continue the sign-in process.
