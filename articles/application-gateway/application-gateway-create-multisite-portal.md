...
4. Click **OK**.
5. Select **Standard_DS1** for the size of the virtual machine, and click **Select**.
...
### Install IIS
1. Run command `Login-AzureRmAccount -EnvironmentName AzureChinaCloud` to create a connection with Azure in powershell.

2. Run the following powershell command to install IIS on the virtual machine: 
