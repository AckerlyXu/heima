---
title: Debug a Java application on local Azure Service Fabric cluster | Azure
...
<!-- Update_Description: new articles on service fabric tutorial debug log local cluster -->
<!--ms.date: 04/09/2018-->