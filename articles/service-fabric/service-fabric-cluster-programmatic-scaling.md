---
title: Azure Service Fabric Programmatic Scaling | Azure
...
To interact with the Service Fabric cluster itself, use [System.Fabric.FabricClient](https://docs.microsoft.com/dotnet/api/system.fabric.fabricclient).
...
The fluent compute library can log in using these credentials as follows (note that core fluent Azure types like `IAzure` are in the [Microsoft.Azure.Management.Fluent](https://www.nuget.org/packages/Microsoft.Azure.Management.Fluent/) package?view=azure-cli-latest):
...
<!-- Update_Description: new articles on service fabric cluster programmatic scaling -->