<properties
    pageTitle="Reliable Services communication overview | Azure"
...
Finally, describe the endpoints that are required for the service in the [service manifest](/documentation/articles/service-fabric-application-model/) under the section on endpoints.
...
> [AZURE.NOTE] For a complete walk-through of how to write an `ICommunicationListener`, see [Service Fabric Web API services with OWIN self-hosting](/documentation/articles/service-fabric-reliable-services-communication-webapi/)
