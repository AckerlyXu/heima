<properties
    pageTitle="Debug your Azure Service Fabric Application in Eclipse| Azure"
...
1. Start a local development cluster by following the steps in [Setting up your Service Fabric development environment](/documentation/articles/service-fabric-get-started-linux/).
...
* [Collect logs using Linux Azure Diagnostics](/documentation/articles/service-fabric-diagnostics-how-to-setup-lad/).
* [Monitor and diagnose services locally](/documentation/articles/service-fabric-diagnostics-how-to-monitor-and-diagnose-services-locally-linux/).
