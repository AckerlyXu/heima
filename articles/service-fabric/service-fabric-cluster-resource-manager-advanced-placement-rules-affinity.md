<properties
    pageTitle="Service Fabric Cluster Resource Manager - Affinity | Azure"
...
- For uses such as limiting services to a small set of machines and trying to aggregate the load of a collection of services, use [Application Groups](/documentation/articles/service-fabric-cluster-resource-manager-application-groups/)
