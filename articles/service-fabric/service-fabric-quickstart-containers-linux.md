...
```bash
sfctl cluster select --endpoint http://lnxt10vkfz6.chinanorth.cloudapp.chinacloudapi.cn:19080
```
...
Open a browser and navigate to Service Fabric Explorer at http://lnxt10vkfz6.chinanorth.cloudapp.chinacloudapi.cn:19080/Explorer. Expand the Applications node and note that there is now an entry for your application type and another for the first instance of that type.

![Service Fabric Explorer][sfx]

Connect to the running container.  Open a web browser pointing to the IP address returned on port 80, for example "lnxt10vkfz6.chinanorth.cloudapp.chinacloudapi.cn:80". You should see the nginx welcome page display in the browser.
...
<!--Update_Description: new articles about service fabric quickstart via using container on linux server-->