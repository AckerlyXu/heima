---
title: Azure Service Fabric Reliable Services lifecycle | Azure
...
Exceptions thrown by Service Fabric are either permanent [(`FabricException`)](https://docs.azure.cn/java/api/system.fabric.exception) or transient [(`FabricTransientException`)](https://docs.azure.cn/java/api/system.fabric.exception._fabric_transient_exception). Permanent exceptions should be logged and thrown. Transient exceptions can be retried based on retry logic.
...
<!--Update_Description: wording update, add content of Stateful service startup and shutdown -->
