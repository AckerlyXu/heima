---
title: Create a Azure Service Fabric reliable actors Java application on Linux | Azure
...
<!--Update_Description: update meta properties, add new feature on using Azure CLI 2.0-->