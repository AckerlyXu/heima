---
title: Create an Azure Service Fabric reliable actors Java application on Linux | Azure
...
<!--Update_Description: update meta properties, add new feature on Service Fabric Java libraries on Maven ->