---
title: Set up your development environment on Mac OS X to work with Azure Service Fabric| Azure
...
<!--Update_Description: update meta properties, add update workflow of creating service fabric on mac -->