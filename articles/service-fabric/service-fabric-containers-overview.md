<properties
    pageTitle="Overview of Service Fabric and containers | Azure"
...
## Introduction
Azure Service Fabric is an [orchestrator](/documentation/articles/service-fabric-cluster-resource-manager-introduction/) of services across a cluster of machines. Services can be developed in many ways from using the [Service Fabric programming models ](/documentation/articles/service-fabric-choose-framework/) to deploying [guest executables](/documentation/articles/service-fabric-deploy-existing-app/). By default Service Fabric deploys and activates these services as processes. Processes provide the fastest activation and highest density usage of the resources in a cluster. Service Fabric can also deploy services in container images. Importantly, you can mix services in processes and services in containers in the same application. You get the best of both worlds, depending on your scenario.
...
For a walkthrough about how to do this, read [Deploy a Docker container to Service Fabric](/documentation/articles/service-fabric-deploy-container-linux/).
...
For a walkthrough about how to do this, read [Deploy a Windows container to Service Fabric](/documentation/articles/service-fabric-deploy-container/).
...
In the Service Fabric [application model](/documentation/articles/service-fabric-application-model/), a container represents an application host in which multiple service replicas are placed. The following scenarios are supported for containers:

* **Guest containers**: This scenario is identical to the [guest executable scenario](/documentation/articles/service-fabric-deploy-existing-app/) where you can deploy existing applications in a container. Examples include Node.js, JavaScript, or any code (executables).
...
[Deploy a Windows container to Service Fabric on Windows Server 2016](/documentation/articles/service-fabric-deploy-container/)

[Deploy a Docker container to Service Fabric on Linux](/documentation/articles/service-fabric-deploy-container/)
