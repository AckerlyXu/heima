<properties
    pageTitle="Create a standalone Azure Service Fabric cluster | Azure"
...
Find details on contents of the package [here](/documentation/articles/service-fabric-cluster-standalone-package-contents/).
...
See Environment Setup section at [Plan and prepare your cluster deployment](/documentation/articles/service-fabric-cluster-standalone-deployment-preparation/) for troubleshooting details.
...
[Plan and prepare your cluster deployment](/documentation/articles/service-fabric-cluster-standalone-deployment-preparation/)
...
To connect to a secure cluster, see [Service fabric connect to secure cluster](/documentation/articles/service-fabric-connect-to-secure-cluster/).
...
You can add or remove nodes to your standalone Service Fabric cluster as your business needs change. See [Add or Remove nodes to a Service Fabric standalone cluster](/documentation/articles/service-fabric-cluster-windows-server-add-remove-nodes/) for detailed steps.
...
> [AZURE.NOTE]
> Starting with the new [GA version of the standalone cluster for Windows Server (version 5.3.204.x)](https://azure.microsoft.com/blog/azure-service-fabric-for-windows-server-now-ga/), you can upgrade your cluster to future releases, manually or automatically. Refer to [Upgrade a standalone Service Fabric cluster version](/documentation/articles/service-fabric-cluster-upgrade-windows-server/) document for details.
> 
> 

## Next steps
- [Deploy and remove applications using PowerShell](/documentation/articles/service-fabric-deploy-remove-applications/)
...
- [Upgrade a standalone Service Fabric cluster version](/documentation/articles/service-fabric-cluster-upgrade-windows-server/)
