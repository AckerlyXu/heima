<properties
    pageTitle="Service communication with the ASP.NET Web API | Azure"
...
For more information on how to create application and service instances, see [Deploy an application](/documentation/articles/service-fabric-deploy-remove-applications/).

## Next steps

[Debug your Service Fabric application by using Visual Studio](/documentation/articles/service-fabric-debugging-your-application/)
