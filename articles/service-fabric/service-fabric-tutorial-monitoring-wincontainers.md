---
title: Monitoring and Diagnostics for Windows Containers in Azure Service Fabric | Azure
...
* Deploy it using PowerShell to upgrade your cluster by [deploying the template](/service-fabric/service-fabric-cluster-creation-via-arm). Azure Resource Manager realizes that the resource exists, so will roll it out as an upgrade.
