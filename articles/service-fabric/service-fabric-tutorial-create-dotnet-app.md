...
Add [AngularJS](http://angularjs.org/) to your service using the built-in [Bower support](https://docs.microsoft.com/aspnet/core/client-side/bower). Open *bower.json* and add entries for angular and angular-bootstrap, then save your changes.
