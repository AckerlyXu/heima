---
title: Upgrade a standalone Azure Service Fabric cluster on Windows Server | Azure
...
For clusters that have connectivity to the [Microsoft Download Center](http://download.microsoft.com), we periodically checks for the availability of new Service Fabric versions.
