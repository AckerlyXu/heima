---
title: Azure Service Bus WCF Relay tutorial | Azure
...
* An active Azure account. If you don't have one, you can create an account in just a couple of minutes. For details, see [Azure Trial](https://www.azure.cn/pricing/1rmb-trial/).
...
3. At the top of the Program.cs file, add references to [System.ServiceModel.Description](https://msdn.microsoft.com/library/system.servicemodel.description.aspx) and [Microsoft.ServiceBus.Description](https://docs.microsoft.com/dotnet/api/microsoft.servicebus.description).
