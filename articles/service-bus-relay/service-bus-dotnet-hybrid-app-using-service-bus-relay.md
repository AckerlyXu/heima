---
title: Azure WCF Relay hybrid on-premises/cloud application (.NET) | Azure
...
[Azure Relay](/service-bus/) is designed for the use-case of taking existing
...
* [How to use Relay](./relay-wcf-dotnet-get-started.md)  
