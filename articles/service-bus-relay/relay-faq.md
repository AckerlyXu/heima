...
This article answers some frequently asked questions (FAQs) about [Azure Relay](/service-bus-messaging/). For general Azure pricing and support information, see [Azure Support FAQs](http://go.microsoft.com/fwlink/?LinkID=185083).
...
### How do you charge for WCF Relay?
...
(**This applies only to WCF relays.**)
