---
title: Server-side JavaScript programming for Azure Cosmos DB | Azure
...
keywords: Database triggers, stored procedure, stored procedure, database program, sproc, azure, 21Vianet Azure
services: cosmos-db
documentationcenter: ''
author: rockboyfor
manager: digimobile
...
This sample shows how to use the [SQL .NET API](https://docs.azure.cn/zh-cn/dotnet/api/overview/cosmosdb?view=azure-dotnet) to create a pre-trigger and create a document with the trigger enabled. 
