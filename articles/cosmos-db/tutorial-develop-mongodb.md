...
This tutorial demonstrates how to create an Azure Cosmos DB account using the Azure portal preview, and how to create a database and collection to store data using the [MongoDB API](../documentdb/documentdb-protocol-mongodb.md). 
...
1. In the Azure portal preview, in the **Azure Cosmos DB** page, select the API for MongoDB account. 
...
2. Modify the following variables in the Dal.cs file per your account settings from the Keys page in the Azure portal preview:
