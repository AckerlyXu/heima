---
title: Consistency levels in Azure Cosmos DB | Azure
...
keywords: eventual consistency, azure cosmos db, azure, 21Vianet Azure
services: cosmos-db
author: rockboyfor
manager: digimobile
documentationcenter: ''
...
<!-- Not Available on https://www.youtube.com/embed/-4FsGysVD14 -->
...
* Bounded staleness provides a stronger consistency guarantee than session, consistent-prefix, or eventual consistency. For multiple-region distributed applications, we recommend you use bounded staleness for scenarios where you would like to have strong consistency but also want 99.99% availability and low latency.   
...
1. In the [Azure portal](https://portal.azure.cn/), in the Jumpbar, click **Azure Cosmos DB**.
