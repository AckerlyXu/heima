...
Azure Cosmos DB is 21Vianet's multiple-region distributed multi-model database service. Using Azure Cosmos DB, you can quickly create and query managed document databases.
...
3. Paste the URI value from the portal over `https://FILLME.documents.azure.cn` on line 45.
