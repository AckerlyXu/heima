---
title: 'Azure Cosmos DB: .NET examples for the DocumentDB API | Azure'
...
For more information about indexing, see [DocumentDB indexing policies](indexing-policies.md).
