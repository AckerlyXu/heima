---
title: Export the Azure Cosmos DB Emulator certificates | Azure
...
Follow the instructions in the [Adding a Certificate to the Java CA Certificates Store](/java-add-certificate-ca-store) to import the X.509 certificate into the default Java certificate store. Keep in mind you will be working in the %JAVA_HOME% directory when running keytool.
