---
title: 'Azure Cosmos DB tutorial: Create, query, and traverse in Apache TinkerPops Gremlin Console | Azure'
...
2. Fill in your *host*, *port*, *username*, *password*, *connectionPool*, and *serializer* configurations:
    ...
    ---|---|---
    Hosts| ***.graphs.azure.cn |Your graph service URI, which you can retrieve from the Azure portal
    Port|443|Set to 443
