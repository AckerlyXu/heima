---
title: 'Quickstart: Table API with Java - Azure Cosmos DB | Azure'
...
5. Comment out line one and uncomment line two. The first two lines should now look like this.
    ...
    StorageConnectionString = DefaultEndpointsProtocol=https;AccountName=[ACCOUNTNAME];AccountKey=[ACCOUNTKEY];TableEndpoint=[TableEndpoint]
    ```
...
<!-- Update_Description: new articles on cassandra creating table with java  -->