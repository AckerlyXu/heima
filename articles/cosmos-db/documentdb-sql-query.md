---
title: SQL queries for Azure Cosmos DB DocumentDB API | Azure
...
| [REPLICATE (str_expr, num_expr)](/cosmos-db/documentdb-sql-query-reference#bk_replicate) |Repeats a string value a specified number of times. |
