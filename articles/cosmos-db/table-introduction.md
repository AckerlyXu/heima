...
| SLAs | 99.9% availability | 99.99% availability within a single region, and ability to add more regions for higher availability. [Industry-leading comprehensive SLAs](https://www.azure.cn/support/sla/documentdb/v1_1/) on general availability |

## How to get started

Create an Azure Cosmos DB account in the [Azure portal preview](https://portal.azure.cn), and get started with our [Quickstart for Table API using .NET](create-table-dotnet.md). 

## Next steps

Here are a few pointers to get you started:
* Get started with [Azure Cosmos DB's Table API](create-table-dotnet.md) using existing NET Table SDK.
* Learn about [Global distribution with Azure Document DB](../documentdb/documentdb-distribute-data-globally.md).
* Learn about [Provisioned throughput in Azure Document DB](../documentdb/documentdb-request-units.md).