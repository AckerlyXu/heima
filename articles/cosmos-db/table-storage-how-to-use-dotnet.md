...
You can also create an Azure storage account by using [Azure PowerShell](../storage/common/storage-powershell-guide-full.md), [Azure CLI](../storage/common/storage-azure-cli.md), or the [Storage Resource Provider Client Library for .NET](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.management.storage?view=azure-dotnet).
...
3. Search online for "Microsoft.Azure.CosmosDB.Table", and select **Install** to install the Azure CosmosDB Table Library.
4. Search online for "WindowsAzure.ConfigurationManager", and select **Install** to install the Azure Configuration Manager Library.
...
* See more Table storage samples in [Getting Started with Azure Table Storage in .NET](https://github.com/Azure-Samples/storage-table-dotnet-getting-started/)
