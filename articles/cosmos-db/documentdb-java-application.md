...
This Java web application tutorial shows you how to use the [Azure Cosmos DB](https://www.azure.cn/home/features/cosmos-db/) service to store and access data from a Java application hosted on Azure Websites. In this topic, you will learn:
