---
title: Performance tips - Azure Cosmos DB NoSQL | Azure
...
1. **Install the most recent SDK**
    ...
    The Cosmos DB SDKs are constantly being improved to provide the best performance. See the [Cosmos DB SDK](sql-api-sdk-dotnet.md) pages to determine the most recent SDK and review improvements.
