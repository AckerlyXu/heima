...
Next, head to the [Azure portal](https://portal.azure.cn) to retrieve your URI and primary key. The Azure Cosmos DB URI and primary key are necessary for your application to understand where to connect to, and for Azure Cosmos DB to trust your application's connection.
...
* To learn more about the programming model, see [Azure Cosmos DB](https://www.azure.cn/home/features/cosmos-db/).
