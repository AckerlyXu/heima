...
For processing specifically based on new changes in Cosmos DB, the built-in change feed surfaces a persistent, ordered log of changes. To find out more see: [Working with change feed](/cosmos-db/change-feed). 
