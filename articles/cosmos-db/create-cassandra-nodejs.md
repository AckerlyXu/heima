---
title: 'Quickstart: Cassandra API with Node.js - Azure Cosmos DB | Azure'
...
3. Paste the CONTACT POINT value from the portal over `<FillMEIN>` on line 4.
    ...
    `config.contactPoint = "cosmos-db-quickstarts.documents.azure.cn:10350"`
...
<!-- Update_Description: new articles on creating cassandra nodejs -->