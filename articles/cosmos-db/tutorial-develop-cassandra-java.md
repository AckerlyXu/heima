---
title: 'Azure Cosmos DB: Develop with the Cassandra API in Java | Azure'
...
3. Paste the CONTACT POINT value from the portal over `<Cassandra endpoint host>` on line 2.
    ...
    `cassandra_host=cosmos-db-quickstarts.documents.azure.cn`
...
<!-- Update_Description: new articles on tutorial development with cassandra and java -->