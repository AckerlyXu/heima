---
title: 'Azure Cosmos DB: SQL API getting started tutorial | Azure'
...
6. Within the results, find **Microsoft.Azure.DocumentDB** and click **Install**.
   The package ID for the Azure Cosmos DB SQL API Client Library is [Azure Cosmos DB Client Library](https://www.nuget.org/packages/Microsoft.Azure.DocumentDB/).
