---
title: Learn Node.js - Azure Cosmos DB Node.js Tutorial | Azure
description: Learn Node.js! Tutorial explores how to use Azure Cosmos DB to store and access data from a Node.js Express web application hosted on Azure Websites.
