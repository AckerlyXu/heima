---
title: 'Azure Cosmos DB: SQL Python API, SDK & resources | Azure'
description: Learn all about the SQL Python API and SDK, and changes made between each version of the Azure Cosmos DB Python SDK.
services: cosmos-db
