<properties
    pageTitle="Manage Azure Blob Storage resources with Storage Explorer (Preview) | Azure"
...
## Overview
[Azure Blob Storage](/documentation/articles/storage-dotnet-how-to-use-blobs/) is a service for storing large amounts of unstructured data, such as text or binary data, that can be accessed from anywhere in the world via HTTP or HTTPS.
...
- [Connect to a Azure storage account or service](/documentation/articles/vs-azure-tools-storage-manage-with-storage-explorer/#connect-to-a-storage-account-or-service/)
...
4. A text box will appear below the **Blob Containers** folder. Enter the name for your blob container. See
   the [Container naming rules](/documentation/articles/storage-dotnet-how-to-use-blobs/#create-a-container/) section for a list of
...
A [shared access signature (SAS)](/documentation/articles/storage-dotnet-shared-access-signature-part-1/) provides delegated access to resources in your storage account.
...
7. Follow these steps depending on the task you wish to perform:
   ...
   - **Upload files to a blob container**
     ...
     3. Specify the type of **Blob type**. The article [Get started with Azure Blob storage using .NET](/documentation/articles/storage-dotnet-how-to-use-blobs/#blob-service-concepts/) explains the differences between the various blob types.
...
- Learn how to [create applications using Azure blobs, tables, queues, and files](/documentation/services/storage/).
