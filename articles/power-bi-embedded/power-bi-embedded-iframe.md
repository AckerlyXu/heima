<properties
    pageTitle="How to use Power BI Embedded with REST | Azure"
...
An overview of Power BI Embedded is described in the official [Power BI Embedded site](/home/features/power-bi-embedded/), but let's take a quick look before we get into the details about using it with REST.
