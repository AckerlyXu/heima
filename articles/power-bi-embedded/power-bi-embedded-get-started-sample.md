...
> [AZURE.NOTE] 
> Before you can configure and run the Power BI Embedded get started sample, you need to create at least one **Workspace Collection** in your Azure subscription. To learn how to create a **Workspace Collection** in the Azure Portal see [Getting Started with Power BI Embedded](/documentation/articles/power-bi-embedded-get-started/).
>
>
...
1. Download and unzip the [Power BI Embedded - Integrate a report into a web app](http://go.microsoft.com/fwlink/?LinkId=761493) sample on GitHub.
	...
	>[AZURE.IMPORTANT] Some URLs in this sample can only be used in global environment. To make it work in Azure China environment, you have to do some replacement.
...
6. Enter your **Workspace Collection** name, and **Access Key**. You can get these in the **Azure Portal**. To learn more about how to get your **Access Key**, see [View Power BI API Access Keys](/documentation/articles/power-bi-embedded-get-started/#view-power-bi-api-access-keys/) in Get started with Power BI Embedded.
...
- [Authenticating and authorizing in Power BI Embedded](/documentation/articles/power-bi-embedded-app-token-flow/)
