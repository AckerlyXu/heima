...
This tutorial loads the WideWorldImportersDW data warehouse from Azure Blob storage to Azure SQL Data Warehouse. The tutorial uses the [Azure portal](https://portal.azure.cn) and [SQL Server Management Studio](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms) (SSMS) to: 
...
3. Fill out the SQL Data Warehouse form with the following information:   
   ...
   | ------- | --------------- | ----------- | 
   | **Database name** | SampleDW | For valid database names, see [Database Identifiers](https://docs.microsoft.com/sql/relational-databases/databases/database-identifiers). | 
...
1. After the deployment completes, click **SQL databases** from the left-hand menu and then click **SampleDW** on the **SQL databases** page. The overview page for your database opens, showing you the fully qualified server name (such as **sample-svr.database.chinacloudapi.cn**) and provides options for further configuration. 
...
2. In the **Connect to Server** dialog box, enter the following information:
    ...
    | Server name | The fully qualified server name | For example, **sample-svr.database.chinacloudapi.cn** is a fully qualified server name. |
...
1. Log in to the [Azure portal](https://portal.azure.cn), click on your data warehouse.
...
4. To remove the SQL server you created, click **sample-svr.database.chinacloudapi.cn** in the previous image, and then click **Delete**.  Be careful with this as deleting the server will delete all databases assigned to the server.
