---
title: Cheat sheet for Azure SQL Data Warehouse | Azure
...
First, load your data into  Azure Blob storage. Next, use PolyBase to load your data into SQL Data Warehouse in a staging table. Use the following configuration:
...
Learn more about [data migration], [data loading], and the [Extract, Load, and Transform (ELT) process](/sql-data-warehouse/design-elt-data-loading). 
