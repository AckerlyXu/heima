<properties
    pageTitle="Azure SQL Data Warehouse backups - snapshots, geo-redundant | Azure"
...
Database backups are an essential part of any business continuity and disaster recovery strategy because they protect your data from accidental corruption or deletion. For more information, see [Business continuity overview](/documentation/articles/sql-database-business-continuity/).
...
* Azure Premium storage, see [Introduction to Azure Premium Storage](/documentation/articles/storage-premium-storage/).
* Locally Redundant storage, see [Azure Storage replication](/documentation/articles/storage-redundancy/#locally-redundant-storage).
...
* Azure blob snapshots, see [Create a blob snapshot](/documentation/articles/storage-blob-snapshots/).

## Geo-redundant backups
Every 24 hours, SQL Data Warehouse stores the full data warehouse in Standard storage. The full data warehouse is created to match the time of the last snapshot. The standard storage belongs to a geo-redundant storage account with read access (RA-GRS). The Azure Storage RA-GRS feature replicates the backup files to a [paired data center](/documentation/articles/best-practices-availability-paired-regions/). This geo-replication ensures you can restore data warehouse in case you cannot access the snapshots in your primary region. 
...
* Geo-redundant storage, see [Azure Storage replication](/documentation/articles/storage-redundancy/).
* RA-GRS storage, see [Read-access geo-redundant storage](/documentation/articles/storage-redundancy/#read-access-geo-redundant-storage).
...
* To restore a SQL data warehouse, see [Restore a SQL data warehouse](/documentation/articles/sql-data-warehouse-restore-database-overview/).
...
* To restore a data warehouse, see [Restore a SQL data warehouse](/documentation/articles/sql-data-warehouse-restore-database-overview/)
