...
To load with T-SQL, run the [CREATE TABLE AS SELECT (CTAS)](https://docs.microsoft.com/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse) T-SQL statement. This command inserts the results of a select statement into a new table. When the statement selects from an external table, it imports the external data. 
...
<!-- Update_Description: new articles on design ELT data loading -->
<!-- ms.date: 01/15/2018 -->