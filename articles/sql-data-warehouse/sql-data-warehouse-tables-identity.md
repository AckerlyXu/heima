...
## System views
You can use the [sys.identity_columns](https://docs.microsoft.com/sql/relational-databases/system-catalog-views/sys-identity-columns-transact-sql) catalog view to identify a column that has the IDENTITY property.
...
- [DBCC CHECK_IDENT()](https://docs.microsoft.com/sql/t-sql/database-console-commands/dbcc-checkident-transact-sql)
