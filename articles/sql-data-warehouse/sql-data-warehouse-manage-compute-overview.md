---
title: Manage compute resource in Azure SQL Data Warehouse | Azure
...
Scaling the data warehouse requires the permissions described in [ALTER DATABASE](https://docs.microsoft.com/sql/t-sql/statements/alter-database-azure-sql-data-warehouse).  Pause and Resume require the [SQL DB Contributor](../active-directory/role-based-access-built-in-roles.md#sql-db-contributor) permission, specifically Microsoft.Sql/servers/databases/action.
