---
title: Partitioning tables in SQL Data Warehouse | Azure
...
- Eliminate the SQL Server [partition scheme](https://docs.microsoft.com/sql/t-sql/statements/create-partition-scheme-transact-sql).
- Add the [partition function](https://docs.microsoft.com/sql/t-sql/statements/create-partition-function-transact-sql) definition to your CREATE TABLE.
...
## Partition switching
SQL Data Warehouse supports partition splitting, merging, and switching. Each of these functions is executed using the [ALTER TABLE](https://docs.microsoft.com/sql/t-sql/statements/alter-table-transact-sql) statement.
