...
Threat Detection provides a new layer of security, which enables customers to detect and respond to potential threats as they occur by providing security alerts on anomalous activities. Users can explore the suspicious events using [Azure SQL Data Warehouse Auditing](/documentation/articles/sql-data-warehouse-auditing-overview/) to determine if they result from an attempt to access, breach or exploit data in the data warehouse.
