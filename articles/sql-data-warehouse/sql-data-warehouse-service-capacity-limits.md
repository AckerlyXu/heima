...
| [Data Warehouse Units (DWU)][Data Warehouse Units (DWU)] |Default DTU per server |54,000<br></br>By default, each SQL server (for example, myserver.database.chinacloudapi.cn) has a DTU Quota of 54,000, which allows up to DW6000c. This quota is simply a safety limit. To calculate your DTU needs, multiply the 7.5 by the total DWU needed, or multiply 9.0 by the total cDWU needed. For example:<br></br>DW6000 x 7.5 = 45,000 DTUs<br></br>DW600c x 9.0 = 54,000 DTUs.<br></br>You can view your current DTU consumption from the SQL server option in the portal. Both paused and unpaused databases count toward the DTU quota. |
