...
## SELECT..INTO vs. CTAS
You can consider CTAS as a super-charged version of the [SELECT...INTO](https://docs.microsoft.com/sql/t-sql/queries/select-into-clause-transact-sql) statement.
...
Please refer to the [CTAS](https://docs.microsoft.com/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse) documentation. It is one of the most important statements in Azure SQL Data Warehouse. Make sure you thoroughly understand it.
