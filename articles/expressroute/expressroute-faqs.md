...
Check [pricing details](/pricing/details/expressroute/) for pricing information.
...
We do not set a limit on the amount of data transfer. Refer to [pricing details](/pricing/details/expressroute/) for information on bandwidth rates.
...
For more details, see [Sharing an ExpressRoute Circuit across multiple subscriptions](/documentation/articles/expressroute-howto-linkvnet-arm/).
...
Yes. You can link a single virtual network with up to 4 ExpressRoute circuits. They must be ordered through 4 different [ExpressRoute locations](/documentation/articles/expressroute-locations/).
...
Refer to [pricing details](/pricing/details/expressroute/) for cost.
...
1. Review the  [ExpressRoute prerequisites page](/documentation/articles/expressroute-prerequisites/) to make sure you meet the requirements.
...
4. Follow the steps listed in the workflows below to setup connectivity [ExpressRoute workflows for circuit provisioning and circuit states](/documentation/articles/expressroute-workflows/).
...
Office 365 services and CRM Online requires premium add-on to be enabled. The [pricing details page](/pricing/details/expressroute/) provides details of costs for ExpressRoute.
