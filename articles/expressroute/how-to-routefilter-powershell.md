---
title: 'Configure route filters for Azure ExpressRoute Microsoft peering: PowerShell'
...
Before you begin configuration, make sure you meet the following criteria:
 ...
 - Install the latest version of the Azure Resource Manager PowerShell cmdlets. For more information, see [Install and configure Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/install-azurerm-ps).
...
```powershell
New-AzureRmRouteFilter -Name "MyRouteFilter" -ResourceGroupName "MyResourceGroup" -Location "China East"
```
