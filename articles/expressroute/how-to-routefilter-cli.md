---
title: 'Configure route filters for Azure ExpressRoute Microsoft peering: CLI '
...
Before beginning, install the latest version of the CLI commands (2.0 or later). For information about installing the CLI commands, see [Install Azure CLI 2.0](/cli/install-azure-cli) and [Get Started with Azure CLI 2.0](/cli/get-started-with-azure-cli).
