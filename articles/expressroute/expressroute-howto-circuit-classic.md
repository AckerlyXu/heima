<properties
   pageTitle="Create and modify an ExpressRoute circuit : PowerShell: Azure classic | Azure"
...
Make sure that you have reviewed the [prerequisites](/documentation/articles/expressroute-prerequisites/) and [workflows](/documentation/articles/expressroute-workflows) before you begin configuration.  

### Step 2. Install the latest versions of the Azure PowerShell modules

Follow the instructions in [How to install and configure Azure PowerShell](/documentation/articles/powershell-install-configure/) for step-by-step guidance on how to configure your computer to use the Azure PowerShell modules.
...
*ServiceProviderProvisioningState* provides information on the current state of provisioning on the service-provider side. *Status* provides the state on the Microsoft side. For more information about circuit provisioning states, see the [Workflows](/documentation/articles/expressroute-workflows/#expressroute-circuit-provisioning-states) article.
...
Refer to the [ExpressRoute circuit routing configuration (create and modify circuit peerings)](/documentation/articles/expressroute-howto-routing-classic/) article for step-by-step instructions.
...
Next, link a virtual network to your ExpressRoute circuit. Refer to [Linking ExpressRoute circuits to virtual networks](/documentation/articles/expressroute-howto-linkvnet-classic/) for step-by-step instructions. If you need to create a virtual network by using the classic deployment model for ExpressRoute, see [Create a virtual network for ExpressRoute](/documentation/articles/expressroute-howto-vnet-portal-classic/) for instructions.
...
Refer to the [ExpressRoute FAQ](/documentation/articles/expressroute-faqs/) for more information on limits and limitations.
...
Check the [ExpressRoute FAQ](/documentation/articles/expressroute-faqs/) for supported bandwidth options for your provider. You can pick any size that is greater than the size of your existing circuit as long as the physical port (on which your circuit is created) allows.
...
- [Create and modify routing for your ExpressRoute circuit](/documentation/articles/expressroute-howto-routing-classic/)
- [Link your virtual network to your ExpressRoute circuit](/documentation/articles/expressroute-howto-linkvnet-classic/)
