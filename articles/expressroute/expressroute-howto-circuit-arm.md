...
The following example shows how to create a 200-Mbps ExpressRoute circuit through Beijing Telecom Ethernet in Beijing. If you're using a different provider and different settings, substitute that information when you make your request. Use the following example to request a new service key:
