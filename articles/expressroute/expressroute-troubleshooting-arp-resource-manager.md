<properties 
   pageTitle="Getting ARP tables: Resource Manager: Azure ExpressRoute Troubleshooting | Azure"
...
Ensure that you have the following before you progress further
 ...
 - IP address ranges used for configuring the peerings (Azure private and Azure public). Review the ip address assignment examples in the [ExpressRoute routing requirements page](/documentation/articles/expressroute-routing/) to get an understanding of how ip addresses are mapped to interfaces on your side and on the ExpressRoute side. You can get information on the peering configuration by reviewing the [ExpressRoute peering configuration page](/documentation/articles/expressroute-howto-routing-arm/).
