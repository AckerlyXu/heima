<properties
   pageTitle="Workflows for configuring an ExpressRoute circuit | Azure"
...
5. Linking virtual networks to ExpressRoute circuits - You can link virtual networks to your ExpressRoute circuit. Follow instructions [to link VNets](/documentation/articles/expressroute-howto-linkvnet-arm/) to your circuit. These VNets can either be in the same Azure subscription as the ExpressRoute circuit, or can be in a different subscription.
