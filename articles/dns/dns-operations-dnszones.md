---
title: Manage DNS zones in Azure DNS - PowerShell | Azure
...
<br>
Review the [Azure DNS PowerShell reference documentation](https://docs.microsoft.com/powershell/module/azurerm.dns).
