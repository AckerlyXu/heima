...
- An active Azure account  
    If you don't have an account, you can create a trial account in just a couple of minutes. For more information, see [Azure 1rmb-trial](https://www.azure.cn/pricing/1rmb-trial/).
...
## Send notifications
You can quickly test receiving notifications in your app by sending notifications in the [Azure portal](https://portal.azure.cn/). Use the **Test Send** button on the notification hub, as shown in the following image:
