...
3. Copy the following code into the new **Notifications** class:
    ...
    This class uses the isolated storage to store the categories of news that this device is to receive. It also contains methods to register for these categories using a [template](/documentation/articles/notification-hubs-templates-cross-platform-push-messages/) notification registration.
...
<!-- URLs.-->
[Get started with Notification Hubs]: /documentation/articles/notification-hubs-windows-mobile-push-notifications-mpns/
