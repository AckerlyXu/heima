...
* Follow the [Get started tutorial](/documentation/articles/notification-hubs-ios-apple-push-notification-apns-get-started/) for your mobile platform of choice, implementing the back-end portion in PHP.
