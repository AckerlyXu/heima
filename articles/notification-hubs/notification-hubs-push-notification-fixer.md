...
- **Push notification service developer portal**
    ...
    Verify credentials in the respective push notification service developer portal (APNs, Windows Notification Service, and so on). For more information, see [Get started with Azure Notification Hubs].
