...
You can follow the [Get started tutorial](/documentation/articles/notification-hubs-windows-store-dotnet-get-started-wns-push-notification/) for your mobile platform of choice, implementing the back-end portion in Python.
...
[Get started tutorial]: /documentation/articles/notification-hubs-windows-store-dotnet-get-started-wns-push-notification/
[Breaking News tutorial]: /documentation/articles/notification-hubs-windows-notification-dotnet-push-xplat-segmented-wns/
[Localizing News tutorial]: /documentation/articles/notification-hubs-windows-store-dotnet-xplat-localized-wns-push-notification/
