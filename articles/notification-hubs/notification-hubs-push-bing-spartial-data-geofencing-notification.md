<properties
	pageTitle="Geo-fenced push notifications with Azure Notification Hubs and Bing Spatial Data | Azure"
...
# Geo-fenced push notifications with Azure Notification Hubs and Bing Spatial Data
 ...
 > [AZURE.NOTE] To complete this tutorial, you must have an active Azure account. If you don't have an account, you can create a free trial account in just a couple of minutes. For details, see [Azure Free Trial](/pricing/free-trial/?WT.mc_id=A0E0E5C02).
...
Second, as you are working to ensure that the delivery is done to the right participants, you might want to target them via [tagging](/documentation/articles/notification-hubs-tags-segment-push-message/).
...
For more details regarding Notification Hubs capabilities, check out our [documentation portal](/documentation/services/notification-hubs/).
