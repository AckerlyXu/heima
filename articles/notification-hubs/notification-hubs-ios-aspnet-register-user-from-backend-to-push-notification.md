<properties
	pageTitle="Register the current user for push notifications by using Web API | Azure"
...
<!-- URLs. -->
[Notify users with Notification Hubs]: /documentation/articles/notification-hubs-aspnet-backend-windows-dotnet-wns-notification/

[Get Started with Notification Hubs]: /documentation/articles/notification-hubs-ios-apple-push-notification-apns-get-started/
