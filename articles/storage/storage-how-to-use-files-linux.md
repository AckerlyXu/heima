<properties
    pageTitle="How to use Azure Files with Linux | Azure"
...
- [Create and manage file shares](/documentation/articles/storage-azure-cli/#create-and-manage-file-shares) using the Azure CLI

### Reference
- [File Service REST API reference](http://msdn.microsoft.com/zh-cn/library/azure/dn167006.aspx)
* [Azure Files Troubleshooting Article](/documentation/articles/storage-troubleshoot-file-connection-problems/)

### Blog posts
* [Azure File storage is now generally available](https://azure.microsoft.com/blog/azure-file-storage-now-generally-available/)
* [Inside Azure File Storage](/home/features/storage) 
