<properties
    pageTitle="Get started with Azure table storage and Visual Studio Connected Services (ASP.NET) | Azure"
...
1. Run the application, and select **Add entity** to see results similar to the following screen shot:
	...
	You can verify that the entity was added by following the steps in the section, [Get a single entity](#get-a-single-entity). You can also use the [Azure Storage Explorer](/documentation/articles/vs-azure-tools-storage-manage-with-storage-explorer/) to view all the entities for your tables.
