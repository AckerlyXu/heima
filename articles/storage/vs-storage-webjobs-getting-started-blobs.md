<properties
    pageTitle="Get started with blob storage and Visual Studio connected services (WebJob projects) | Azure"
...
This article has provided code samples that show how to handle common scenarios for working with Azure blobs. For more information about how to use Azure WebJobs and the WebJobs SDK, see [Azure WebJobs documentation resources](/documentation/articles/websites-webjobs-resources/).
