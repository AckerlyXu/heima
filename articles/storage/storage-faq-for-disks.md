...
A standard managed disk created from an 80 GB VHD will be treated as the next available standard disk size, which is an S10 disk. You will be charged as per the S10 disk pricing. Please check the [pricing page](https://www.azure.cn/pricing/details/storage) for details.

**Are there any transaction costs for standard managed disks?**

Yes, you are charged for each transaction. Please check the [pricing page] (https://www.azure.cn/pricing/details/storage) for details.
...
Yes. You can change the storage account type of your managed disks using the Azure portal preview, PowerShell, or the Azure CLI.

**Is there a way I can copy or export a managed disk to a private storage account?**

Yes, you can export your managed disks using the Azure portal preview, PowerShell, or the Azure CLI.
...
**Is Managed Disks the default option in the Azure portal preview?**
