<properties
    pageTitle="Get started with table storage and Visual Studio connected services (cloud services) | Azure"
...
- See [Get started with Azure Table storage using .NET](/documentation/articles/storage-dotnet-how-to-use-tables/) for more information on programmatically manipulating tables.
