---
title: Troubleshoot Azure File storage problems in Windows | Azure
...
-	Use the right copy method:
    -	Use [AzCopy](../common/storage-use-azcopy.md?toc=%2fstorage%2ffiles%2ftoc.json#file-copy) for any transfer between two file shares.
