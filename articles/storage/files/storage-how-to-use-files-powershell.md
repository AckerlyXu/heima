---
title: How to use PowerShell to manage Azure File storage | Azure
...
Create the storage account context. The context encapsulates the storage account name and account key. For instructions on copying your account key from the [Azure portal](https://portal.azure.cn), see [View and copy storage access keys](../common/storage-create-storage-account.md?toc=%2fstorage%2ffiles%2ftoc.json#view-and-copy-storage-access-keys).
