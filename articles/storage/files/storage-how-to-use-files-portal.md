...
The [Azure portal](https://portal.azure.cn) provides a user interface for managing Azure Files. You can perform the following actions from your web browser:
