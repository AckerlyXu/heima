...
1. **To prepare to use a Command Line Interface (CLI), download and install the Azure CLI.**  
    See [Install Azure CLI 2.0](https://docs.azure.cn/cli/install-az-cli2) and [Get started with Azure CLI 2.0](https://docs.azure.cn/cli/get-started-with-azure-cli).
