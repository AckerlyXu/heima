<properties
    pageTitle="Get started with Azure Queue storage using .NET | Azure"
...
- View more feature guides to learn about additional options for storing data in Azure.
    - [Get started with Azure Table storage using .NET](/documentation/articles/storage-dotnet-how-to-use-tables/) to store structured data.
    - [Get started with Azure Blob storage using .NET](/documentation/articles/storage-dotnet-how-to-use-blobs/) to store unstructured data.
    - [Connect to SQL Database by using .NET (C#)](/documentation/articles/sql-database-develop-dotnet-simple/) to store relational data.
