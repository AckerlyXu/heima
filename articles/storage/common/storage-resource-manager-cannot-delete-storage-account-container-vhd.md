...
2. Check the **Disk URL** to identify the storage account and the VHD that prevents you delete the storage account. In the following example, the string before ".blob.core.chinacloudapi.cn " is the storage account name, and "SCCM2012-2015-08-28.vhd" is the VHD name.  
