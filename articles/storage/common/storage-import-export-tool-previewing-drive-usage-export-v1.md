---
title: Previewing drive usage for an Azure Import/Export export job - v1 | Azure
...
Before you create an export job, you need to choose a set of blobs to be exported. The Azure Import/Export service allows you to use a list of blob paths or blob prefixes to represent the blobs you've selected.  
