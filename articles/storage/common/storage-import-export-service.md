...
You can create an import or export job using the Azure portal or the [Azure Storage Import/Export REST API](https://docs.microsoft.com/rest/api/storageimportexport).
...
You can use carriers like FedEx or the China Postal Service to ship your drives to the shipping address.
...
> [!IMPORTANT] 
> Before shipping the physical media, check with your advisers to verify that your media and data can legally be shipped to the identified data center. This will help to ensure that it reaches Microsoft in a timely manner. 
...
There are no transaction costs when importing data into Azure Storage. The standard egress charges are applicable when data is exported from blob storage. For more details on transaction costs, see [Data transfer pricing.](https://www.azure.cn/pricing/details/data-transfer/)
