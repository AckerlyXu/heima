---
title: Azure Storage Explorer troubleshooting guide | Azure
...
Azure Storage Explorer (Preview) is a stand-alone app that enables you to easily work with Azure Storage data on Windows, macOS, and Linux. The app can connect to Storage accounts hosted on Azure, National Clouds, and Azure Stack.
...
- Verify that you can connect to the Azure portal using your web browser
