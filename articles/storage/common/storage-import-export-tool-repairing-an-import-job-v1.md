---
title: Repairing an Azure Import/Export import job - v1 | Azure
...
You can run the Azure Import/Export Tool with the import job's copy log files, and the tool uploads the missing files (or parts of a file) to your Azure storage account to complete the import job.  
