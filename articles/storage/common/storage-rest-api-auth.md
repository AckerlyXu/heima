...
* A general-purpose storage account. If you don't have any storage accounts, you can create one using the [Azure portal](https://portal.azure.cn), [PowerShell](../blobs/storage-quickstart-create-storage-account-powershell.md), or [Azure CLI](../blobs/storage-quickstart-create-storage-account-cli.md).
