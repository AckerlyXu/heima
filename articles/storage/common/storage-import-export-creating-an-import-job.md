...
description: Learn how to create an import for the Azure Import/Export service.
author: hayley244
manager: syadav
editor: syadav
services: storage
...
-   Shipping the drives to 21 Vanet via a supported carrier service.
...
## Creating the import job
To create the import job, call the [Put Job](https://docs.microsoft.com/rest/api/storageimportexport/jobs#Jobs_CreateOrUpdate) operation. You will need to provide the following information:
