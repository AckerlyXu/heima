...
To view settings for Storage Service Encryption, sign in to the [Azure portal](https://portal.azure.cn) and select a storage account. In the **SETTINGS** pane, select the **Encryption** setting.
...
A: Yes, all copies of the storage account are encrypted. All redundancy options are supported--locally redundant storage,  geo-redundant storage, and read-access geo-redundant storage.
