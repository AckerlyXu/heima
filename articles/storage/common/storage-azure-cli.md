...
### Accounts
* **Azure account**: If you don't already have an Azure subscription, [create a trial Azure account](https://www.azure.cn/pricing/1rmb-trial/).
...
* **Log in with a service principal**: `az login --service-principal -u http://azure-cli-2016-08-05-14-31-15 -p VerySecret --tenant contoso.partner.onmschina.cn`
...
* `--location` [Required]: Location. For example, "China East".
...
List the blobs in a container with the [az storage blob list](https://docs.azure.cn/cli/storage/blob#az_storage_blob_list) command.
