<properties
    pageTitle="Azure Premium and Standard Managed Disks Overview | Azure"
...
Azure Managed Disks simplifies disk management for Azure IaaS VMs by managing the [storage accounts](/documentation/articles/storage-introduction/) associated with the VM disks. You only have to specify the type ([Premium](/documentation/articles/storage-premium-storage/) or [Standard](/documentation/articles/storage-standard-storage/)) and the size of disk you need, and Azure creates and manages the disk for you.
...
Managed Disks will allow you to create up to 10,000 VM **disks** in a subscription, which will enable you to create thousands of **VMs** in a single subscription. This feature also further increases the scalability of [Virtual Machine Scale Sets (VMSS)](/documentation/articles/virtual-machine-scale-sets-overview/) by allowing you to create up to a thousand VMs in a VMSS using a Marketplace image.
...
[Premium](/documentation/articles/storage-premium-storage/) (SSD-based) and [Standard](/documentation/articles/storage-standard-storage/) (HDD-based). The billing of a managed disk depends on which type of storage you have selected for the disk.
...
[Incremental snapshots](/documentation/articles/storage-incremental-snapshots/) are currently not supported for Managed Disks, but will be supported in the future.

To learn more about how to create snapshots with Managed Disks, please check out these resources:

* [Create copy of VHD stored as a Managed Disk using Snapshots in Windows](/documentation/articles/virtual-machines-windows-snapshot-copy-managed-disk/)
* [Create copy of VHD stored as a Managed Disk using Snapshots in Linux](/documentation/articles/virtual-machines-linux-snapshot-copy-managed-disk/)


For detailed information on pricing for Managed Disks, see [Managed Disks Pricing](/pricing/details/managed-disks/).
...
* [How to capture a managed image of a generalized VM in Azure](/documentation/articles/virtual-machines-windows-capture-image-resource/)
* [How to generalize and capture a Linux virtual machine using the Azure CLI 2.0 (Preview)](/documentation/articles/virtual-machines-linux-capture-image/)
...
* [Create a Linux VM using the Azure CLI 2.0 (Preview)](/documentation/articles/virtual-machines-linux-quick-create-cli/)

* [Attach a managed data disk to a Windows VM using PowerShell](/documentation/articles/virtual-machines-windows-attach-disk-ps/)

* [Add a managed disk to a Linux VM](/documentation/articles/virtual-machines-linux-quick-create-cli/)

### Compare Managed Disks storage options 

* [Premium storage and disks](/documentation/articles/storage-premium-storage/)

* [Standard storage and disks](/documentation/articles/storage-standard-storage/)

### Operational guidance

* [Migrate from AWS and other platforms to Managed Disks in Azure](/documentation/articles/virtual-machines-windows-on-prem-to-azure/)

* [Convert Azure VMs to managed disks in Azure](/documentation/articles/virtual-machines-windows-migrate-to-managed-disks/)
