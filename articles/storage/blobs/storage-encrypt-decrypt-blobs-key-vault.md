...
For overview information about client-side encryption for Azure Storage, see [Client-Side Encryption and Azure Key Vault for Azure Storage](../common/storage-client-side-encryption.md?toc=%2fstorage%2fblobs%2ftoc.json).
...
For an overview of client-side encryption for Azure Storage, see [Client-Side Encryption and Azure Key Vault for Azure Storage](../common/storage-client-side-encryption.md?toc=%2fstorage%2fblobs%2ftoc.json)
...
Following is a screenshot from the [Azure Classic Management Portal](https://manage.windowsazure.cn) for a blob that has been encrypted by using client-side encryption with a key stored in Key Vault. The **KeyId** property is the URI for the key in Key Vault that acts as the KEK. The **EncryptedKey** property contains the encrypted version of the CEK.
...
## Next steps
For more information about using Azure Storage with C#, see [Azure Storage Client Library for .NET](https://msdn.microsoft.com/library/azure/dn261237.aspx).
...
For the latest information on Azure Storage, go to the [Azure Storage Team Blog](http://blogs.msdn.com/b/windowsazurestorage/).
