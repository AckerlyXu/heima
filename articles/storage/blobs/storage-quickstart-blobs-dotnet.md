...
In this quickstart, the .NET client library for Azure Storage upload, download, and list block blobs in a container .
...
<configuration>
  ...
  <appSettings>
    ...
    AccountKey=<KeyHere>;EndpointSuffix=core.chinacloudapi.cn" />
  </appSettings>
</configuration>
```
