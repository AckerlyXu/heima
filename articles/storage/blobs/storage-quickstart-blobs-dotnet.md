...
To complete this quickstart, first create an Azure storage account in the [Azure portal](https://portal.azure.cn/#create/Microsoft.StorageAccount-ARM). For help creating the account, see [Create a storage account](../common/storage-quickstart-create-account.md).
...
- See the [.NET API reference](/dotnet/api/overview/storage) for more information about the .NET client library.
