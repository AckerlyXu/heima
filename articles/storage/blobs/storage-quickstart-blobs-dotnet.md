...
1. Go to the [Azure portal](https://portal.azure.cn) and log in using your Azure account. 
...
<configuration>
  ...
  <appSettings>
    ...
    AccountKey=7NGE5jasdfdRzASDFNOMEx1u20W/thisisjustC/anexampleZK/Rt5pz2xNRrDckyv8EjB9P1WGF==;EndpointSuffix=core.chinacloudapi.cn" />
  </appSettings>
</configuration>
```
...
https://mystorage.blob.core.chinacloudapi.cn/quickstartblobs/QuickStart_cbd5f95c-6ab8-4cbf-b8d2-a58e85d7a8e8.txt
