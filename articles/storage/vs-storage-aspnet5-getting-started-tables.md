<properties
    pageTitle="How to get started with table storage and Visual Studio connected services (ASP.NET 5) | Azure"
...
For more general information about using Azure Table storage, see [Get started with Azure Table storage using .NET](/documentation/articles/storage-dotnet-how-to-use-tables/).
