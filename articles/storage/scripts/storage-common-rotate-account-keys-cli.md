...
| [az storage account keys list](https://docs.azure.cn/cli/storage/account/keys#az_storage_account_keys_list) | Displays the storage account access keys for the specified account. |
| [az storage account keys renew](https://docs.azure.cn/cli/storage/account/keys#az_storage_account_keys_renew) | Regenerates the primary or secondary storage account access key. |
