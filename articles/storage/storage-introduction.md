...
For very large datasets where network constraints make uploading or downloading data to Blob storage over the wire unrealistic, you can ship a hard drive to 21Vianet to import or export data directly from the data center. See [Use the Azure Import/Export Service to Transfer Data to Blob Storage](./storage-import-export-service.md). 
