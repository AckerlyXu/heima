...
##<a name="scalability-targets-for-premium-storage-accounts"></a><a name="scalability-targets-for-standard-storage-accounts"></a><a name="scalability-targets-for-blobs-queues-tables-and-files"></a> Scalability targets for blobs, queues, tables, and files
