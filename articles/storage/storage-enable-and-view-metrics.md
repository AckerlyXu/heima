<properties
    pageTitle="Enabling storage metrics in the Azure portal | Azure"
...
Please see [Azure Storage Explorers](/documentation/articles/storage-explorers/) for a list of available tools.
