...
This article lists common problems that are related to Azure File storage when you connect from Linux clients. It also provides possible causes and resolutions for these problems.
...
Reduce the number of concurrent open handles by closing some handles, and then retry the operation. For more information, see [Azure Storage performance and scalability checklist](storage-performance-checklist.md).
