<properties
    pageTitle="Azure Storage Table Design Guide | Azure"
...
For information about encrypting table data, see [Client-Side Encryption and Azure Key Vault for Azure Storage](/documentation/articles/storage-client-side-encryption/).  
...
For more information about using SAS tokens with the Table service, see [Using Shared Access Signatures (SAS)](/documentation/articles/storage-dotnet-shared-access-signature-part-1/).  
