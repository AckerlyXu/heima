<properties
    pageTitle="Using Azure PowerShell with Azure Storage | Azure"
...
**New to Azure:** Get a Azure subscription and a Microsoft account associated with that subscription. For information on Azure purchase options, see [Free Trial](/pricing/1rmb-trial/).
...
- Generate a shared access signature token for an Azure storage container and use it to create a storage context:
	...
	For more information, see [New-AzureStorageContainerSASToken](http://msdn.microsoft.com/zh-cn/library/azure/dn806416.aspx) and [Using Shared Access Signatures (SAS)](/documentation/articles/storage-dotnet-shared-access-signature-part-1/).
...
For more information on Azure File storage, see [Get started with Azure File storage on Windows](/documentation/articles/storage-dotnet-how-to-use-files/) and [File Service REST API](http://msdn.microsoft.com/zh-cn/library/azure/dn167006.aspx).
...
For detailed information on using Storage Metrics and Storage Logging to troubleshoot storage issues, see [Monitoring, Diagnosing, and Troubleshooting Azure Storage](/documentation/articles/storage-monitoring-diagnosing-troubleshooting/).
...
For more information, see [Shared Access Signatures: Understanding the SAS Model](/documentation/articles/storage-dotnet-shared-access-signature-part-1/) and [Manage anonymous read access to containers and blobs](/documentation/articles/storage-manage-access-to-resources/).
