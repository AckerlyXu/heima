---
title: Introduction to Azure Queue storage | Azure
...
* **Storage account:** All access to Azure Storage is done through a storage account. See [Azure Storage Scalability and Performance Targets](../common/storage-scalability-targets.md?toc=%2fstorage%2fqueues%2ftoc.json) for details about storage account capacity.
