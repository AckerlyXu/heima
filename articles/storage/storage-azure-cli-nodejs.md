<properties
    pageTitle="Using the Azure CLI 1.0 with Azure Storage | Azure"
...
> [AZURE.NOTE]
> The guide provides the Azure CLI command and script examples for classic storage accounts. See [Using the Azure CLI for Mac, Linux, and Windows with Azure Resource Management](/documentation/articles/azure-cli-arm-commands/#azure-storage-commands-to-manage-your-storage-objects) for Azure CLI commands for Resource Manager storage accounts.
>
>
...
**New to Azure:** Get an Azure subscription and a Microsoft account associated with that subscription. For information on Azure purchase options, see [1rmb Trial](/pricing/1rmb-trial/), [Purchase Options](/pricing/purchase-options/).
...
* [Azure CLI commands in Resource Manager mode](/documentation/articles/azure-cli-arm-commands/#azure-storage-commands-to-manage-your-storage-objects)
* [Azure CLI commands in Azure Service Management mode](/documentation/articles/xplat-cli-install/)

You may also like to try the [Azure CLI 2.0 (Preview)](/documentation/articles/storage-azure-cli/), our next-generation CLI written in Python, for use with the resource management deployment model.
