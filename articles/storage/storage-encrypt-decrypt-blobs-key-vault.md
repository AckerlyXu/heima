<properties
    pageTitle="Tutorial: Encrypt and decrypt blobs in Azure Storage using Azure Key Vault | Azure"
...
For overview information about client-side encryption for Azure Storage, see [Client-Side Encryption and Azure Key Vault for Azure Storage](/documentation/articles/storage-client-side-encryption/)
...
For an overview of client-side encryption for Azure Storage, see [Client-Side Encryption and Azure Key Vault for Azure Storage](/documentation/articles/storage-client-side-encryption/)
