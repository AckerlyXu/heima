<properties
    pageTitle="Get started with Azure Storage in five minutes | Azure"
...
4. You'll need an Azure subscription and an Azure storage account.
    ...
    - To get an Azure subscription, see [1rmb Trial](/pricing/1rmb-trial/), [Purchase Options](/pricing/purchase-options/).
    - To create a storage account in Azure, see [How to create a storage account](/documentation/articles/storage-create-storage-account/#create-a-storage-account).
...
* [Introduction to Microsoft Azure Storage](/documentation/articles/storage-introduction/)
* [Get started with Azure Storage Explorer](/documentation/articles/vs-azure-tools-storage-manage-with-storage-explorer/)
