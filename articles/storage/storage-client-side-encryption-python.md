<properties
    pageTitle="Client-Side Encryption with Python for Azure Storage | Azure"
...
The storage client library expects the provided KEK and key resolver to implement the following interface. [Azure Key Vault](/home/features/key-vault/) support for Python KEK management is pending and will be integrated into this library when completed.
