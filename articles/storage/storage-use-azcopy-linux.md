...
Note that AzCopy currently only supports the [Account SAS](storage-dotnet-shared-access-signature-part-1.md).
...
* [Manage blobs with Storage Explorer](https://docs.azure.cn/zh-cn/vs-azure-tools-storage-explorer-blobs)
