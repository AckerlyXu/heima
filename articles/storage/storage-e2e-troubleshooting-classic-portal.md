...
- **Azure Management Portal**. You can configure metrics and logging for your storage account in the [Azure Management Portal](https://manage.windowsazure.cn). You can also view charts and graphs that show how your application is performing over time, and configure alerts to notify you if your application performs differently than expected for a specified metric. 
	...
	See [Monitor a storage account in the Azure Portal](/documentation/articles/storage-monitor-storage-account/) for information about configuring monitoring in the Azure Management Portal.
...
To configure logging and metrics for your storage account using the portal, follow the instructions at [Monitor a storage account in the Azure Portal](/documentation/articles/storage-monitor-storage-account/).
