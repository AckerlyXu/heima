...
- Azure PowerShell 0.7.4 or later. See [How to install and configure Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview).
...
You can generate the publish scripts for a virtual machine that hosts your website when you create a new project by following [these instructions](virtual-machines/windows/classic/web-app-visual-studio.md?toc=%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json). You can also [generate publish scripts for web apps in Azure App Service](app-service/app-service-web-get-started-dotnet.md).
...
The Windows PowerShell module that Visual Studio generates contains functions that the publish script uses. These Azure PowerShell functions are not intended to be modified. See [How to install and configure Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview).
...
## Next steps
Learn more about PowerShell scripting by reading [Scripting with Windows PowerShell](https://technet.microsoft.com/library/bb978526.aspx) and see other Azure PowerShell scripts at the [Script Center](/automation/automation-runbook-gallery/).
