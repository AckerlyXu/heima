...
1. Right-click the web application project and select **Convert > Convert to Azure Cloud Service Project**. (That this command does not appear if you already have a web role project in the solution.)
