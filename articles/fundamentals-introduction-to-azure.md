...
## Azure portal
Azure has a web interface called the [Azure portal](http://portal.azure.cn) that allows administrators to access and administer Azure features and services.  
