...
namespace cn.itcast.bookshop.DAL
{
    ...
    public partial class Articel_Words
    {
        ...
        public cn.itcast.bookshop.Model.Articel_Words GetModel(int Id)
        {
            ...
            cn.itcast.bookshop.Model.Articel_Words model = new cn.itcast.bookshop.Model.Articel_Words();
        ...
        /// 得到一个对象实体
        /// </summary>
        public cn.itcast.bookshop.Model.Articel_Words DataRowToModel(DataRow row)
        {
            cn.itcast.bookshop.Model.Articel_Words model = new cn.itcast.bookshop.Model.Articel_Words();
            if (row != null)
            {
