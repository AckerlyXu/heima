...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public cn.itcast.bookshop.Model.Categories GetModel(int Id)
		{
			...
			cn.itcast.bookshop.Model.Categories model=new cn.itcast.bookshop.Model.Categories();
		...
		/// 得到一个对象实体
		/// </summary>
		public cn.itcast.bookshop.Model.Categories DataRowToModel(DataRow row)
		{
			cn.itcast.bookshop.Model.Categories model=new cn.itcast.bookshop.Model.Categories();
			if (row != null)
			{
