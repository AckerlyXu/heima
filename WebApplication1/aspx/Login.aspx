...
<body>
    ...
    <div id="main" class="swidth1024 loginbg">
        ...
        <a href="javascript:void(0)"><img src="/Images/mm.jpg"  ></a>
      ...
      <input type="hidden" id="txtReturn" name="returnurl" value="<%=url %>"">
                                ...
                                <div class="rem_for wid100">
                                    <div class="fr" style="margin-right:30px;">
                                        ...
                                        <label><input id="chkRember" name="autoLogin" type="checkbox" value="1">自动登录</label><a href="javascript:void(0)" id="btnForget">忘记密码?</a>
                                    </div>
                                </div>
                                <input type="submit" id="btnLogin" class="lognow ml_90" style="width: 200px;"/>登录
