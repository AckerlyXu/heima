<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImageUpLoadTest.aspx.cs" Inherits="WebApplication1.ImageUpLoadTest" %>
   ...
   <title>SWFUpload Application Demo (ASP.Net 2.0)</title>
	...
	<script type="text/javascript">
		...
		window.onload = function () {
			swfu = new SWFUpload({
				// Backend Settings
				upload_url: "/ashx/ImageUpLoadTest.ashx",
                post_params : {
...
<body>
	...
	<div id="content">
        ...
        <img src="upload/thumb/毕业证书.jpg" alt="Alternate Text" />
    </form>
</body>
</html>
