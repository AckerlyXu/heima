...
* **Azure subscription** - To deploy more than a few compute-intensive instances, consider a pay-as-you-go subscription or other purchase options. If you're using an [Azure free account](https://www.azure.cn/pricing/1rmb-trial/), you can use only a limited number of Azure compute cores.
