...
If you haven't already, you can get an [Azure subscription trial](/pricing/1rmb-trial/) and the [Azure CLI 1.0](/documentation/articles/cli-install-nodejs/) [connected to your Azure account](/documentation/articles/xplat-cli-connect/). Make sure the Azure CLI is in Resource Manager mode as follows:
