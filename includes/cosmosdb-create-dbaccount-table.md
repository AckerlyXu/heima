...
2. In the left menu, click **New**, click **Databases**, and then click **Azure Cosmos DB**.
   ...
   ![Screen shot of the Azure portal preview, highlighting More Services, and Azure Cosmos DB](./media/documentdb-create-dbaccount/create-nosql-db-databases-json-tutorial-1.png)
