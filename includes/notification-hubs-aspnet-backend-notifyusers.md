...
6. In the **Configure Azure Web App** window, select a subscription and then, in the **App Service plan** list, do either of the following:
...
3. In the results list, select **Azure Notification Hubs**, and then select **Install**. Complete the installation, and then close the NuGet Package Manager window.
...
2. Select **Azure App Service** as your publish target, and then select **Publish**.  
    ...
    ![The Azure App Service tile][B15]
