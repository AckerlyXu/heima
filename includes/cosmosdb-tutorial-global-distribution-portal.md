...
## <a id="addregion"></a>Add global database regions using the Azure Portal Preview
...
1. In the [Azure portal preview](https://portal.azure.cn/), in the left bar, click **Azure Cosmos DB**.
...
[consistency]: /documentdb-consistency-levels/
