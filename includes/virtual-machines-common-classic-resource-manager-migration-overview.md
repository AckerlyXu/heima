...
| Compute | VM with backup or snapshot extension | These extensions are installed on a Virtual Machine configured with the Azure Backup service. To migrate these Virtual Machines, follow the guidance [here](/virtual-machines/windows/migration-classic-resource-manager-faq#vault).  |
...
<!--Not Available Microsoft Dynamics Lifecycle Services -->
<!--Not Available Azure AD Domain Services -->
<!--Not Available Azure RemoteApp -->
<!--Not Available Azure API Management -->
