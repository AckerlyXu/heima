...
namespace cn.itcast.bookshop.DAL
{
	...
	public partial class BookComment
	{
		...
		public cn.itcast.bookshop.Model.BookComment GetModel(int Id)
		{
			...
			cn.itcast.bookshop.Model.BookComment model=new cn.itcast.bookshop.Model.BookComment();
		...
		/// 得到一个对象实体
		/// </summary>
		public cn.itcast.bookshop.Model.BookComment DataRowToModel(DataRow row)
		{
			cn.itcast.bookshop.Model.BookComment model=new cn.itcast.bookshop.Model.BookComment();
			if (row != null)
			{
